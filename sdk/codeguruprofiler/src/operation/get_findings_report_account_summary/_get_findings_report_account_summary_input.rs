...
impl GetFindingsReportAccountSummaryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_findings_report_account_summary::GetFindingsReportAccountSummaryInput, ::aws_smithy_types::error::operation::BuildError> {
