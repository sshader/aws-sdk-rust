...
#[derive(Debug)]
    ...
    ::std::write!(output, "/v2/domains/{domainIdentifier}/subscriptions", domainIdentifier = domain_identifier).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_subscriptions::ListSubscriptionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
impl ListSubscriptionsError {
    ...
    /// Returns `true` if the error kind is `ListSubscriptionsError::UnauthorizedException`.
