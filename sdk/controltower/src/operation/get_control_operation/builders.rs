...
impl GetControlOperationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_control_operation::GetControlOperationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_control_operation::GetControlOperationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_control_operation::GetControlOperationOutput, crate::operation::get_control_operation::GetControlOperationError, Self> {
