...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_organization_configuration::ser_describe_organization_configuration_input(&input)?);
