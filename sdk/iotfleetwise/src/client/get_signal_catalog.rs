...
impl super::Client {
    ...
    ///   - [`creation_time(DateTime)`](crate::operation::get_signal_catalog::GetSignalCatalogOutput::creation_time): <p> The time the signal catalog was created in seconds since epoch (January 1, 1970 at midnight UTC time). </p>
    ///   - [`last_modification_time(DateTime)`](crate::operation::get_signal_catalog::GetSignalCatalogOutput::last_modification_time): <p>The last time the signal catalog was modified.</p>
