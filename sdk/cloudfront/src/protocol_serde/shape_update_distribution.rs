...
pub fn de_update_distribution_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_distribution::UpdateDistributionOutput, crate::operation::update_distribution::UpdateDistributionError> {
    ...
    Err(match error_code {
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_too_many_distribution_cnames::de_too_many_distribution_cnames_xml_err(_response_body, output).map_err(crate::operation::update_distribution::UpdateDistributionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "TooManyDistributionsAssociatedToOriginAccessControl" => crate::operation::update_distribution::UpdateDistributionError::TooManyDistributionsAssociatedToOriginAccessControl({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
