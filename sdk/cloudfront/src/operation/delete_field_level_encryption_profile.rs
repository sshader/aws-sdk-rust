    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_field_level_encryption_profile::DeleteFieldLevelEncryptionProfileError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_field_level_encryption_profile::DeleteFieldLevelEncryptionProfileOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteFieldLevelEncryptionProfile {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteFieldLevelEncryptionProfile");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteFieldLevelEncryptionProfileRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteFieldLevelEncryptionProfileResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteFieldLevelEncryptionProfile")
                            .with_interceptor(DeleteFieldLevelEncryptionProfileEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_field_level_encryption_profile::DeleteFieldLevelEncryptionProfileError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_field_level_encryption_profile::DeleteFieldLevelEncryptionProfileError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_field_level_encryption_profile::DeleteFieldLevelEncryptionProfileError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DeleteFieldLevelEncryptionProfileResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteFieldLevelEncryptionProfileResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteFieldLevelEncryptionProfileRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteFieldLevelEncryptionProfileRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_field_level_encryption_profile::DeleteFieldLevelEncryptionProfileInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_field_level_encryption_profile::DeleteFieldLevelEncryptionProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DeleteFieldLevelEncryptionProfileEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteFieldLevelEncryptionProfileEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteFieldLevelEncryptionProfileEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteFieldLevelEncryptionProfileInput>()
                        .ok_or("failed to downcast to DeleteFieldLevelEncryptionProfileInput")?;
...
pub enum DeleteFieldLevelEncryptionProfileError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteFieldLevelEncryptionProfileError) for what information is available for the error.")]
...
impl DeleteFieldLevelEncryptionProfileError {
    /// Creates the `DeleteFieldLevelEncryptionProfileError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteFieldLevelEncryptionProfileError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::FieldLevelEncryptionProfileInUse(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteFieldLevelEncryptionProfileError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_field_level_encryption_profile::DeleteFieldLevelEncryptionProfileError {
