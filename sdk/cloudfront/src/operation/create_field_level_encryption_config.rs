    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfigOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateFieldLevelEncryptionConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateFieldLevelEncryptionConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateFieldLevelEncryptionConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateFieldLevelEncryptionConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateFieldLevelEncryptionConfig")
                            .with_interceptor(CreateFieldLevelEncryptionConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfigError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct CreateFieldLevelEncryptionConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateFieldLevelEncryptionConfigResponseDeserializer {
            ...
            let parse_result = if !success && status != 201 || force_error {
                ...
                crate::protocol_serde::shape_create_field_level_encryption_config::de_create_field_level_encryption_config_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateFieldLevelEncryptionConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateFieldLevelEncryptionConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_field_level_encryption_config_input::ser_field_level_encryption_config_http_payload(& input.field_level_encryption_config)?);
...
#[derive(Debug)]
            struct CreateFieldLevelEncryptionConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateFieldLevelEncryptionConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateFieldLevelEncryptionConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateFieldLevelEncryptionConfigInput>()
                        .ok_or("failed to downcast to CreateFieldLevelEncryptionConfigInput")?;
...
pub enum CreateFieldLevelEncryptionConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateFieldLevelEncryptionConfigError) for what information is available for the error.")]
...
impl CreateFieldLevelEncryptionConfigError {
    /// Creates the `CreateFieldLevelEncryptionConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateFieldLevelEncryptionConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::FieldLevelEncryptionConfigAlreadyExists(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            ...
            Self::TooManyFieldLevelEncryptionConfigs(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateFieldLevelEncryptionConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfigError {
