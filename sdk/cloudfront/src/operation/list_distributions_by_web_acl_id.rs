...
impl ListDistributionsByWebACLId {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebAclIdOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebACLIdError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebACLIdError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebAclIdOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDistributionsByWebACLId {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListDistributionsByWebACLId");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListDistributionsByWebACLIdRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListDistributionsByWebACLIdResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDistributionsByWebACLId")
                            .with_interceptor(ListDistributionsByWebACLIdEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebACLIdError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebACLIdError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebACLIdError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDistributionsByWebACLIdResponseDeserializer {
...
#[derive(Debug)]
            struct ListDistributionsByWebACLIdRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDistributionsByWebACLIdRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebAclIdInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebAclIdInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.web_acl_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("web_acl_id", "cannot be empty or unset"))?;
    ...
    if web_acl_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("web_acl_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/2020-05-31/distributionsByWebACLId/{WebACLId}", WebACLId = web_acl_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebAclIdInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListDistributionsByWebACLIdEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDistributionsByWebACLIdEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListDistributionsByWebACLIdEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListDistributionsByWebAclIdInput>()
                        .ok_or("failed to downcast to ListDistributionsByWebAclIdInput")?;
...
pub enum ListDistributionsByWebACLIdError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListDistributionsByWebACLIdError) for what information is available for the error.")]
...
impl ListDistributionsByWebACLIdError {
    /// Creates the `ListDistributionsByWebACLIdError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListDistributionsByWebACLIdError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListDistributionsByWebACLIdError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebACLIdError {
