...
impl GetOriginRequestPolicyConfig {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetOriginRequestPolicyConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetOriginRequestPolicyConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetOriginRequestPolicyConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetOriginRequestPolicyConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetOriginRequestPolicyConfig")
                            .with_interceptor(GetOriginRequestPolicyConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetOriginRequestPolicyConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetOriginRequestPolicyConfigResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_origin_request_policy_config::de_get_origin_request_policy_config_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetOriginRequestPolicyConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetOriginRequestPolicyConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetOriginRequestPolicyConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetOriginRequestPolicyConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetOriginRequestPolicyConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetOriginRequestPolicyConfigInput>()
                        .ok_or("failed to downcast to GetOriginRequestPolicyConfigInput")?;
...
pub enum GetOriginRequestPolicyConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetOriginRequestPolicyConfigError) for what information is available for the error.")]
...
impl GetOriginRequestPolicyConfigError {
    /// Creates the `GetOriginRequestPolicyConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetOriginRequestPolicyConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetOriginRequestPolicyConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigError {
