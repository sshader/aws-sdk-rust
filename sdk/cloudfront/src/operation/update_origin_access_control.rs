...
impl UpdateOriginAccessControl {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_origin_access_control::UpdateOriginAccessControlOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_origin_access_control::UpdateOriginAccessControlError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_origin_access_control::UpdateOriginAccessControlError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_origin_access_control::UpdateOriginAccessControlOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateOriginAccessControl {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateOriginAccessControl");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateOriginAccessControlRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateOriginAccessControlResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateOriginAccessControl")
                            .with_interceptor(UpdateOriginAccessControlEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_origin_access_control::UpdateOriginAccessControlError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_origin_access_control::UpdateOriginAccessControlError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_origin_access_control::UpdateOriginAccessControlError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct UpdateOriginAccessControlResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateOriginAccessControlResponseDeserializer {
...
#[derive(Debug)]
            struct UpdateOriginAccessControlRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateOriginAccessControlRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_origin_access_control::UpdateOriginAccessControlInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_origin_access_control::UpdateOriginAccessControlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_origin_access_control_input::ser_origin_access_control_config_http_payload(& input.origin_access_control_config)?);
...
#[derive(Debug)]
            struct UpdateOriginAccessControlEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateOriginAccessControlEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateOriginAccessControlEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateOriginAccessControlInput>()
                        .ok_or("failed to downcast to UpdateOriginAccessControlInput")?;
...
pub enum UpdateOriginAccessControlError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateOriginAccessControlError) for what information is available for the error.")]
...
impl UpdateOriginAccessControlError {
    /// Creates the `UpdateOriginAccessControlError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateOriginAccessControlError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateOriginAccessControlError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_origin_access_control::UpdateOriginAccessControlError {
