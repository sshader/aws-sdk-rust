...
impl DescribeAddonConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_addon_configuration::DescribeAddonConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_addon_configuration::DescribeAddonConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_addon_configuration::DescribeAddonConfigurationOutput, crate::operation::describe_addon_configuration::DescribeAddonConfigurationError, Self> {
