...
impl super::Client {
    ...
    ///   - [`cluster_name(impl Into<String>)`](crate::operation::describe_addon::builders::DescribeAddonFluentBuilder::cluster_name) / [`set_cluster_name(Option<String>)`](crate::operation::describe_addon::builders::DescribeAddonFluentBuilder::set_cluster_name):<br>required: **true**<br><p>The name of the cluster.</p><br>
    ///   - [`addon_name(impl Into<String>)`](crate::operation::describe_addon::builders::DescribeAddonFluentBuilder::addon_name) / [`set_addon_name(Option<String>)`](crate::operation::describe_addon::builders::DescribeAddonFluentBuilder::set_addon_name):<br>required: **true**<br><p>The name of the add-on. The name must match one of the names returned by <a href="https://docs.aws.amazon.com/eks/latest/APIReference/API_ListAddons.html"> <code>ListAddons</code> </a>.</p><br>
