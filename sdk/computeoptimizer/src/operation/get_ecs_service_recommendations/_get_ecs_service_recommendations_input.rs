...
impl GetEcsServiceRecommendationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_ecs_service_recommendations::GetEcsServiceRecommendationsInput, ::aws_smithy_types::error::operation::BuildError> {
