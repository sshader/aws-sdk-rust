...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::export_ec2_instance_recommendations::ExportEc2InstanceRecommendationsOutput,
                    crate::operation::export_ec2_instance_recommendations::ExportEC2InstanceRecommendationsError,
                > for ExportEC2InstanceRecommendationsFluentBuilder
            {
                fn send(
                    self,
...
impl ExportEC2InstanceRecommendationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::export_ec2_instance_recommendations::ExportEc2InstanceRecommendationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::export_ec2_instance_recommendations::ExportEC2InstanceRecommendationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::export_ec2_instance_recommendations::ExportEC2InstanceRecommendations::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::export_ec2_instance_recommendations::ExportEC2InstanceRecommendations::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::export_ec2_instance_recommendations::ExportEc2InstanceRecommendationsOutput, crate::operation::export_ec2_instance_recommendations::ExportEC2InstanceRecommendationsError, Self> {
