...
impl GetRecommendationSummariesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_recommendation_summaries::GetRecommendationSummariesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_recommendation_summaries::GetRecommendationSummariesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_recommendation_summaries::GetRecommendationSummariesOutput, crate::operation::get_recommendation_summaries::GetRecommendationSummariesError, Self> {
