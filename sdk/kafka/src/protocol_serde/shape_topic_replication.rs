...
pub(crate) fn de_topic_replication<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TopicReplication>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    ...
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "copyTopicConfigurations" => {
                                builder = builder.set_copy_topic_configurations(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "detectAndCopyNewTopics" => {
                                builder = builder.set_detect_and_copy_new_topics(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "topicsToExclude" => {
                                builder = builder.set_topics_to_exclude(
                                    crate::protocol_serde::shape_list_of_string_max249::de_list_of_string_max249(tokens)?
                                );
                            }
                            "topicsToReplicate" => {
