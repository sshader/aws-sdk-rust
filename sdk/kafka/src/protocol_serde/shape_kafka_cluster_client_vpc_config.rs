...
pub(crate) fn de_kafka_cluster_client_vpc_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::KafkaClusterClientVpcConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
