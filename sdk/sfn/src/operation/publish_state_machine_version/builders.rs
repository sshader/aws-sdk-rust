...
impl PublishStateMachineVersionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::publish_state_machine_version::PublishStateMachineVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::publish_state_machine_version::PublishStateMachineVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::publish_state_machine_version::PublishStateMachineVersionOutput, crate::operation::publish_state_machine_version::PublishStateMachineVersionError, Self> {
