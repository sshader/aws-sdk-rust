...
/// Orchestration and serialization glue logic for `RedriveExecution`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
#[doc(hidden)]
pub struct RedriveExecution;
impl RedriveExecution {
    #[doc(hidden)]
    pub fn new() -> Self {
        Self
    }
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::redrive_execution::RedriveExecutionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::redrive_execution::RedriveExecutionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::redrive_execution::RedriveExecutionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::redrive_execution::RedriveExecutionOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                ...
                                let input: &mut crate::operation::redrive_execution::RedriveExecutionInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RedriveExecution {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RedriveExecution");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RedriveExecutionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RedriveExecutionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RedriveExecution")
                            .with_interceptor(RedriveExecutionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::redrive_execution::RedriveExecutionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::redrive_execution::RedriveExecutionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::redrive_execution::RedriveExecutionError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct RedriveExecutionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RedriveExecutionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_redrive_execution::de_redrive_execution_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_redrive_execution::de_redrive_execution_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RedriveExecutionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RedriveExecutionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::redrive_execution::RedriveExecutionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::redrive_execution::RedriveExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder = _header_serialization_settings.set_default_header(
                    ...
                    "AWSStepFunctions.RedriveExecution"
                );
builder
                    };
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_redrive_execution::ser_redrive_execution_input(&input)?);
...
#[derive(Debug)]
            struct RedriveExecutionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RedriveExecutionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RedriveExecutionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RedriveExecutionInput>()
                        .ok_or("failed to downcast to RedriveExecutionInput")?;
...
/// Error type for the `RedriveExecutionError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum RedriveExecutionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RedriveExecutionError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl RedriveExecutionError {
    /// Creates the `RedriveExecutionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RedriveExecutionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `RedriveExecutionError::ExecutionDoesNotExist`.
    pub fn is_execution_does_not_exist(&self) -> bool {
        matches!(self, Self::ExecutionDoesNotExist(_))
    }
    /// Returns `true` if the error kind is `RedriveExecutionError::ExecutionLimitExceeded`.
    pub fn is_execution_limit_exceeded(&self) -> bool {
        matches!(self, Self::ExecutionLimitExceeded(_))
    }
    /// Returns `true` if the error kind is `RedriveExecutionError::ExecutionNotRedrivable`.
    pub fn is_execution_not_redrivable(&self) -> bool {
        matches!(self, Self::ExecutionNotRedrivable(_))
    }
    /// Returns `true` if the error kind is `RedriveExecutionError::InvalidArn`.
...
impl ::std::error::Error for RedriveExecutionError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::ExecutionNotRedrivable(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::std::fmt::Display for RedriveExecutionError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for RedriveExecutionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RedriveExecutionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RedriveExecutionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::redrive_execution::RedriveExecutionError {
