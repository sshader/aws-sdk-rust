...
impl GetRevocationStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_revocation_status::GetRevocationStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_revocation_status::GetRevocationStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_revocation_status::GetRevocationStatusOutput, crate::operation::get_revocation_status::GetRevocationStatusError, Self> {
