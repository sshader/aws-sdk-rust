...
impl PutSigningProfileFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_signing_profile::PutSigningProfileOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_signing_profile::PutSigningProfileError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_signing_profile::PutSigningProfileOutput, crate::operation::put_signing_profile::PutSigningProfileError, Self> {
