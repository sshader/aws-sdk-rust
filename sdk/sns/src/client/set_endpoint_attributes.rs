...
impl super::Client {
    ...
    ///   - [`endpoint_arn(impl Into<String>)`](crate::operation::set_endpoint_attributes::builders::SetEndpointAttributesFluentBuilder::endpoint_arn) / [`set_endpoint_arn(Option<String>)`](crate::operation::set_endpoint_attributes::builders::SetEndpointAttributesFluentBuilder::set_endpoint_arn):<br>required: **true**<br><p>EndpointArn used for SetEndpointAttributes action.</p><br>
