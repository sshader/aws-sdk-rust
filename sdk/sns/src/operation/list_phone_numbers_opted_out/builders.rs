...
impl ListPhoneNumbersOptedOutFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutOutput, crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutError, Self> {
