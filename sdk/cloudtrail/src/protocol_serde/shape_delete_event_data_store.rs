...
pub fn de_delete_event_data_store_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_event_data_store::DeleteEventDataStoreOutput, crate::operation::delete_event_data_store::DeleteEventDataStoreError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_event_data_store_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_event_data_store::DeleteEventDataStoreOutput, crate::operation::delete_event_data_store::DeleteEventDataStoreError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_delete_event_data_store_input(input: &crate::operation::delete_event_data_store::DeleteEventDataStoreInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
