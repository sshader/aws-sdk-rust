...
impl StopEventDataStoreIngestion {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopEventDataStoreIngestion {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopEventDataStoreIngestion");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopEventDataStoreIngestionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopEventDataStoreIngestionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopEventDataStoreIngestion")
                            .with_interceptor(StopEventDataStoreIngestionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct StopEventDataStoreIngestionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopEventDataStoreIngestionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_stop_event_data_store_ingestion::de_stop_event_data_store_ingestion_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopEventDataStoreIngestionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopEventDataStoreIngestionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_event_data_store_ingestion::ser_stop_event_data_store_ingestion_input(&input)?);
...
#[derive(Debug)]
            struct StopEventDataStoreIngestionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopEventDataStoreIngestionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopEventDataStoreIngestionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopEventDataStoreIngestionInput>()
                        .ok_or("failed to downcast to StopEventDataStoreIngestionInput")?;
...
pub enum StopEventDataStoreIngestionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopEventDataStoreIngestionError) for what information is available for the error.")]
...
impl StopEventDataStoreIngestionError {
    /// Creates the `StopEventDataStoreIngestionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopEventDataStoreIngestionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopEventDataStoreIngestionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionError {
