...
impl MergeDeveloperIdentities {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for MergeDeveloperIdentities {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("MergeDeveloperIdentities");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(MergeDeveloperIdentitiesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(MergeDeveloperIdentitiesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("MergeDeveloperIdentities")
                            .with_interceptor(MergeDeveloperIdentitiesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct MergeDeveloperIdentitiesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for MergeDeveloperIdentitiesResponseDeserializer {
...
#[derive(Debug)]
            struct MergeDeveloperIdentitiesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for MergeDeveloperIdentitiesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::merge_developer_identities::MergeDeveloperIdentitiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_merge_developer_identities::ser_merge_developer_identities_input(&input)?);
...
#[derive(Debug)]
            struct MergeDeveloperIdentitiesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for MergeDeveloperIdentitiesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "MergeDeveloperIdentitiesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<MergeDeveloperIdentitiesInput>()
                        .ok_or("failed to downcast to MergeDeveloperIdentitiesInput")?;
...
pub enum MergeDeveloperIdentitiesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-MergeDeveloperIdentitiesError) for what information is available for the error.")]
...
impl MergeDeveloperIdentitiesError {
    /// Creates the `MergeDeveloperIdentitiesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `MergeDeveloperIdentitiesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for MergeDeveloperIdentitiesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::merge_developer_identities::MergeDeveloperIdentitiesError {
