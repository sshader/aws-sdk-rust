...
impl UpdateIdentityPoolOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_identity_pool::UpdateIdentityPoolOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::update_identity_pool::UpdateIdentityPoolOutput {
                identity_pool_id: self.identity_pool_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("identity_pool_id", "identity_pool_id was not specified but it is required when building UpdateIdentityPoolOutput")
                    )?
                ,
                identity_pool_name: self.identity_pool_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("identity_pool_name", "identity_pool_name was not specified but it is required when building UpdateIdentityPoolOutput")
                    )?
                ,
