...
impl UnlinkDeveloperIdentity {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UnlinkDeveloperIdentity {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UnlinkDeveloperIdentity");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UnlinkDeveloperIdentityRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UnlinkDeveloperIdentityResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UnlinkDeveloperIdentity")
                            .with_interceptor(UnlinkDeveloperIdentityEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct UnlinkDeveloperIdentityResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UnlinkDeveloperIdentityResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_unlink_developer_identity::de_unlink_developer_identity_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UnlinkDeveloperIdentityRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UnlinkDeveloperIdentityRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_unlink_developer_identity::ser_unlink_developer_identity_input(&input)?);
...
#[derive(Debug)]
            struct UnlinkDeveloperIdentityEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UnlinkDeveloperIdentityEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UnlinkDeveloperIdentityEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UnlinkDeveloperIdentityInput>()
                        .ok_or("failed to downcast to UnlinkDeveloperIdentityInput")?;
...
pub enum UnlinkDeveloperIdentityError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UnlinkDeveloperIdentityError) for what information is available for the error.")]
...
impl UnlinkDeveloperIdentityError {
    /// Creates the `UnlinkDeveloperIdentityError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UnlinkDeveloperIdentityError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UnlinkDeveloperIdentityError {
...
impl ::aws_types::request_id::RequestId for crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityError {
