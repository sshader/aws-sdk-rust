...
impl ListIntentStageMetricsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_intent_stage_metrics::ListIntentStageMetricsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_intent_stage_metrics::ListIntentStageMetricsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_intent_stage_metrics::ListIntentStageMetricsOutput, crate::operation::list_intent_stage_metrics::ListIntentStageMetricsError, Self> {
