...
impl UpdateRevealConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_reveal_configuration::UpdateRevealConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_reveal_configuration::UpdateRevealConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_reveal_configuration::UpdateRevealConfigurationOutput, crate::operation::update_reveal_configuration::UpdateRevealConfigurationError, Self> {
