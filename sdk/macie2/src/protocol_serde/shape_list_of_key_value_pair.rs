...
pub(crate) fn de_list_of_key_value_pair<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::KeyValuePair>>, ::aws_smithy_json::deserialize::error::DeserializeError>
