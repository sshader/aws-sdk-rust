...
impl DescribeWhatIfForecastFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_what_if_forecast::DescribeWhatIfForecastOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_what_if_forecast::DescribeWhatIfForecastError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_what_if_forecast::DescribeWhatIfForecastOutput, crate::operation::describe_what_if_forecast::DescribeWhatIfForecastError, Self> {
