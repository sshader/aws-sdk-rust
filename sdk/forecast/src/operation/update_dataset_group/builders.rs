...
impl UpdateDatasetGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_dataset_group::UpdateDatasetGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_dataset_group::UpdateDatasetGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_dataset_group::UpdateDatasetGroupOutput, crate::operation::update_dataset_group::UpdateDatasetGroupError, Self> {
