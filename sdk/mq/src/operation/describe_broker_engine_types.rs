...
impl DescribeBrokerEngineTypes {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeBrokerEngineTypes {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeBrokerEngineTypes");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeBrokerEngineTypesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeBrokerEngineTypesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeBrokerEngineTypes")
                            .with_interceptor(DescribeBrokerEngineTypesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DescribeBrokerEngineTypesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeBrokerEngineTypesResponseDeserializer {
...
#[derive(Debug)]
            struct DescribeBrokerEngineTypesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeBrokerEngineTypesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/v1/broker-engine-types").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DescribeBrokerEngineTypesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeBrokerEngineTypesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeBrokerEngineTypesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeBrokerEngineTypesInput>()
                        .ok_or("failed to downcast to DescribeBrokerEngineTypesInput")?;
...
pub enum DescribeBrokerEngineTypesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeBrokerEngineTypesError) for what information is available for the error.")]
...
impl DescribeBrokerEngineTypesError {
    /// Creates the `DescribeBrokerEngineTypesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeBrokerEngineTypesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeBrokerEngineTypesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesError {
