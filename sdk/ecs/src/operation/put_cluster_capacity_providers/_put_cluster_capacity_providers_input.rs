...
impl PutClusterCapacityProvidersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersInput, ::aws_smithy_types::error::operation::BuildError> {
