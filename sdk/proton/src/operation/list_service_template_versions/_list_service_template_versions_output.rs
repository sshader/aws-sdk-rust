...
impl ListServiceTemplateVersionsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_service_template_versions::ListServiceTemplateVersionsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_service_template_versions::ListServiceTemplateVersionsOutput {
                ...
                template_versions: self.template_versions
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("template_versions", "template_versions was not specified but it is required when building ListServiceTemplateVersionsOutput")
                    )?
                ,
