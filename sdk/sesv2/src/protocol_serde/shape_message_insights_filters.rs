...
pub(crate) fn de_message_insights_filters<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MessageInsightsFilters>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Subject" => {
                                builder = builder.set_subject(
                                    crate::protocol_serde::shape_email_subject_filter_list::de_email_subject_filter_list(tokens)?
                                );
                            }
                            "Isp" => {
                                builder = builder.set_isp(
                                    crate::protocol_serde::shape_isp_filter_list::de_isp_filter_list(tokens)?
                                );
                            }
                            "LastDeliveryEvent" => {
