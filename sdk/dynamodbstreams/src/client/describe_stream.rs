...
impl super::Client {
    ...
    ///   - [`stream_arn(impl Into<String>)`](crate::operation::describe_stream::builders::DescribeStreamFluentBuilder::stream_arn) / [`set_stream_arn(Option<String>)`](crate::operation::describe_stream::builders::DescribeStreamFluentBuilder::set_stream_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) for the stream.</p><br>
    ///   - [`limit(i32)`](crate::operation::describe_stream::builders::DescribeStreamFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::describe_stream::builders::DescribeStreamFluentBuilder::set_limit):<br>required: **false**<br><p>The maximum number of shard objects to return. The upper limit is 100.</p><br>
    ///   - [`exclusive_start_shard_id(impl Into<String>)`](crate::operation::describe_stream::builders::DescribeStreamFluentBuilder::exclusive_start_shard_id) / [`set_exclusive_start_shard_id(Option<String>)`](crate::operation::describe_stream::builders::DescribeStreamFluentBuilder::set_exclusive_start_shard_id):<br>required: **false**<br><p>The shard ID of the first item that this operation will evaluate. Use the value that was returned for <code>LastEvaluatedShardId</code> in the previous operation. </p><br>
