...
impl DescribeStackResourceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_stack_resource::DescribeStackResourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_stack_resource::DescribeStackResourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_stack_resource::DescribeStackResourceOutput, crate::operation::describe_stack_resource::DescribeStackResourceError, Self> {
