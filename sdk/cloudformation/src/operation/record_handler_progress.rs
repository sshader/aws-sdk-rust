...
impl RecordHandlerProgress {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::record_handler_progress::RecordHandlerProgressOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::record_handler_progress::RecordHandlerProgressError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::record_handler_progress::RecordHandlerProgressError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::record_handler_progress::RecordHandlerProgressOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RecordHandlerProgress {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RecordHandlerProgress");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RecordHandlerProgressRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RecordHandlerProgressResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RecordHandlerProgress")
                            .with_interceptor(RecordHandlerProgressEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::record_handler_progress::RecordHandlerProgressError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::record_handler_progress::RecordHandlerProgressError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::record_handler_progress::RecordHandlerProgressError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct RecordHandlerProgressResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RecordHandlerProgressResponseDeserializer {
...
#[derive(Debug)]
            struct RecordHandlerProgressRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RecordHandlerProgressRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::record_handler_progress::RecordHandlerProgressInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::record_handler_progress::RecordHandlerProgressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_record_handler_progress_input::ser_record_handler_progress_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RecordHandlerProgressEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RecordHandlerProgressEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RecordHandlerProgressEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RecordHandlerProgressInput>()
                        .ok_or("failed to downcast to RecordHandlerProgressInput")?;
...
pub enum RecordHandlerProgressError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RecordHandlerProgressError) for what information is available for the error.")]
...
impl RecordHandlerProgressError {
    /// Creates the `RecordHandlerProgressError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RecordHandlerProgressError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::OperationStatusCheckFailedException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RecordHandlerProgressError {
...
impl ::aws_types::request_id::RequestId for crate::operation::record_handler_progress::RecordHandlerProgressError {
