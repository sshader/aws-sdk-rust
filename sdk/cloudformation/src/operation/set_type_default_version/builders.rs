...
impl SetTypeDefaultVersionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_type_default_version::SetTypeDefaultVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_type_default_version::SetTypeDefaultVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_type_default_version::SetTypeDefaultVersionOutput, crate::operation::set_type_default_version::SetTypeDefaultVersionError, Self> {
