...
impl DescribeStackSetOperationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_stack_set_operation::DescribeStackSetOperationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_stack_set_operation::DescribeStackSetOperationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_stack_set_operation::DescribeStackSetOperationOutput, crate::operation::describe_stack_set_operation::DescribeStackSetOperationError, Self> {
