...
pub(crate) fn de_layer_version_content_output<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::LayerVersionContentOutput>, ::aws_smithy_json::deserialize::error::DeserializeError>
