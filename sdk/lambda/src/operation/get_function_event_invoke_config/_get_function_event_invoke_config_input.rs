...
impl GetFunctionEventInvokeConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_function_event_invoke_config::GetFunctionEventInvokeConfigInput, ::aws_smithy_types::error::operation::BuildError> {
