...
impl UpdateFunctionUrlConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_function_url_config::UpdateFunctionUrlConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_function_url_config::UpdateFunctionUrlConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_function_url_config::UpdateFunctionUrlConfigOutput, crate::operation::update_function_url_config::UpdateFunctionUrlConfigError, Self> {
