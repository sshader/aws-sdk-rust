...
/// Paginator for [`ListEventSourceMappings`](crate::operation::list_event_source_mappings::ListEventSourceMappings)
            ...
            impl ListEventSourceMappingsPaginator {
                ...
                pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::list_event_source_mappings::ListEventSourceMappingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_event_source_mappings::ListEventSourceMappingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                    ...
                    ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| ::std::boxed::Box::pin(async move {
                        ...
                        loop {
                            let resp = crate::operation::list_event_source_mappings::ListEventSourceMappings::orchestrate(&runtime_plugins, input.clone()).await;
...
/// Flattened paginator for `ListEventSourceMappingsPaginator`
                ...
                impl ListEventSourceMappingsPaginatorItems {
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::types::EventSourceMappingConfiguration, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_event_source_mappings::ListEventSourceMappingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_event_source_mappings_output_output_event_source_mappings(page).unwrap_or_default().into_iter())
                    }
                }
