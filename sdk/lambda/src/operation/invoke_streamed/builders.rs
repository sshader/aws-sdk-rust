...
pub use crate::operation::invoke_streamed::_invoke_output::InvokeOutputStreamedBuilder;

pub use crate::operation::invoke_streamed::_invoke_input::InvokeInputBuilder;
...
impl InvokeInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::invoke_streamed::InvokeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>,
    > {
        let mut fluent_builder = client.invoke_streamed();
...
impl InvokeStreamedFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::invoke_streamed::InvokeStreamed::operation_runtime_plugins(self.handle.runtime_plugins.clone(), &self.handle.conf, self.config_override);
        crate::operation::invoke_streamed::InvokeStreamed::orchestrate(&runtime_plugins, input).await
    }
    ...
    pub async fn customize(
        ...
        crate::client::customize::orchestrator::CustomizableOperation<crate::operation::invoke_streamed::InvokeOutputStreamed, crate::operation::invoke_streamed::InvokeError>,
        ::aws_smithy_http::result::SdkError<crate::operation::invoke_streamed::InvokeError>,
    > {
