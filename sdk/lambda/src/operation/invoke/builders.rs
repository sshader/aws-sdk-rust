...
pub use crate::operation::invoke::_invoke_output::InvokeOutputStreamedBuilder;
...
impl InvokeFluentBuilder {
    ...
    pub async fn send_stream(
        ...
        crate::operation::invoke::InvokeOutputStreamed,
        ::aws_smithy_http::result::SdkError<crate::operation::invoke::InvokeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>,
    > {
        let input = self.inner.build().map_err(::aws_smithy_http::result::SdkError::construction_failure)?;
        let runtime_plugins =
            crate::operation::invoke::Invoke::operation_runtime_plugins(self.handle.runtime_plugins.clone(), &self.handle.conf, self.config_override);
        crate::operation::invoke::Invoke::orchestrate_streamed(&runtime_plugins, input).await
    }
    ...
    pub async fn customize(
        ...
        crate::client::customize::orchestrator::CustomizableOperation<crate::operation::invoke::InvokeOutput, crate::operation::invoke::InvokeError>,
