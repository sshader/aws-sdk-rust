...
impl ListVersionsByFunctionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_versions_by_function::ListVersionsByFunctionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_versions_by_function::ListVersionsByFunctionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_versions_by_function::ListVersionsByFunctionOutput, crate::operation::list_versions_by_function::ListVersionsByFunctionError, Self> {
