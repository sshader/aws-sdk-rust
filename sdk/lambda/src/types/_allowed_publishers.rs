...
impl  AllowedPublishers  {
    ...
    pub fn signing_profile_version_arns(&self) -> & [::std::string::String] {
        use std::ops::Deref; self.signing_profile_version_arns.deref()
    }
}
impl AllowedPublishers {
        ...
        ::std::result::Result::Ok(
            crate::types::AllowedPublishers {
                signing_profile_version_arns: self.signing_profile_version_arns
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("signing_profile_version_arns", "signing_profile_version_arns was not specified but it is required when building AllowedPublishers")
                    )?
                ,
            }
        )
