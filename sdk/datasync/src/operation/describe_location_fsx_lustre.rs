...
impl DescribeLocationFsxLustre {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_location_fsx_lustre::DescribeLocationFsxLustreOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_location_fsx_lustre::DescribeLocationFsxLustreError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_location_fsx_lustre::DescribeLocationFsxLustreError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_location_fsx_lustre::DescribeLocationFsxLustreOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeLocationFsxLustre {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeLocationFsxLustre");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeLocationFsxLustreRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeLocationFsxLustreResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeLocationFsxLustre")
                            .with_interceptor(DescribeLocationFsxLustreEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_location_fsx_lustre::DescribeLocationFsxLustreError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_location_fsx_lustre::DescribeLocationFsxLustreError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_location_fsx_lustre::DescribeLocationFsxLustreError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DescribeLocationFsxLustreResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeLocationFsxLustreResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_describe_location_fsx_lustre::de_describe_location_fsx_lustre_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeLocationFsxLustreRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeLocationFsxLustreRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_location_fsx_lustre::DescribeLocationFsxLustreInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_location_fsx_lustre::DescribeLocationFsxLustreInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_location_fsx_lustre::ser_describe_location_fsx_lustre_input(&input)?);
...
#[derive(Debug)]
            struct DescribeLocationFsxLustreEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeLocationFsxLustreEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeLocationFsxLustreEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeLocationFsxLustreInput>()
                        .ok_or("failed to downcast to DescribeLocationFsxLustreInput")?;
...
pub enum DescribeLocationFsxLustreError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeLocationFsxLustreError) for what information is available for the error.")]
...
impl DescribeLocationFsxLustreError {
    /// Creates the `DescribeLocationFsxLustreError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeLocationFsxLustreError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeLocationFsxLustreError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_location_fsx_lustre::DescribeLocationFsxLustreError {
