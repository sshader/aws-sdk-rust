...
/// Paginator for [`DescribeSubscriptionFilters`](crate::operation::describe_subscription_filters::DescribeSubscriptionFilters)
            ...
            impl DescribeSubscriptionFiltersPaginator {
                ...
                pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::describe_subscription_filters::DescribeSubscriptionFiltersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_subscription_filters::DescribeSubscriptionFiltersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                    ...
                    ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| ::std::boxed::Box::pin(async move {
                        ...
                        loop {
                            let resp = crate::operation::describe_subscription_filters::DescribeSubscriptionFilters::orchestrate(&runtime_plugins, input.clone()).await;
...
/// Flattened paginator for `DescribeSubscriptionFiltersPaginator`
                ...
                impl DescribeSubscriptionFiltersPaginatorItems {
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::types::SubscriptionFilter, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_subscription_filters::DescribeSubscriptionFiltersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_describe_subscription_filters_output_output_subscription_filters(page).unwrap_or_default().into_iter())
                    }
                }
