        ...
        ::std::result::Result::Ok(
            crate::operation::get_user_id::GetUserIdOutput {
                user_id: self.user_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("user_id", "user_id was not specified but it is required when building GetUserIdOutput")
                    )?
                ,
                identity_store_id: self.identity_store_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("identity_store_id", "identity_store_id was not specified but it is required when building GetUserIdOutput")
                    )?
                ,
