...
impl TagDeliveryStream {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::tag_delivery_stream::TagDeliveryStreamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::tag_delivery_stream::TagDeliveryStreamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::tag_delivery_stream::TagDeliveryStreamError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::tag_delivery_stream::TagDeliveryStreamOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for TagDeliveryStream {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("TagDeliveryStream");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(TagDeliveryStreamRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(TagDeliveryStreamResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("TagDeliveryStream")
                            .with_interceptor(TagDeliveryStreamEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::tag_delivery_stream::TagDeliveryStreamError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::tag_delivery_stream::TagDeliveryStreamError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::tag_delivery_stream::TagDeliveryStreamError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct TagDeliveryStreamResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TagDeliveryStreamResponseDeserializer {
...
#[derive(Debug)]
            struct TagDeliveryStreamRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TagDeliveryStreamRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::tag_delivery_stream::TagDeliveryStreamInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::tag_delivery_stream::TagDeliveryStreamInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_tag_delivery_stream::ser_tag_delivery_stream_input(&input)?);
...
#[derive(Debug)]
            struct TagDeliveryStreamEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TagDeliveryStreamEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "TagDeliveryStreamEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<TagDeliveryStreamInput>()
                        .ok_or("failed to downcast to TagDeliveryStreamInput")?;
...
pub enum TagDeliveryStreamError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-TagDeliveryStreamError) for what information is available for the error.")]
...
impl TagDeliveryStreamError {
    /// Creates the `TagDeliveryStreamError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `TagDeliveryStreamError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for TagDeliveryStreamError {
...
impl ::aws_types::request_id::RequestId for crate::operation::tag_delivery_stream::TagDeliveryStreamError {
