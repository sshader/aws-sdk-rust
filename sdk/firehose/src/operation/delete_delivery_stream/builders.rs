...
impl DeleteDeliveryStreamFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_delivery_stream::DeleteDeliveryStreamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_delivery_stream::DeleteDeliveryStreamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_delivery_stream::DeleteDeliveryStreamOutput, crate::operation::delete_delivery_stream::DeleteDeliveryStreamError, Self> {
