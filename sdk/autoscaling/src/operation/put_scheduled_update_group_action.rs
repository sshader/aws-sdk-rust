...
impl PutScheduledUpdateGroupAction {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutScheduledUpdateGroupAction {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutScheduledUpdateGroupAction");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutScheduledUpdateGroupActionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutScheduledUpdateGroupActionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutScheduledUpdateGroupAction")
                            .with_interceptor(PutScheduledUpdateGroupActionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutScheduledUpdateGroupActionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_put_scheduled_update_group_action::de_put_scheduled_update_group_action_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutScheduledUpdateGroupActionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_scheduled_update_group_action_input::ser_put_scheduled_update_group_action_input_input_input(&input)?);
...
#[derive(Debug)]
            struct PutScheduledUpdateGroupActionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutScheduledUpdateGroupActionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutScheduledUpdateGroupActionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutScheduledUpdateGroupActionInput>()
                        .ok_or("failed to downcast to PutScheduledUpdateGroupActionInput")?;
...
pub enum PutScheduledUpdateGroupActionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutScheduledUpdateGroupActionError) for what information is available for the error.")]
...
impl PutScheduledUpdateGroupActionError {
    /// Creates the `PutScheduledUpdateGroupActionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutScheduledUpdateGroupActionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutScheduledUpdateGroupActionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionError {
