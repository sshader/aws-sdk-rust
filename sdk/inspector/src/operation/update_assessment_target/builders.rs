...
impl UpdateAssessmentTargetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_assessment_target::UpdateAssessmentTargetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_assessment_target::UpdateAssessmentTargetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_assessment_target::UpdateAssessmentTargetOutput, crate::operation::update_assessment_target::UpdateAssessmentTargetError, Self> {
