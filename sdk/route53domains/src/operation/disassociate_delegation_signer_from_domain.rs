    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateDelegationSignerFromDomain {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateDelegationSignerFromDomain");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateDelegationSignerFromDomainRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateDelegationSignerFromDomainResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateDelegationSignerFromDomain")
                            .with_interceptor(DisassociateDelegationSignerFromDomainEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DisassociateDelegationSignerFromDomainResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateDelegationSignerFromDomainResponseDeserializer {
...
#[derive(Debug)]
            struct DisassociateDelegationSignerFromDomainRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateDelegationSignerFromDomainRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disassociate_delegation_signer_from_domain::ser_disassociate_delegation_signer_from_domain_input(&input)?);
...
#[derive(Debug)]
            struct DisassociateDelegationSignerFromDomainEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateDelegationSignerFromDomainEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisassociateDelegationSignerFromDomainEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateDelegationSignerFromDomainInput>()
                        .ok_or("failed to downcast to DisassociateDelegationSignerFromDomainInput")?;
...
pub enum DisassociateDelegationSignerFromDomainError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateDelegationSignerFromDomainError) for what information is available for the error.")]
...
impl DisassociateDelegationSignerFromDomainError {
    /// Creates the `DisassociateDelegationSignerFromDomainError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateDelegationSignerFromDomainError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateDelegationSignerFromDomainError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainError {
