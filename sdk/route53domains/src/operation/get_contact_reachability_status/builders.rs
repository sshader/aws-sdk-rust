...
impl GetContactReachabilityStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_contact_reachability_status::GetContactReachabilityStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_contact_reachability_status::GetContactReachabilityStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_contact_reachability_status::GetContactReachabilityStatusOutput, crate::operation::get_contact_reachability_status::GetContactReachabilityStatusError, Self> {
