...
impl ResendContactReachabilityEmail {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ResendContactReachabilityEmail {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ResendContactReachabilityEmail");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ResendContactReachabilityEmailRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ResendContactReachabilityEmailResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResendContactReachabilityEmail")
                            .with_interceptor(ResendContactReachabilityEmailEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct ResendContactReachabilityEmailResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ResendContactReachabilityEmailResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_resend_contact_reachability_email::de_resend_contact_reachability_email_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ResendContactReachabilityEmailRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ResendContactReachabilityEmailRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_resend_contact_reachability_email::ser_resend_contact_reachability_email_input(&input)?);
...
#[derive(Debug)]
            struct ResendContactReachabilityEmailEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ResendContactReachabilityEmailEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ResendContactReachabilityEmailEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ResendContactReachabilityEmailInput>()
                        .ok_or("failed to downcast to ResendContactReachabilityEmailInput")?;
...
pub enum ResendContactReachabilityEmailError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ResendContactReachabilityEmailError) for what information is available for the error.")]
...
impl ResendContactReachabilityEmailError {
    /// Creates the `ResendContactReachabilityEmailError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ResendContactReachabilityEmailError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ResendContactReachabilityEmailError {
...
impl ::aws_types::request_id::RequestId for crate::operation::resend_contact_reachability_email::ResendContactReachabilityEmailError {
