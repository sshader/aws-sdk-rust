...
impl DeleteTagsForDomainFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_tags_for_domain::DeleteTagsForDomainOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_tags_for_domain::DeleteTagsForDomainError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_tags_for_domain::DeleteTagsForDomainOutput, crate::operation::delete_tags_for_domain::DeleteTagsForDomainError, Self> {
