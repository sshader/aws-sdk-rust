...
impl EnableDomainAutoRenewFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewOutput, crate::operation::enable_domain_auto_renew::EnableDomainAutoRenewError, Self> {
