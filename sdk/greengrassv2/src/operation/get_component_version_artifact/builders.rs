...
impl GetComponentVersionArtifactFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_component_version_artifact::GetComponentVersionArtifactOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_component_version_artifact::GetComponentVersionArtifactError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_component_version_artifact::GetComponentVersionArtifactOutput, crate::operation::get_component_version_artifact::GetComponentVersionArtifactError, Self> {
