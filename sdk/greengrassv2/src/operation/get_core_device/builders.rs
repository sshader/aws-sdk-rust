...
impl GetCoreDeviceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_core_device::GetCoreDeviceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_core_device::GetCoreDeviceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_core_device::GetCoreDeviceOutput, crate::operation::get_core_device::GetCoreDeviceError, Self> {
