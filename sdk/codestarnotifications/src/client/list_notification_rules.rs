...
impl super::Client {
    ...
    ///   - [`filters(ListNotificationRulesFilter)`](crate::operation::list_notification_rules::builders::ListNotificationRulesFluentBuilder::filters) / [`set_filters(Option<Vec::<ListNotificationRulesFilter>>)`](crate::operation::list_notification_rules::builders::ListNotificationRulesFluentBuilder::set_filters):<br>required: **false**<br><p>The filters to use to return information by service or resource type. For valid values, see <code>ListNotificationRulesFilter</code>.</p> <note>   <p>A filter with the same name can appear more than once when used with OR statements. Filters with different names should be applied with AND statements.</p>  </note><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_notification_rules::builders::ListNotificationRulesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_notification_rules::builders::ListNotificationRulesFluentBuilder::set_next_token):<br>required: **false**<br><p>An enumeration token that, when provided in a request, returns the next batch of the results.</p><br>
