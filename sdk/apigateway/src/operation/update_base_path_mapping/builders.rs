...
impl UpdateBasePathMappingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_base_path_mapping::UpdateBasePathMappingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_base_path_mapping::UpdateBasePathMappingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_base_path_mapping::UpdateBasePathMappingOutput, crate::operation::update_base_path_mapping::UpdateBasePathMappingError, Self> {
