...
pub fn ser_budget(
    ...
    if let Some(var_20) = &input.last_updated_time {
        object.key("LastUpdatedTime").date_time(var_20, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
...
pub(crate) fn de_budget<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::Budget>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::budget_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
