        ...
        ::std::result::Result::Ok(
            crate::types::Budget {
                budget_name: self.budget_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("budget_name", "budget_name was not specified but it is required when building Budget")
                    )?
                ,
                ...
                time_unit: self.time_unit
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("time_unit", "time_unit was not specified but it is required when building Budget")
                    )?
                ,
                ...
                budget_type: self.budget_type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("budget_type", "budget_type was not specified but it is required when building Budget")
                    )?
                ,
