...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_trust_anchor::builders::CreateTrustAnchorFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_trust_anchor::builders::CreateTrustAnchorFluentBuilder::set_name):<br>required: **true**<br><p>The name of the trust anchor.</p><br>
    ///   - [`source(Source)`](crate::operation::create_trust_anchor::builders::CreateTrustAnchorFluentBuilder::source) / [`set_source(Option<Source>)`](crate::operation::create_trust_anchor::builders::CreateTrustAnchorFluentBuilder::set_source):<br>required: **true**<br><p>The trust anchor type and its related certificate data.</p><br>
    ///   - [`enabled(bool)`](crate::operation::create_trust_anchor::builders::CreateTrustAnchorFluentBuilder::enabled) / [`set_enabled(Option<bool>)`](crate::operation::create_trust_anchor::builders::CreateTrustAnchorFluentBuilder::set_enabled):<br>required: **false**<br><p>Specifies whether the trust anchor is enabled.</p><br>
