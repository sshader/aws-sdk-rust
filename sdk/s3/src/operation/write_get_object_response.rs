...
#[derive(Debug)]
                    ...
                    let endpoint_prefix =
     {
        ...
        if request_route.is_empty() {
                                        return Err(::aws_smithy_http::endpoint::error::InvalidEndpointError::failed_to_construct_uri("request_route was unset or empty but must be set as part of the endpoint prefix").into());
                                    }
