...
impl AttachLoadBalancerTlsCertificate {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AttachLoadBalancerTlsCertificate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AttachLoadBalancerTlsCertificate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AttachLoadBalancerTlsCertificateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AttachLoadBalancerTlsCertificateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AttachLoadBalancerTlsCertificate")
                            .with_interceptor(AttachLoadBalancerTlsCertificateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct AttachLoadBalancerTlsCertificateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AttachLoadBalancerTlsCertificateResponseDeserializer {
...
#[derive(Debug)]
            struct AttachLoadBalancerTlsCertificateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AttachLoadBalancerTlsCertificateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_attach_load_balancer_tls_certificate::ser_attach_load_balancer_tls_certificate_input(&input)?);
...
#[derive(Debug)]
            struct AttachLoadBalancerTlsCertificateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AttachLoadBalancerTlsCertificateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AttachLoadBalancerTlsCertificateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AttachLoadBalancerTlsCertificateInput>()
                        .ok_or("failed to downcast to AttachLoadBalancerTlsCertificateInput")?;
...
pub enum AttachLoadBalancerTlsCertificateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AttachLoadBalancerTlsCertificateError) for what information is available for the error.")]
...
impl AttachLoadBalancerTlsCertificateError {
    /// Creates the `AttachLoadBalancerTlsCertificateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AttachLoadBalancerTlsCertificateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AttachLoadBalancerTlsCertificateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateError {
