...
impl DeleteInstanceSnapshotFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_instance_snapshot::DeleteInstanceSnapshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_instance_snapshot::DeleteInstanceSnapshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_instance_snapshot::DeleteInstanceSnapshotOutput, crate::operation::delete_instance_snapshot::DeleteInstanceSnapshotError, Self> {
