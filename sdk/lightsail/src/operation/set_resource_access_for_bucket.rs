...
impl SetResourceAccessForBucket {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetResourceAccessForBucket {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetResourceAccessForBucket");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetResourceAccessForBucketRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetResourceAccessForBucketResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetResourceAccessForBucket")
                            .with_interceptor(SetResourceAccessForBucketEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct SetResourceAccessForBucketResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetResourceAccessForBucketResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_set_resource_access_for_bucket::de_set_resource_access_for_bucket_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct SetResourceAccessForBucketRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetResourceAccessForBucketRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_resource_access_for_bucket::ser_set_resource_access_for_bucket_input(&input)?);
...
#[derive(Debug)]
            struct SetResourceAccessForBucketEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetResourceAccessForBucketEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetResourceAccessForBucketEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetResourceAccessForBucketInput>()
                        .ok_or("failed to downcast to SetResourceAccessForBucketInput")?;
...
pub enum SetResourceAccessForBucketError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetResourceAccessForBucketError) for what information is available for the error.")]
...
impl SetResourceAccessForBucketError {
    /// Creates the `SetResourceAccessForBucketError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetResourceAccessForBucketError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetResourceAccessForBucketError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketError {
