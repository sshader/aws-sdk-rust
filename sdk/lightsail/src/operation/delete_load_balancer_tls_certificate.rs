...
impl DeleteLoadBalancerTlsCertificate {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteLoadBalancerTlsCertificate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteLoadBalancerTlsCertificate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteLoadBalancerTlsCertificateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteLoadBalancerTlsCertificateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteLoadBalancerTlsCertificate")
                            .with_interceptor(DeleteLoadBalancerTlsCertificateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DeleteLoadBalancerTlsCertificateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteLoadBalancerTlsCertificateResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteLoadBalancerTlsCertificateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteLoadBalancerTlsCertificateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_load_balancer_tls_certificate::ser_delete_load_balancer_tls_certificate_input(&input)?);
...
#[derive(Debug)]
            struct DeleteLoadBalancerTlsCertificateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteLoadBalancerTlsCertificateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteLoadBalancerTlsCertificateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteLoadBalancerTlsCertificateInput>()
                        .ok_or("failed to downcast to DeleteLoadBalancerTlsCertificateInput")?;
...
pub enum DeleteLoadBalancerTlsCertificateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteLoadBalancerTlsCertificateError) for what information is available for the error.")]
...
impl DeleteLoadBalancerTlsCertificateError {
    /// Creates the `DeleteLoadBalancerTlsCertificateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteLoadBalancerTlsCertificateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteLoadBalancerTlsCertificateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateError {
