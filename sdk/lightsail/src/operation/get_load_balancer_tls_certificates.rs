...
impl GetLoadBalancerTlsCertificates {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetLoadBalancerTlsCertificates {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetLoadBalancerTlsCertificates");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetLoadBalancerTlsCertificatesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetLoadBalancerTlsCertificatesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetLoadBalancerTlsCertificates")
                            .with_interceptor(GetLoadBalancerTlsCertificatesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetLoadBalancerTlsCertificatesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetLoadBalancerTlsCertificatesResponseDeserializer {
...
#[derive(Debug)]
            struct GetLoadBalancerTlsCertificatesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLoadBalancerTlsCertificatesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_load_balancer_tls_certificates::ser_get_load_balancer_tls_certificates_input(&input)?);
...
#[derive(Debug)]
            struct GetLoadBalancerTlsCertificatesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetLoadBalancerTlsCertificatesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetLoadBalancerTlsCertificatesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetLoadBalancerTlsCertificatesInput>()
                        .ok_or("failed to downcast to GetLoadBalancerTlsCertificatesInput")?;
...
pub enum GetLoadBalancerTlsCertificatesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetLoadBalancerTlsCertificatesError) for what information is available for the error.")]
...
impl GetLoadBalancerTlsCertificatesError {
    /// Creates the `GetLoadBalancerTlsCertificatesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetLoadBalancerTlsCertificatesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetLoadBalancerTlsCertificatesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesError {
