...
impl GetContainerServiceDeployments {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_container_service_deployments::GetContainerServiceDeploymentsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_container_service_deployments::GetContainerServiceDeploymentsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_container_service_deployments::GetContainerServiceDeploymentsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_container_service_deployments::GetContainerServiceDeploymentsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetContainerServiceDeployments {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetContainerServiceDeployments");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetContainerServiceDeploymentsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetContainerServiceDeploymentsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetContainerServiceDeployments")
                            .with_interceptor(GetContainerServiceDeploymentsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_container_service_deployments::GetContainerServiceDeploymentsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_container_service_deployments::GetContainerServiceDeploymentsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_container_service_deployments::GetContainerServiceDeploymentsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetContainerServiceDeploymentsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetContainerServiceDeploymentsResponseDeserializer {
...
#[derive(Debug)]
            struct GetContainerServiceDeploymentsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetContainerServiceDeploymentsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_container_service_deployments::GetContainerServiceDeploymentsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_container_service_deployments::GetContainerServiceDeploymentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_container_service_deployments::ser_get_container_service_deployments_input(&input)?);
...
#[derive(Debug)]
            struct GetContainerServiceDeploymentsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetContainerServiceDeploymentsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetContainerServiceDeploymentsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetContainerServiceDeploymentsInput>()
                        .ok_or("failed to downcast to GetContainerServiceDeploymentsInput")?;
...
pub enum GetContainerServiceDeploymentsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetContainerServiceDeploymentsError) for what information is available for the error.")]
...
impl GetContainerServiceDeploymentsError {
    /// Creates the `GetContainerServiceDeploymentsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetContainerServiceDeploymentsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetContainerServiceDeploymentsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_container_service_deployments::GetContainerServiceDeploymentsError {
