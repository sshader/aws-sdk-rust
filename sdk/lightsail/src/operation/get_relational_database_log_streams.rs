...
impl GetRelationalDatabaseLogStreams {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_relational_database_log_streams::GetRelationalDatabaseLogStreamsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_relational_database_log_streams::GetRelationalDatabaseLogStreamsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_relational_database_log_streams::GetRelationalDatabaseLogStreamsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_relational_database_log_streams::GetRelationalDatabaseLogStreamsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRelationalDatabaseLogStreams {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetRelationalDatabaseLogStreams");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetRelationalDatabaseLogStreamsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetRelationalDatabaseLogStreamsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRelationalDatabaseLogStreams")
                            .with_interceptor(GetRelationalDatabaseLogStreamsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_relational_database_log_streams::GetRelationalDatabaseLogStreamsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_relational_database_log_streams::GetRelationalDatabaseLogStreamsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_relational_database_log_streams::GetRelationalDatabaseLogStreamsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetRelationalDatabaseLogStreamsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRelationalDatabaseLogStreamsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_relational_database_log_streams::de_get_relational_database_log_streams_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetRelationalDatabaseLogStreamsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRelationalDatabaseLogStreamsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_relational_database_log_streams::GetRelationalDatabaseLogStreamsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_relational_database_log_streams::GetRelationalDatabaseLogStreamsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_relational_database_log_streams::ser_get_relational_database_log_streams_input(&input)?);
...
#[derive(Debug)]
            struct GetRelationalDatabaseLogStreamsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRelationalDatabaseLogStreamsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetRelationalDatabaseLogStreamsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetRelationalDatabaseLogStreamsInput>()
                        .ok_or("failed to downcast to GetRelationalDatabaseLogStreamsInput")?;
...
pub enum GetRelationalDatabaseLogStreamsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetRelationalDatabaseLogStreamsError) for what information is available for the error.")]
...
impl GetRelationalDatabaseLogStreamsError {
    /// Creates the `GetRelationalDatabaseLogStreamsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetRelationalDatabaseLogStreamsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetRelationalDatabaseLogStreamsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_relational_database_log_streams::GetRelationalDatabaseLogStreamsError {
