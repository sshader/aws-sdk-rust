...
impl GetRelationalDatabaseLogEvents {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRelationalDatabaseLogEvents {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetRelationalDatabaseLogEvents");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetRelationalDatabaseLogEventsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetRelationalDatabaseLogEventsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRelationalDatabaseLogEvents")
                            .with_interceptor(GetRelationalDatabaseLogEventsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetRelationalDatabaseLogEventsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRelationalDatabaseLogEventsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_relational_database_log_events::de_get_relational_database_log_events_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetRelationalDatabaseLogEventsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRelationalDatabaseLogEventsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_relational_database_log_events::ser_get_relational_database_log_events_input(&input)?);
...
#[derive(Debug)]
            struct GetRelationalDatabaseLogEventsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRelationalDatabaseLogEventsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetRelationalDatabaseLogEventsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetRelationalDatabaseLogEventsInput>()
                        .ok_or("failed to downcast to GetRelationalDatabaseLogEventsInput")?;
...
pub enum GetRelationalDatabaseLogEventsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetRelationalDatabaseLogEventsError) for what information is available for the error.")]
...
impl GetRelationalDatabaseLogEventsError {
    /// Creates the `GetRelationalDatabaseLogEventsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetRelationalDatabaseLogEventsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetRelationalDatabaseLogEventsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsError {
