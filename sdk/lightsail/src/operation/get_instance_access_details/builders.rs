...
impl GetInstanceAccessDetailsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_instance_access_details::GetInstanceAccessDetailsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_instance_access_details::GetInstanceAccessDetailsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_instance_access_details::GetInstanceAccessDetailsOutput, crate::operation::get_instance_access_details::GetInstanceAccessDetailsError, Self> {
