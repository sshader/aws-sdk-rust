...
impl GetContainerServiceMetricData {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetContainerServiceMetricData {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetContainerServiceMetricData");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetContainerServiceMetricDataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetContainerServiceMetricDataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetContainerServiceMetricData")
                            .with_interceptor(GetContainerServiceMetricDataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetContainerServiceMetricDataResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetContainerServiceMetricDataResponseDeserializer {
...
#[derive(Debug)]
            struct GetContainerServiceMetricDataRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetContainerServiceMetricDataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    let inner_1 = &_input.metric_name;
    let inner_1 = inner_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("metric_name", "cannot be empty or unset"))?;
    ...
    let inner_5 = inner_5.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("statistics", "cannot be empty or unset"))?;
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_container_service_metric_data::ser_get_container_service_metric_data_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetContainerServiceMetricDataEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetContainerServiceMetricDataInput>()
                        .ok_or("failed to downcast to GetContainerServiceMetricDataInput")?;
...
pub enum GetContainerServiceMetricDataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetContainerServiceMetricDataError) for what information is available for the error.")]
...
impl GetContainerServiceMetricDataError {
    /// Creates the `GetContainerServiceMetricDataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetContainerServiceMetricDataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetContainerServiceMetricDataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataError {
