...
impl CreateLoadBalancerTlsCertificate {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateLoadBalancerTlsCertificate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateLoadBalancerTlsCertificate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateLoadBalancerTlsCertificateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateLoadBalancerTlsCertificateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateLoadBalancerTlsCertificate")
                            .with_interceptor(CreateLoadBalancerTlsCertificateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct CreateLoadBalancerTlsCertificateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateLoadBalancerTlsCertificateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_create_load_balancer_tls_certificate::de_create_load_balancer_tls_certificate_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateLoadBalancerTlsCertificateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateLoadBalancerTlsCertificateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_load_balancer_tls_certificate::ser_create_load_balancer_tls_certificate_input(&input)?);
...
#[derive(Debug)]
            struct CreateLoadBalancerTlsCertificateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateLoadBalancerTlsCertificateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateLoadBalancerTlsCertificateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateLoadBalancerTlsCertificateInput>()
                        .ok_or("failed to downcast to CreateLoadBalancerTlsCertificateInput")?;
...
pub enum CreateLoadBalancerTlsCertificateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateLoadBalancerTlsCertificateError) for what information is available for the error.")]
...
impl CreateLoadBalancerTlsCertificateError {
    /// Creates the `CreateLoadBalancerTlsCertificateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateLoadBalancerTlsCertificateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateLoadBalancerTlsCertificateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateError {
