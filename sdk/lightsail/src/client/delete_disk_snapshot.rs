...
impl super::Client {
    ...
    ///   - [`disk_snapshot_name(impl Into<String>)`](crate::operation::delete_disk_snapshot::builders::DeleteDiskSnapshotFluentBuilder::disk_snapshot_name) / [`set_disk_snapshot_name(Option<String>)`](crate::operation::delete_disk_snapshot::builders::DeleteDiskSnapshotFluentBuilder::set_disk_snapshot_name):<br>required: **true**<br><p>The name of the disk snapshot you want to delete (e.g., <code>my-disk-snapshot</code>).</p><br>
