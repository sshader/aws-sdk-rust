...
impl GetIdentityNotificationAttributesOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_identity_notification_attributes::GetIdentityNotificationAttributesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_identity_notification_attributes::GetIdentityNotificationAttributesOutput {
                notification_attributes: self.notification_attributes
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("notification_attributes", "notification_attributes was not specified but it is required when building GetIdentityNotificationAttributesOutput")
                    )?
                ,
