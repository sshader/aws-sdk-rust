    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateConfigurationSetTrackingOptions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateConfigurationSetTrackingOptions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateConfigurationSetTrackingOptionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateConfigurationSetTrackingOptionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateConfigurationSetTrackingOptions")
                            .with_interceptor(UpdateConfigurationSetTrackingOptionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptionsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateConfigurationSetTrackingOptionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_update_configuration_set_tracking_options::de_update_configuration_set_tracking_options_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateConfigurationSetTrackingOptionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_configuration_set_tracking_options_input::ser_update_configuration_set_tracking_options_input_input_input(&input)?);
...
#[derive(Debug)]
            struct UpdateConfigurationSetTrackingOptionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateConfigurationSetTrackingOptionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateConfigurationSetTrackingOptionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateConfigurationSetTrackingOptionsInput>()
                        .ok_or("failed to downcast to UpdateConfigurationSetTrackingOptionsInput")?;
...
pub enum UpdateConfigurationSetTrackingOptionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateConfigurationSetTrackingOptionsError) for what information is available for the error.")]
...
impl UpdateConfigurationSetTrackingOptionsError {
    /// Creates the `UpdateConfigurationSetTrackingOptionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateConfigurationSetTrackingOptionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateConfigurationSetTrackingOptionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptionsError {
