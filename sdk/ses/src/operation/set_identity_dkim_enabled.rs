...
impl SetIdentityDkimEnabled {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabledOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabledError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabledError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabledOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetIdentityDkimEnabled {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetIdentityDkimEnabled");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetIdentityDkimEnabledRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetIdentityDkimEnabledResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetIdentityDkimEnabled")
                            .with_interceptor(SetIdentityDkimEnabledEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabledError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabledError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabledError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetIdentityDkimEnabledResponseDeserializer {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetIdentityDkimEnabledRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabledInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabledInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_identity_dkim_enabled_input::ser_set_identity_dkim_enabled_input_input_input(&input)?);
...
#[derive(Debug)]
            struct SetIdentityDkimEnabledEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetIdentityDkimEnabledEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetIdentityDkimEnabledEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetIdentityDkimEnabledInput>()
                        .ok_or("failed to downcast to SetIdentityDkimEnabledInput")?;
...
pub enum SetIdentityDkimEnabledError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetIdentityDkimEnabledError) for what information is available for the error.")]
...
impl SetIdentityDkimEnabledError {
    /// Creates the `SetIdentityDkimEnabledError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetIdentityDkimEnabledError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetIdentityDkimEnabledError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabledError {
