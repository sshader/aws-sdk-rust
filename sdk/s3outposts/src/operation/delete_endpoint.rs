...
fn uri_query(_input: &crate::operation::delete_endpoint::DeleteEndpointInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    let inner_1 = &_input.endpoint_id;
    let inner_1 = inner_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("endpoint_id", "cannot be empty or unset"))?;
    if inner_1.is_empty() {
    ...
    let inner_2 = inner_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("outpost_id", "cannot be empty or unset"))?;
    if inner_2.is_empty() {
