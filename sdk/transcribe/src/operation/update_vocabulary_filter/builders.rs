...
impl UpdateVocabularyFilterFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_vocabulary_filter::UpdateVocabularyFilterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_vocabulary_filter::UpdateVocabularyFilterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_vocabulary_filter::UpdateVocabularyFilterOutput, crate::operation::update_vocabulary_filter::UpdateVocabularyFilterError, Self> {
