...
impl DeleteProjectVersionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_project_version::DeleteProjectVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_project_version::DeleteProjectVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_project_version::DeleteProjectVersionOutput, crate::operation::delete_project_version::DeleteProjectVersionError, Self> {
