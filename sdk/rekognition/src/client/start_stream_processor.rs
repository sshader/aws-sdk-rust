...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::start_stream_processor::builders::StartStreamProcessorFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::start_stream_processor::builders::StartStreamProcessorFluentBuilder::set_name):<br>required: **true**<br><p>The name of the stream processor to start processing.</p><br>
    ///   - [`start_selector(StreamProcessingStartSelector)`](crate::operation::start_stream_processor::builders::StartStreamProcessorFluentBuilder::start_selector) / [`set_start_selector(Option<StreamProcessingStartSelector>)`](crate::operation::start_stream_processor::builders::StartStreamProcessorFluentBuilder::set_start_selector):<br>required: **false**<br><p> Specifies the starting point in the Kinesis stream to start processing. You can use the producer timestamp or the fragment number. If you use the producer timestamp, you must put the time in milliseconds. For more information about fragment numbers, see <a href="https://docs.aws.amazon.com/kinesisvideostreams/latest/dg/API_reader_Fragment.html">Fragment</a>. </p>  <p>This is a required parameter for label detection stream processors and should not be used to start a face search stream processor.</p><br>
    ///   - [`stop_selector(StreamProcessingStopSelector)`](crate::operation::start_stream_processor::builders::StartStreamProcessorFluentBuilder::stop_selector) / [`set_stop_selector(Option<StreamProcessingStopSelector>)`](crate::operation::start_stream_processor::builders::StartStreamProcessorFluentBuilder::set_stop_selector):<br>required: **false**<br><p> Specifies when to stop processing the stream. You can specify a maximum amount of time to process the video. </p>  <p>This is a required parameter for label detection stream processors and should not be used to start a face search stream processor.</p><br>
