...
impl ListChangedBlocksFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_changed_blocks::ListChangedBlocksOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_changed_blocks::ListChangedBlocksError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_changed_blocks::ListChangedBlocksOutput, crate::operation::list_changed_blocks::ListChangedBlocksError, Self> {
