...
impl EnableDelegatedAdminAccountOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::enable_delegated_admin_account::EnableDelegatedAdminAccountOutput {
                delegated_admin_account_id: self.delegated_admin_account_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("delegated_admin_account_id", "delegated_admin_account_id was not specified but it is required when building EnableDelegatedAdminAccountOutput")
                    )?
                ,
