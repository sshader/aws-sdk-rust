...
pub fn de_upload_multipart_part_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::upload_multipart_part::UploadMultipartPartOutput, crate::operation::upload_multipart_part::UploadMultipartPartError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_upload_multipart_part_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::upload_multipart_part::UploadMultipartPartOutput, crate::operation::upload_multipart_part::UploadMultipartPartError> {
    Ok({
        #[allow(unused_mut)]
