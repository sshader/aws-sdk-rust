...
impl super::Client {
    ...
    ///   - [`vault_name(impl Into<String>)`](crate::operation::delete_vault_notifications::builders::DeleteVaultNotificationsFluentBuilder::vault_name) / [`set_vault_name(Option<String>)`](crate::operation::delete_vault_notifications::builders::DeleteVaultNotificationsFluentBuilder::set_vault_name):<br>required: **true**<br><p>The name of the vault.</p><br>
