...
impl super::Client {
    ...
    ///   - [`vault_name(impl Into<String>)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::vault_name) / [`set_vault_name(Option<String>)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::set_vault_name):<br>required: **true**<br><p>The name of the vault.</p><br>
    ...
    ///   - [`archive_description(impl Into<String>)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::archive_description) / [`set_archive_description(Option<String>)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::set_archive_description):<br>required: **false**<br><p>The optional description of the archive you are uploading.</p><br>
    ///   - [`checksum(impl Into<String>)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::checksum) / [`set_checksum(Option<String>)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::set_checksum):<br>required: **false**<br><p>The SHA256 tree hash of the data being uploaded.</p><br>
    ///   - [`body(ByteStream)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::body) / [`set_body(ByteStream)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::set_body):<br>required: **false**<br><p>The data to upload.</p><br>
