...
impl ListProvisionedCapacityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_provisioned_capacity::ListProvisionedCapacityInput, ::aws_smithy_types::error::operation::BuildError> {
