...
.with_interceptor(crate::glacier_interceptors::GlacierAccountIdAutofillInterceptor::<crate::operation::complete_multipart_upload::CompleteMultipartUploadInput>::new())
