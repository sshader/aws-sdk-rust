    ...
    pub fn build(self) -> ::std::result::Result<crate::types::RedshiftDestinationProperties, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::RedshiftDestinationProperties {
                object: self.object
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("object", "object was not specified but it is required when building RedshiftDestinationProperties")
                    )?
                ,
                intermediate_bucket_name: self.intermediate_bucket_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("intermediate_bucket_name", "intermediate_bucket_name was not specified but it is required when building RedshiftDestinationProperties")
                    )?
                ,
