...
impl CreateFirewallDomainListInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_firewall_domain_list::CreateFirewallDomainListInput, ::aws_smithy_types::error::operation::BuildError> {
