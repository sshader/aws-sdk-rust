...
impl ListFirewallRulesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_firewall_rules::ListFirewallRulesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_firewall_rules::ListFirewallRulesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_firewall_rules::ListFirewallRulesOutput, crate::operation::list_firewall_rules::ListFirewallRulesError, Self> {
