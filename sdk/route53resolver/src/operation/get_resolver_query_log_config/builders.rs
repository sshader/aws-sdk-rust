...
impl GetResolverQueryLogConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_resolver_query_log_config::GetResolverQueryLogConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_resolver_query_log_config::GetResolverQueryLogConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_resolver_query_log_config::GetResolverQueryLogConfigOutput, crate::operation::get_resolver_query_log_config::GetResolverQueryLogConfigError, Self> {
