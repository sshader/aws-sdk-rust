...
impl ListFirewallDomainListsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_firewall_domain_lists::ListFirewallDomainListsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_firewall_domain_lists::ListFirewallDomainListsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_firewall_domain_lists::ListFirewallDomainListsOutput, crate::operation::list_firewall_domain_lists::ListFirewallDomainListsError, Self> {
