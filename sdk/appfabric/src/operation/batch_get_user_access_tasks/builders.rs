...
impl BatchGetUserAccessTasksFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_get_user_access_tasks::BatchGetUserAccessTasksOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_get_user_access_tasks::BatchGetUserAccessTasksError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_get_user_access_tasks::BatchGetUserAccessTasksOutput, crate::operation::batch_get_user_access_tasks::BatchGetUserAccessTasksError, Self> {
