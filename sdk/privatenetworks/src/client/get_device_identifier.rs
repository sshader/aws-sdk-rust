...
impl super::Client {
    ...
    ///   - [`device_identifier_arn(impl Into<String>)`](crate::operation::get_device_identifier::builders::GetDeviceIdentifierFluentBuilder::device_identifier_arn) / [`set_device_identifier_arn(Option<String>)`](crate::operation::get_device_identifier::builders::GetDeviceIdentifierFluentBuilder::set_device_identifier_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the device identifier.</p><br>
