                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "KendraSettings" => {
                                builder = builder.set_kendra_settings(
                                    crate::protocol_serde::shape_kendra_settings::de_kendra_settings(tokens)?
                                );
                            }
                            "DirectDeploySettings" => {
                                builder = builder.set_direct_deploy_settings(
                                    crate::protocol_serde::shape_direct_deploy_settings::de_direct_deploy_settings(tokens)?
                                );
                            }
