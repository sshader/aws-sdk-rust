...
pub fn de_describe_training_job_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_training_job::DescribeTrainingJobOutput, crate::operation::describe_training_job::DescribeTrainingJobError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_training_job_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_training_job::DescribeTrainingJobOutput, crate::operation::describe_training_job::DescribeTrainingJobError> {
    Ok({
        #[allow(unused_mut)]
        ...
        crate::serde_util::describe_training_job_output_output_correct_errors(output).build()
    })
}

pub fn ser_describe_training_job_input(input: &crate::operation::describe_training_job::DescribeTrainingJobInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_describe_training_job_input::ser_describe_training_job_input_input(&mut object, input)?;
    object.finish();
