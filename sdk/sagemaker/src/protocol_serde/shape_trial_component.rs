...
pub(crate) fn de_trial_component<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TrialComponent>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::TrialComponentBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "SourceDetail" => {
                                builder = builder.set_source_detail(
                                    crate::protocol_serde::shape_trial_component_source_detail::de_trial_component_source_detail(tokens)?
                                );
                            }
                            "LineageGroupArn" => {
