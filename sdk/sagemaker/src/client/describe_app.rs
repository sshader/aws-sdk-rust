...
impl super::Client {
    ...
    ///   - [`domain_id(impl Into<String>)`](crate::operation::describe_app::builders::DescribeAppFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::describe_app::builders::DescribeAppFluentBuilder::set_domain_id):<br>required: **true**<br><p>The domain ID.</p><br>
    ...
    ///   - [`app_type(AppType)`](crate::operation::describe_app::builders::DescribeAppFluentBuilder::app_type) / [`set_app_type(Option<AppType>)`](crate::operation::describe_app::builders::DescribeAppFluentBuilder::set_app_type):<br>required: **true**<br><p>The type of app.</p><br>
    ///   - [`app_name(impl Into<String>)`](crate::operation::describe_app::builders::DescribeAppFluentBuilder::app_name) / [`set_app_name(Option<String>)`](crate::operation::describe_app::builders::DescribeAppFluentBuilder::set_app_name):<br>required: **true**<br><p>The name of the app.</p><br>
    ///   - [`space_name(impl Into<String>)`](crate::operation::describe_app::builders::DescribeAppFluentBuilder::space_name) / [`set_space_name(Option<String>)`](crate::operation::describe_app::builders::DescribeAppFluentBuilder::set_space_name):<br>required: **false**<br><p>The name of the space.</p><br>
