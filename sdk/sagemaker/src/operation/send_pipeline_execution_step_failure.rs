    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::send_pipeline_execution_step_failure::SendPipelineExecutionStepFailureError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::send_pipeline_execution_step_failure::SendPipelineExecutionStepFailureOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                ...
                                let input: &mut crate::operation::send_pipeline_execution_step_failure::SendPipelineExecutionStepFailureInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SendPipelineExecutionStepFailure {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SendPipelineExecutionStepFailure");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SendPipelineExecutionStepFailureRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SendPipelineExecutionStepFailureResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SendPipelineExecutionStepFailure")
                            .with_interceptor(SendPipelineExecutionStepFailureEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::send_pipeline_execution_step_failure::SendPipelineExecutionStepFailureError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::send_pipeline_execution_step_failure::SendPipelineExecutionStepFailureError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::send_pipeline_execution_step_failure::SendPipelineExecutionStepFailureError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct SendPipelineExecutionStepFailureResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SendPipelineExecutionStepFailureResponseDeserializer {
...
#[derive(Debug)]
            struct SendPipelineExecutionStepFailureRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SendPipelineExecutionStepFailureRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::send_pipeline_execution_step_failure::SendPipelineExecutionStepFailureInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::send_pipeline_execution_step_failure::SendPipelineExecutionStepFailureInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_send_pipeline_execution_step_failure::ser_send_pipeline_execution_step_failure_input(&input)?);
...
#[derive(Debug)]
            struct SendPipelineExecutionStepFailureEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SendPipelineExecutionStepFailureEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SendPipelineExecutionStepFailureEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SendPipelineExecutionStepFailureInput>()
                        .ok_or("failed to downcast to SendPipelineExecutionStepFailureInput")?;
...
pub enum SendPipelineExecutionStepFailureError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SendPipelineExecutionStepFailureError) for what information is available for the error.")]
...
impl SendPipelineExecutionStepFailureError {
    /// Creates the `SendPipelineExecutionStepFailureError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SendPipelineExecutionStepFailureError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SendPipelineExecutionStepFailureError {
...
impl ::aws_types::request_id::RequestId for crate::operation::send_pipeline_execution_step_failure::SendPipelineExecutionStepFailureError {
