...
impl DescribeCompilationJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_compilation_job::DescribeCompilationJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_compilation_job::DescribeCompilationJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_compilation_job::DescribeCompilationJobOutput, crate::operation::describe_compilation_job::DescribeCompilationJobError, Self> {
