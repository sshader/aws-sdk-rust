...
impl StopTransformJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_transform_job::StopTransformJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_transform_job::StopTransformJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_transform_job::StopTransformJobOutput, crate::operation::stop_transform_job::StopTransformJobError, Self> {
