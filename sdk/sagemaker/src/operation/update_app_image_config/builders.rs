...
impl UpdateAppImageConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_app_image_config::UpdateAppImageConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_app_image_config::UpdateAppImageConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_app_image_config::UpdateAppImageConfigOutput, crate::operation::update_app_image_config::UpdateAppImageConfigError, Self> {
