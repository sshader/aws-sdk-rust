...
impl ListTrialComponentsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_trial_components::ListTrialComponentsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_trial_components::ListTrialComponentsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_trial_components::ListTrialComponentsOutput, crate::operation::list_trial_components::ListTrialComponentsError, Self> {
