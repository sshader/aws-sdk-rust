    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGeneratorsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGeneratorsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListLicenseManagerReportGenerators {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListLicenseManagerReportGenerators");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListLicenseManagerReportGeneratorsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListLicenseManagerReportGeneratorsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListLicenseManagerReportGenerators")
                            .with_interceptor(ListLicenseManagerReportGeneratorsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGeneratorsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGeneratorsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGeneratorsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct ListLicenseManagerReportGeneratorsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListLicenseManagerReportGeneratorsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_list_license_manager_report_generators::de_list_license_manager_report_generators_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListLicenseManagerReportGeneratorsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListLicenseManagerReportGeneratorsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGeneratorsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGeneratorsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_license_manager_report_generators::ser_list_license_manager_report_generators_input(&input)?);
...
#[derive(Debug)]
            struct ListLicenseManagerReportGeneratorsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListLicenseManagerReportGeneratorsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListLicenseManagerReportGeneratorsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListLicenseManagerReportGeneratorsInput>()
                        .ok_or("failed to downcast to ListLicenseManagerReportGeneratorsInput")?;
...
pub enum ListLicenseManagerReportGeneratorsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListLicenseManagerReportGeneratorsError) for what information is available for the error.")]
...
impl ListLicenseManagerReportGeneratorsError {
    /// Creates the `ListLicenseManagerReportGeneratorsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListLicenseManagerReportGeneratorsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListLicenseManagerReportGeneratorsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGeneratorsError {
