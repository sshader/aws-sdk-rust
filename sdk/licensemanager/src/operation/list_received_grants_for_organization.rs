...
impl ListReceivedGrantsForOrganization {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganizationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganizationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganizationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganizationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListReceivedGrantsForOrganization {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListReceivedGrantsForOrganization");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListReceivedGrantsForOrganizationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListReceivedGrantsForOrganizationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListReceivedGrantsForOrganization")
                            .with_interceptor(ListReceivedGrantsForOrganizationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganizationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganizationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganizationError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_list_received_grants_for_organization::de_list_received_grants_for_organization_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListReceivedGrantsForOrganizationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganizationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_received_grants_for_organization::ser_list_received_grants_for_organization_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListReceivedGrantsForOrganizationEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListReceivedGrantsForOrganizationInput>()
                        .ok_or("failed to downcast to ListReceivedGrantsForOrganizationInput")?;
...
pub enum ListReceivedGrantsForOrganizationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListReceivedGrantsForOrganizationError) for what information is available for the error.")]
...
impl ListReceivedGrantsForOrganizationError {
    /// Creates the `ListReceivedGrantsForOrganizationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListReceivedGrantsForOrganizationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListReceivedGrantsForOrganizationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganizationError {
