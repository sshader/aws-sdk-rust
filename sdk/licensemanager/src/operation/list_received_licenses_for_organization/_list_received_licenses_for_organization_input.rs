...
impl ListReceivedLicensesForOrganizationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_received_licenses_for_organization::ListReceivedLicensesForOrganizationInput, ::aws_smithy_types::error::operation::BuildError> {
