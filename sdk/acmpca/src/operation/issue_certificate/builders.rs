...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::issue_certificate::IssueCertificateOutput,
                    crate::operation::issue_certificate::IssueCertificateError,
                > for IssueCertificateFluentBuilder
            {
                fn send(
                    self,
...
impl IssueCertificateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::issue_certificate::IssueCertificateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::issue_certificate::IssueCertificateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::issue_certificate::IssueCertificate::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::issue_certificate::IssueCertificate::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::issue_certificate::IssueCertificateOutput, crate::operation::issue_certificate::IssueCertificateError, Self> {
