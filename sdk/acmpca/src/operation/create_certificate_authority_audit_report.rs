    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCertificateAuthorityAuditReport {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateCertificateAuthorityAuditReport");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateCertificateAuthorityAuditReportRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateCertificateAuthorityAuditReportResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateCertificateAuthorityAuditReport")
                            .with_interceptor(CreateCertificateAuthorityAuditReportEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct CreateCertificateAuthorityAuditReportResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateCertificateAuthorityAuditReportResponseDeserializer {
...
#[derive(Debug)]
            struct CreateCertificateAuthorityAuditReportRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCertificateAuthorityAuditReportRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_certificate_authority_audit_report::ser_create_certificate_authority_audit_report_input(&input)?);
...
#[derive(Debug)]
            struct CreateCertificateAuthorityAuditReportEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateCertificateAuthorityAuditReportEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateCertificateAuthorityAuditReportEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateCertificateAuthorityAuditReportInput>()
                        .ok_or("failed to downcast to CreateCertificateAuthorityAuditReportInput")?;
...
pub enum CreateCertificateAuthorityAuditReportError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateCertificateAuthorityAuditReportError) for what information is available for the error.")]
...
impl CreateCertificateAuthorityAuditReportError {
    /// Creates the `CreateCertificateAuthorityAuditReportError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateCertificateAuthorityAuditReportError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateCertificateAuthorityAuditReportError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportError {
