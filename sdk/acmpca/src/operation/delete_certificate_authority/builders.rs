...
impl DeleteCertificateAuthorityFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_certificate_authority::DeleteCertificateAuthorityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_certificate_authority::DeleteCertificateAuthorityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_certificate_authority::DeleteCertificateAuthorityOutput, crate::operation::delete_certificate_authority::DeleteCertificateAuthorityError, Self> {
