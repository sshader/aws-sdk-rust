...
impl  ListServicesOutput  {
    ...
    pub fn service_summary_list(&self) -> & [crate::types::ServiceSummary] {
        use std::ops::Deref; self.service_summary_list.deref()
    }
    /// <p>The token that you can pass in a subsequent request to get the next result page. It's returned in a paginated request.</p>
        ...
        ::std::result::Result::Ok(
            crate::operation::list_services::ListServicesOutput {
                service_summary_list: self.service_summary_list
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("service_summary_list", "service_summary_list was not specified but it is required when building ListServicesOutput")
                    )?
                ,
