...
impl  ListAutoScalingConfigurationsOutput  {
    ...
    pub fn auto_scaling_configuration_summary_list(&self) -> & [crate::types::AutoScalingConfigurationSummary] {
        use std::ops::Deref; self.auto_scaling_configuration_summary_list.deref()
    }
    /// <p>The token that you can pass in a subsequent request to get the next result page. It's returned in a paginated request.</p>
...
impl ListAutoScalingConfigurationsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_auto_scaling_configurations::ListAutoScalingConfigurationsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_auto_scaling_configurations::ListAutoScalingConfigurationsOutput {
                auto_scaling_configuration_summary_list: self.auto_scaling_configuration_summary_list
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("auto_scaling_configuration_summary_list", "auto_scaling_configuration_summary_list was not specified but it is required when building ListAutoScalingConfigurationsOutput")
                    )?
                ,
