...
impl  ListObservabilityConfigurationsOutput  {
    ...
    pub fn observability_configuration_summary_list(&self) -> & [crate::types::ObservabilityConfigurationSummary] {
        use std::ops::Deref; self.observability_configuration_summary_list.deref()
    }
    /// <p>The token that you can pass in a subsequent request to get the next result page. It's returned in a paginated request.</p>
...
impl ListObservabilityConfigurationsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_observability_configurations::ListObservabilityConfigurationsOutput, ::aws_smithy_types::error::operation::BuildError> {
