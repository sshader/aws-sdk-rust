...
impl  ListVpcIngressConnectionsOutput  {
    ...
    pub fn vpc_ingress_connection_summary_list(&self) -> & [crate::types::VpcIngressConnectionSummary] {
        use std::ops::Deref; self.vpc_ingress_connection_summary_list.deref()
    }
    /// <p>The token that you can pass in a subsequent request to get the next result page. It's returned in a paginated request.</p>
...
impl ListVpcIngressConnectionsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_vpc_ingress_connections::ListVpcIngressConnectionsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_vpc_ingress_connections::ListVpcIngressConnectionsOutput {
                vpc_ingress_connection_summary_list: self.vpc_ingress_connection_summary_list
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("vpc_ingress_connection_summary_list", "vpc_ingress_connection_summary_list was not specified but it is required when building ListVpcIngressConnectionsOutput")
                    )?
                ,
