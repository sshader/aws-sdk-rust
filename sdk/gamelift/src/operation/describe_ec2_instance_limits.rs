...
impl DescribeEC2InstanceLimits {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_ec2_instance_limits::DescribeEc2InstanceLimitsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_ec2_instance_limits::DescribeEC2InstanceLimitsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_ec2_instance_limits::DescribeEC2InstanceLimitsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_ec2_instance_limits::DescribeEc2InstanceLimitsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeEC2InstanceLimits {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeEC2InstanceLimits");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeEC2InstanceLimitsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeEC2InstanceLimitsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeEC2InstanceLimits")
                            .with_interceptor(DescribeEC2InstanceLimitsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_ec2_instance_limits::DescribeEC2InstanceLimitsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_ec2_instance_limits::DescribeEC2InstanceLimitsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_ec2_instance_limits::DescribeEC2InstanceLimitsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DescribeEC2InstanceLimitsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeEC2InstanceLimitsResponseDeserializer {
...
#[derive(Debug)]
            struct DescribeEC2InstanceLimitsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeEC2InstanceLimitsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_ec2_instance_limits::DescribeEc2InstanceLimitsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_ec2_instance_limits::DescribeEc2InstanceLimitsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_ec2_instance_limits::ser_describe_ec2_instance_limits_input(&input)?);
...
#[derive(Debug)]
            struct DescribeEC2InstanceLimitsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeEC2InstanceLimitsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeEC2InstanceLimitsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeEc2InstanceLimitsInput>()
                        .ok_or("failed to downcast to DescribeEc2InstanceLimitsInput")?;
...
pub enum DescribeEC2InstanceLimitsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeEC2InstanceLimitsError) for what information is available for the error.")]
...
impl DescribeEC2InstanceLimitsError {
    /// Creates the `DescribeEC2InstanceLimitsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeEC2InstanceLimitsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeEC2InstanceLimitsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_ec2_instance_limits::DescribeEC2InstanceLimitsError {
