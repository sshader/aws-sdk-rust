...
impl StopFleetActionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_fleet_actions::StopFleetActionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_fleet_actions::StopFleetActionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_fleet_actions::StopFleetActionsOutput, crate::operation::stop_fleet_actions::StopFleetActionsError, Self> {
