...
impl StartGameSessionPlacement {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_game_session_placement::StartGameSessionPlacementOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_game_session_placement::StartGameSessionPlacementError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_game_session_placement::StartGameSessionPlacementError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_game_session_placement::StartGameSessionPlacementOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartGameSessionPlacement {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartGameSessionPlacement");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartGameSessionPlacementRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartGameSessionPlacementResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartGameSessionPlacement")
                            .with_interceptor(StartGameSessionPlacementEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_game_session_placement::StartGameSessionPlacementError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_game_session_placement::StartGameSessionPlacementError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_game_session_placement::StartGameSessionPlacementError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct StartGameSessionPlacementResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartGameSessionPlacementResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_start_game_session_placement::de_start_game_session_placement_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartGameSessionPlacementRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartGameSessionPlacementRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_game_session_placement::StartGameSessionPlacementInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_game_session_placement::StartGameSessionPlacementInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_game_session_placement::ser_start_game_session_placement_input(&input)?);
...
#[derive(Debug)]
            struct StartGameSessionPlacementEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartGameSessionPlacementEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartGameSessionPlacementEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartGameSessionPlacementInput>()
                        .ok_or("failed to downcast to StartGameSessionPlacementInput")?;
...
pub enum StartGameSessionPlacementError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartGameSessionPlacementError) for what information is available for the error.")]
...
impl StartGameSessionPlacementError {
    /// Creates the `StartGameSessionPlacementError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartGameSessionPlacementError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartGameSessionPlacementError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_game_session_placement::StartGameSessionPlacementError {
