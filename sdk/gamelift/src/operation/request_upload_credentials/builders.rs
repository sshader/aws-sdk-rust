...
impl RequestUploadCredentialsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::request_upload_credentials::RequestUploadCredentialsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::request_upload_credentials::RequestUploadCredentialsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::request_upload_credentials::RequestUploadCredentialsOutput, crate::operation::request_upload_credentials::RequestUploadCredentialsError, Self> {
