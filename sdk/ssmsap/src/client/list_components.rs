...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::list_components::builders::ListComponentsFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::list_components::builders::ListComponentsFluentBuilder::set_application_id):<br>required: **false**<br><p>The ID of the application.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_components::builders::ListComponentsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_components::builders::ListComponentsFluentBuilder::set_next_token):<br>required: **false**<br><p>The token for the next page of results.</p><br>
