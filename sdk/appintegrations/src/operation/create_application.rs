...
impl CreateApplicationError {
    ...
    /// Returns `true` if the error kind is `CreateApplicationError::DuplicateResourceException`.
    pub fn is_duplicate_resource_exception(&self) -> bool {
        matches!(self, Self::DuplicateResourceException(_))
    }
    /// Returns `true` if the error kind is `CreateApplicationError::InternalServiceError`.
    ...
    /// Returns `true` if the error kind is `CreateApplicationError::ResourceQuotaExceededException`.
