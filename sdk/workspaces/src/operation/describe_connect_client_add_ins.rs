...
impl DescribeConnectClientAddIns {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_connect_client_add_ins::DescribeConnectClientAddInsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_connect_client_add_ins::DescribeConnectClientAddInsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_connect_client_add_ins::DescribeConnectClientAddInsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_connect_client_add_ins::DescribeConnectClientAddInsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeConnectClientAddIns {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeConnectClientAddIns");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeConnectClientAddInsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeConnectClientAddInsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeConnectClientAddIns")
                            .with_interceptor(DescribeConnectClientAddInsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_connect_client_add_ins::DescribeConnectClientAddInsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_connect_client_add_ins::DescribeConnectClientAddInsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_connect_client_add_ins::DescribeConnectClientAddInsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DescribeConnectClientAddInsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeConnectClientAddInsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_describe_connect_client_add_ins::de_describe_connect_client_add_ins_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeConnectClientAddInsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeConnectClientAddInsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_connect_client_add_ins::DescribeConnectClientAddInsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_connect_client_add_ins::DescribeConnectClientAddInsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_connect_client_add_ins::ser_describe_connect_client_add_ins_input(&input)?);
...
#[derive(Debug)]
            struct DescribeConnectClientAddInsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeConnectClientAddInsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeConnectClientAddInsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeConnectClientAddInsInput>()
                        .ok_or("failed to downcast to DescribeConnectClientAddInsInput")?;
...
pub enum DescribeConnectClientAddInsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeConnectClientAddInsError) for what information is available for the error.")]
...
impl DescribeConnectClientAddInsError {
    /// Creates the `DescribeConnectClientAddInsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeConnectClientAddInsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeConnectClientAddInsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_connect_client_add_ins::DescribeConnectClientAddInsError {
