...
impl DescribeWorkspaceImagesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_workspace_images::DescribeWorkspaceImagesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_workspace_images::DescribeWorkspaceImagesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_workspace_images::DescribeWorkspaceImagesOutput, crate::operation::describe_workspace_images::DescribeWorkspaceImagesError, Self> {
