...
impl GetReportGroupTrendFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_report_group_trend::GetReportGroupTrendOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_report_group_trend::GetReportGroupTrendError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_report_group_trend::GetReportGroupTrendOutput, crate::operation::get_report_group_trend::GetReportGroupTrendError, Self> {
