...
impl ImportSourceCredentials {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::import_source_credentials::ImportSourceCredentialsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::import_source_credentials::ImportSourceCredentialsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::import_source_credentials::ImportSourceCredentialsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::import_source_credentials::ImportSourceCredentialsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ImportSourceCredentials {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ImportSourceCredentials");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ImportSourceCredentialsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ImportSourceCredentialsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ImportSourceCredentials")
                            .with_interceptor(ImportSourceCredentialsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::import_source_credentials::ImportSourceCredentialsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::import_source_credentials::ImportSourceCredentialsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::import_source_credentials::ImportSourceCredentialsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct ImportSourceCredentialsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ImportSourceCredentialsResponseDeserializer {
...
#[derive(Debug)]
            struct ImportSourceCredentialsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ImportSourceCredentialsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::import_source_credentials::ImportSourceCredentialsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::import_source_credentials::ImportSourceCredentialsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_import_source_credentials::ser_import_source_credentials_input(&input)?);
...
#[derive(Debug)]
            struct ImportSourceCredentialsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ImportSourceCredentialsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ImportSourceCredentialsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ImportSourceCredentialsInput>()
                        .ok_or("failed to downcast to ImportSourceCredentialsInput")?;
...
pub enum ImportSourceCredentialsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ImportSourceCredentialsError) for what information is available for the error.")]
...
impl ImportSourceCredentialsError {
    /// Creates the `ImportSourceCredentialsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ImportSourceCredentialsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ImportSourceCredentialsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::import_source_credentials::ImportSourceCredentialsError {
