...
impl DescribeCodeCoveragesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_code_coverages::DescribeCodeCoveragesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_code_coverages::DescribeCodeCoveragesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_code_coverages::DescribeCodeCoveragesOutput, crate::operation::describe_code_coverages::DescribeCodeCoveragesError, Self> {
