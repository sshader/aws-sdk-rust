...
impl ListSharedReportGroupsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_shared_report_groups::ListSharedReportGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_shared_report_groups::ListSharedReportGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_shared_report_groups::ListSharedReportGroupsOutput, crate::operation::list_shared_report_groups::ListSharedReportGroupsError, Self> {
