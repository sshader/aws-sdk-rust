...
impl GetInsightsByAssessmentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_insights_by_assessment::GetInsightsByAssessmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_insights_by_assessment::GetInsightsByAssessmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_insights_by_assessment::GetInsightsByAssessmentOutput, crate::operation::get_insights_by_assessment::GetInsightsByAssessmentError, Self> {
