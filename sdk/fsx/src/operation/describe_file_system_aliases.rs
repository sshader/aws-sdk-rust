...
impl DescribeFileSystemAliases {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_file_system_aliases::DescribeFileSystemAliasesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_file_system_aliases::DescribeFileSystemAliasesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_file_system_aliases::DescribeFileSystemAliasesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_file_system_aliases::DescribeFileSystemAliasesOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                ...
                                let input: &mut crate::operation::describe_file_system_aliases::DescribeFileSystemAliasesInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeFileSystemAliases {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeFileSystemAliases");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeFileSystemAliasesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeFileSystemAliasesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeFileSystemAliases")
                            .with_interceptor(DescribeFileSystemAliasesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_file_system_aliases::DescribeFileSystemAliasesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_file_system_aliases::DescribeFileSystemAliasesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_file_system_aliases::DescribeFileSystemAliasesError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DescribeFileSystemAliasesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeFileSystemAliasesResponseDeserializer {
...
#[derive(Debug)]
            struct DescribeFileSystemAliasesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeFileSystemAliasesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_file_system_aliases::DescribeFileSystemAliasesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_file_system_aliases::DescribeFileSystemAliasesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_file_system_aliases::ser_describe_file_system_aliases_input(&input)?);
...
#[derive(Debug)]
            struct DescribeFileSystemAliasesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeFileSystemAliasesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeFileSystemAliasesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeFileSystemAliasesInput>()
                        .ok_or("failed to downcast to DescribeFileSystemAliasesInput")?;
...
pub enum DescribeFileSystemAliasesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeFileSystemAliasesError) for what information is available for the error.")]
...
impl DescribeFileSystemAliasesError {
    /// Creates the `DescribeFileSystemAliasesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeFileSystemAliasesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeFileSystemAliasesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_file_system_aliases::DescribeFileSystemAliasesError {
