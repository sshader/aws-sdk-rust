...
impl DeleteStorageVirtualMachine {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                ...
                                let input: &mut crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteStorageVirtualMachine {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteStorageVirtualMachine");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteStorageVirtualMachineRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteStorageVirtualMachineResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteStorageVirtualMachine")
                            .with_interceptor(DeleteStorageVirtualMachineEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DeleteStorageVirtualMachineResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteStorageVirtualMachineResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_delete_storage_virtual_machine::de_delete_storage_virtual_machine_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteStorageVirtualMachineRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteStorageVirtualMachineRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_storage_virtual_machine::ser_delete_storage_virtual_machine_input(&input)?);
...
#[derive(Debug)]
            struct DeleteStorageVirtualMachineEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteStorageVirtualMachineEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteStorageVirtualMachineEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteStorageVirtualMachineInput>()
                        .ok_or("failed to downcast to DeleteStorageVirtualMachineInput")?;
...
pub enum DeleteStorageVirtualMachineError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteStorageVirtualMachineError) for what information is available for the error.")]
...
impl DeleteStorageVirtualMachineError {
    /// Creates the `DeleteStorageVirtualMachineError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteStorageVirtualMachineError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteStorageVirtualMachineError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineError {
