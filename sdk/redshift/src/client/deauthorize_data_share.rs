...
impl super::Client {
    ...
    ///   - [`data_share_arn(impl Into<String>)`](crate::operation::deauthorize_data_share::builders::DeauthorizeDataShareFluentBuilder::data_share_arn) / [`set_data_share_arn(Option<String>)`](crate::operation::deauthorize_data_share::builders::DeauthorizeDataShareFluentBuilder::set_data_share_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the datashare to remove authorization from.</p><br>
