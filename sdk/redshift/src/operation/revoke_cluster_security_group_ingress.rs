    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngressError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngressOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RevokeClusterSecurityGroupIngress {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RevokeClusterSecurityGroupIngress");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RevokeClusterSecurityGroupIngressRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RevokeClusterSecurityGroupIngressResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RevokeClusterSecurityGroupIngress")
                            .with_interceptor(RevokeClusterSecurityGroupIngressEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngressError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngressError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngressError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RevokeClusterSecurityGroupIngressResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_revoke_cluster_security_group_ingress::de_revoke_cluster_security_group_ingress_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RevokeClusterSecurityGroupIngressRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngressInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_revoke_cluster_security_group_ingress_input::ser_revoke_cluster_security_group_ingress_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RevokeClusterSecurityGroupIngressEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RevokeClusterSecurityGroupIngressEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RevokeClusterSecurityGroupIngressEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RevokeClusterSecurityGroupIngressInput>()
                        .ok_or("failed to downcast to RevokeClusterSecurityGroupIngressInput")?;
...
pub enum RevokeClusterSecurityGroupIngressError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RevokeClusterSecurityGroupIngressError) for what information is available for the error.")]
...
impl RevokeClusterSecurityGroupIngressError {
    /// Creates the `RevokeClusterSecurityGroupIngressError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RevokeClusterSecurityGroupIngressError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RevokeClusterSecurityGroupIngressError {
...
impl ::aws_types::request_id::RequestId for crate::operation::revoke_cluster_security_group_ingress::RevokeClusterSecurityGroupIngressError {
