...
impl CreateSnapshotCopyGrantFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrantOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrantError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrantOutput, crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrantError, Self> {
