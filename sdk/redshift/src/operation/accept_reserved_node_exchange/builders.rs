...
impl AcceptReservedNodeExchangeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchangeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchangeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchangeOutput, crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchangeError, Self> {
