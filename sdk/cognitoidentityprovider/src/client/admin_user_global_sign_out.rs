...
impl super::Client {
    ...
    ///   - [`username(impl Into<String>)`](crate::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutFluentBuilder::username) / [`set_username(Option<String>)`](crate::operation::admin_user_global_sign_out::builders::AdminUserGlobalSignOutFluentBuilder::set_username):<br>required: **true**<br><p>The user name.</p><br>
