...
impl super::Client {
    ...
    ///   - [`username(impl Into<String>)`](crate::operation::admin_delete_user::builders::AdminDeleteUserFluentBuilder::username) / [`set_username(Option<String>)`](crate::operation::admin_delete_user::builders::AdminDeleteUserFluentBuilder::set_username):<br>required: **true**<br><p>The user name of the user you want to delete.</p><br>
