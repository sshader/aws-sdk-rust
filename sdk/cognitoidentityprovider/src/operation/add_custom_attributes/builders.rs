...
impl AddCustomAttributesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::add_custom_attributes::AddCustomAttributesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_custom_attributes::AddCustomAttributesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::add_custom_attributes::AddCustomAttributesOutput, crate::operation::add_custom_attributes::AddCustomAttributesError, Self> {
