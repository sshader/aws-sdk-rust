...
impl ConfirmForgotPasswordFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::confirm_forgot_password::ConfirmForgotPasswordOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::confirm_forgot_password::ConfirmForgotPasswordError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::confirm_forgot_password::ConfirmForgotPasswordOutput, crate::operation::confirm_forgot_password::ConfirmForgotPasswordError, Self> {
