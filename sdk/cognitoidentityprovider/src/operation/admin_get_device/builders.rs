...
impl AdminGetDeviceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::admin_get_device::AdminGetDeviceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::admin_get_device::AdminGetDeviceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::admin_get_device::AdminGetDeviceOutput, crate::operation::admin_get_device::AdminGetDeviceError, Self> {
