...
#[derive(Debug)]
    ...
    ::std::write!(output, "/v1/spaces/{spaceName}/projects/{projectName}/workflowRuns/{id}", spaceName = space_name, projectName = project_name, id = id).expect("formatting should succeed");
...
impl GetWorkflowRunError {
    ...
    /// Returns `true` if the error kind is `GetWorkflowRunError::ServiceQuotaExceededException`.
