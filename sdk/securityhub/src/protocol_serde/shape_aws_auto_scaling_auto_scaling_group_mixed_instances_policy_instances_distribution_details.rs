...
pub fn ser_aws_auto_scaling_auto_scaling_group_mixed_instances_policy_instances_distribution_details(
    ...
    if let Some(var_2) = &input.on_demand_base_capacity {
        object.key("OnDemandBaseCapacity").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
    if let Some(var_3) = &input.on_demand_percentage_above_base_capacity {
        object.key("OnDemandPercentageAboveBaseCapacity").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
    ...
    if let Some(var_5) = &input.spot_instance_pools {
        object.key("SpotInstancePools").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
