...
pub fn ser_aws_cloud_watch_alarm_details(
    ...
    if let Some(var_10) = &input.datapoints_to_alarm {
        object.key("DatapointsToAlarm").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
        ...
        for item_13 in var_11 {
             {
                ...
                crate::protocol_serde::shape_aws_cloud_watch_alarm_dimensions_details::ser_aws_cloud_watch_alarm_dimensions_details(&mut object_14, item_13)?;
                object_14.finish();
            }
        }
        array_12.finish();
    ...
    if let Some(var_16) = &input.evaluation_periods {
        object.key("EvaluationPeriods").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_16).into()));
    }
    ...
    if let Some(var_26) = &input.period {
        object.key("Period").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_26).into()));
    }
    if let Some(var_27) = &input.statistic {
        object.key("Statistic").string(var_27.as_str());
    }
    if let Some(var_28) = &input.threshold {
        object.key("Threshold").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_28).into()));
    }
