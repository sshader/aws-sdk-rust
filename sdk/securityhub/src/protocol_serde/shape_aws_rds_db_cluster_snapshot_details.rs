...
pub fn ser_aws_rds_db_cluster_snapshot_details(
    ...
    if let Some(var_6) = &input.allocated_storage {
        object.key("AllocatedStorage").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_6).into()));
    }
    ...
    if let Some(var_15) = &input.percent_progress {
        object.key("PercentProgress").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_15).into()));
    }
