...
pub fn ser_aws_iam_policy_details(
    ...
    if let Some(var_1) = &input.attachment_count {
        object.key("AttachmentCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
    ...
    if let Some(var_7) = &input.permissions_boundary_usage_count {
        object.key("PermissionsBoundaryUsageCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
