...
impl UpdateFindingAggregator {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_finding_aggregator::UpdateFindingAggregatorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_finding_aggregator::UpdateFindingAggregatorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_finding_aggregator::UpdateFindingAggregatorError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_finding_aggregator::UpdateFindingAggregatorOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateFindingAggregator {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateFindingAggregator");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateFindingAggregatorRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateFindingAggregatorResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateFindingAggregator")
                            .with_interceptor(UpdateFindingAggregatorEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_finding_aggregator::UpdateFindingAggregatorError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_finding_aggregator::UpdateFindingAggregatorError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_finding_aggregator::UpdateFindingAggregatorError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct UpdateFindingAggregatorResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateFindingAggregatorResponseDeserializer {
...
#[derive(Debug)]
            struct UpdateFindingAggregatorRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateFindingAggregatorRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_finding_aggregator::UpdateFindingAggregatorInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_finding_aggregator::UpdateFindingAggregatorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_finding_aggregator::ser_update_finding_aggregator_input(&input)?);
...
#[derive(Debug)]
            struct UpdateFindingAggregatorEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateFindingAggregatorEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateFindingAggregatorEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateFindingAggregatorInput>()
                        .ok_or("failed to downcast to UpdateFindingAggregatorInput")?;
...
pub enum UpdateFindingAggregatorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateFindingAggregatorError) for what information is available for the error.")]
...
impl UpdateFindingAggregatorError {
    /// Creates the `UpdateFindingAggregatorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateFindingAggregatorError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateFindingAggregatorError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_finding_aggregator::UpdateFindingAggregatorError {
