...
impl super::Client {
    ...
    ///   - [`action_target_arns(impl Into<String>)`](crate::operation::describe_action_targets::builders::DescribeActionTargetsFluentBuilder::action_target_arns) / [`set_action_target_arns(Option<Vec::<String>>)`](crate::operation::describe_action_targets::builders::DescribeActionTargetsFluentBuilder::set_action_target_arns):<br>required: **false**<br><p>A list of custom action target ARNs for the custom action targets to retrieve.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_action_targets::builders::DescribeActionTargetsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_action_targets::builders::DescribeActionTargetsFluentBuilder::set_next_token):<br>required: **false**<br><p>The token that is required for pagination. On your first call to the <code>DescribeActionTargets</code> operation, set the value of this parameter to <code>NULL</code>.</p>  <p>For subsequent calls to the operation, to continue listing data, set the value of this parameter to the value returned from the previous response.</p><br>
    ///   - [`max_results(i32)`](crate::operation::describe_action_targets::builders::DescribeActionTargetsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_action_targets::builders::DescribeActionTargetsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return.</p><br>
