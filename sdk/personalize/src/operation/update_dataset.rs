...
builder = _header_serialization_settings.set_default_header(
                    ...
                    "AmazonPersonalize.UpdateDataset"
                );
builder
                    };
...
impl UpdateDatasetError {
    ...
    /// Returns `true` if the error kind is `UpdateDatasetError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `UpdateDatasetError::ResourceInUseException`.
