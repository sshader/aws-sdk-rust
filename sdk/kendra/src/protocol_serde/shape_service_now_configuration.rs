...
pub fn ser_service_now_configuration(
    ...
    if let Some(var_1) = &input.knowledge_article_configuration {
        ...
        crate::protocol_serde::shape_service_now_knowledge_article_configuration::ser_service_now_knowledge_article_configuration(&mut object_2, var_1)?;
        object_2.finish();
    }
...
pub(crate) fn de_service_now_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ServiceNowConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::service_now_configuration_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
