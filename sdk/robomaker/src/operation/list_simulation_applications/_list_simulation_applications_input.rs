...
impl ListSimulationApplicationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_simulation_applications::ListSimulationApplicationsInput, ::aws_smithy_types::error::operation::BuildError> {
