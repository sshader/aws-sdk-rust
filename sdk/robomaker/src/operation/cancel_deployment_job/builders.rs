...
impl CancelDeploymentJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_deployment_job::CancelDeploymentJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_deployment_job::CancelDeploymentJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_deployment_job::CancelDeploymentJobOutput, crate::operation::cancel_deployment_job::CancelDeploymentJobError, Self> {
