...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_batch_import_job::DeleteBatchImportJobOutput,
                    crate::operation::delete_batch_import_job::DeleteBatchImportJobError,
                > for DeleteBatchImportJobFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteBatchImportJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_batch_import_job::DeleteBatchImportJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_batch_import_job::DeleteBatchImportJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_batch_import_job::DeleteBatchImportJob::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_batch_import_job::DeleteBatchImportJob::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_batch_import_job::DeleteBatchImportJobOutput, crate::operation::delete_batch_import_job::DeleteBatchImportJobError, Self> {
