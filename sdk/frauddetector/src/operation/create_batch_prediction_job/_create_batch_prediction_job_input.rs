...
impl CreateBatchPredictionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_batch_prediction_job::CreateBatchPredictionJobInput, ::aws_smithy_types::error::operation::BuildError> {
