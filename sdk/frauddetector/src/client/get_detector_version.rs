...
impl super::Client {
    ...
    ///   - [`detector_id(impl Into<String>)`](crate::operation::get_detector_version::builders::GetDetectorVersionFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::get_detector_version::builders::GetDetectorVersionFluentBuilder::set_detector_id):<br>required: **true**<br><p>The detector ID.</p><br>
