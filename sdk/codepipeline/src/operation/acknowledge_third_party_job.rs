...
impl AcknowledgeThirdPartyJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AcknowledgeThirdPartyJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AcknowledgeThirdPartyJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AcknowledgeThirdPartyJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AcknowledgeThirdPartyJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AcknowledgeThirdPartyJob")
                            .with_interceptor(AcknowledgeThirdPartyJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct AcknowledgeThirdPartyJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AcknowledgeThirdPartyJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_acknowledge_third_party_job::de_acknowledge_third_party_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AcknowledgeThirdPartyJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AcknowledgeThirdPartyJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_acknowledge_third_party_job::ser_acknowledge_third_party_job_input(&input)?);
...
#[derive(Debug)]
            struct AcknowledgeThirdPartyJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AcknowledgeThirdPartyJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AcknowledgeThirdPartyJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AcknowledgeThirdPartyJobInput>()
                        .ok_or("failed to downcast to AcknowledgeThirdPartyJobInput")?;
...
pub enum AcknowledgeThirdPartyJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AcknowledgeThirdPartyJobError) for what information is available for the error.")]
...
impl AcknowledgeThirdPartyJobError {
    /// Creates the `AcknowledgeThirdPartyJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AcknowledgeThirdPartyJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AcknowledgeThirdPartyJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobError {
