...
impl PutApprovalResultFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_approval_result::PutApprovalResultOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_approval_result::PutApprovalResultError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_approval_result::PutApprovalResultOutput, crate::operation::put_approval_result::PutApprovalResultError, Self> {
