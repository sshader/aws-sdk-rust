...
impl PutThirdPartyJobSuccessResult {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutThirdPartyJobSuccessResult {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutThirdPartyJobSuccessResult");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutThirdPartyJobSuccessResultRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutThirdPartyJobSuccessResultResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutThirdPartyJobSuccessResult")
                            .with_interceptor(PutThirdPartyJobSuccessResultEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct PutThirdPartyJobSuccessResultResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutThirdPartyJobSuccessResultResponseDeserializer {
...
#[derive(Debug)]
            struct PutThirdPartyJobSuccessResultRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutThirdPartyJobSuccessResultRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_third_party_job_success_result::ser_put_third_party_job_success_result_input(&input)?);
...
#[derive(Debug)]
            struct PutThirdPartyJobSuccessResultEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutThirdPartyJobSuccessResultEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutThirdPartyJobSuccessResultEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutThirdPartyJobSuccessResultInput>()
                        .ok_or("failed to downcast to PutThirdPartyJobSuccessResultInput")?;
...
pub enum PutThirdPartyJobSuccessResultError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutThirdPartyJobSuccessResultError) for what information is available for the error.")]
...
impl PutThirdPartyJobSuccessResultError {
    /// Creates the `PutThirdPartyJobSuccessResultError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutThirdPartyJobSuccessResultError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutThirdPartyJobSuccessResultError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultError {
