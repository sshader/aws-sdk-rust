...
impl UpdateProjectDataDeliveryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_project_data_delivery::UpdateProjectDataDeliveryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_project_data_delivery::UpdateProjectDataDeliveryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_project_data_delivery::UpdateProjectDataDeliveryOutput, crate::operation::update_project_data_delivery::UpdateProjectDataDeliveryError, Self> {
