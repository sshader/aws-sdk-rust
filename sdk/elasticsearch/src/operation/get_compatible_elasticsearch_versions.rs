    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_compatible_elasticsearch_versions::GetCompatibleElasticsearchVersionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_compatible_elasticsearch_versions::GetCompatibleElasticsearchVersionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCompatibleElasticsearchVersions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetCompatibleElasticsearchVersions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetCompatibleElasticsearchVersionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetCompatibleElasticsearchVersionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCompatibleElasticsearchVersions")
                            .with_interceptor(GetCompatibleElasticsearchVersionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_compatible_elasticsearch_versions::GetCompatibleElasticsearchVersionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_compatible_elasticsearch_versions::GetCompatibleElasticsearchVersionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_compatible_elasticsearch_versions::GetCompatibleElasticsearchVersionsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetCompatibleElasticsearchVersionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCompatibleElasticsearchVersionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_compatible_elasticsearch_versions::de_get_compatible_elasticsearch_versions_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetCompatibleElasticsearchVersionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCompatibleElasticsearchVersionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_compatible_elasticsearch_versions::GetCompatibleElasticsearchVersionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_compatible_elasticsearch_versions::GetCompatibleElasticsearchVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2015-01-01/es/compatibleVersions").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_compatible_elasticsearch_versions::GetCompatibleElasticsearchVersionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetCompatibleElasticsearchVersionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCompatibleElasticsearchVersionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetCompatibleElasticsearchVersionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetCompatibleElasticsearchVersionsInput>()
                        .ok_or("failed to downcast to GetCompatibleElasticsearchVersionsInput")?;
...
pub enum GetCompatibleElasticsearchVersionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetCompatibleElasticsearchVersionsError) for what information is available for the error.")]
...
impl GetCompatibleElasticsearchVersionsError {
    /// Creates the `GetCompatibleElasticsearchVersionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetCompatibleElasticsearchVersionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetCompatibleElasticsearchVersionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_compatible_elasticsearch_versions::GetCompatibleElasticsearchVersionsError {
