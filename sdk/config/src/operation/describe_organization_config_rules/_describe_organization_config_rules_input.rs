...
impl DescribeOrganizationConfigRulesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_organization_config_rules::DescribeOrganizationConfigRulesInput, ::aws_smithy_types::error::operation::BuildError> {
