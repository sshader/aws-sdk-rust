...
impl DescribeDeliveryChannelsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_delivery_channels::DescribeDeliveryChannelsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_delivery_channels::DescribeDeliveryChannelsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_delivery_channels::DescribeDeliveryChannelsOutput, crate::operation::describe_delivery_channels::DescribeDeliveryChannelsError, Self> {
