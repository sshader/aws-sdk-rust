...
pub(crate) fn de_aggregated_source_status<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AggregatedSourceStatus>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "LastUpdateStatus" => {
                                builder = builder.set_last_update_status(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::AggregatedSourceStatusType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
