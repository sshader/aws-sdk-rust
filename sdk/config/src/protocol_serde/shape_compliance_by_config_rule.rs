...
pub(crate) fn de_compliance_by_config_rule<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ComplianceByConfigRule>, ::aws_smithy_json::deserialize::error::DeserializeError>
