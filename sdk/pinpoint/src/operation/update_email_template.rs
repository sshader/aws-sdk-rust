...
fn uri_query(_input: &crate::operation::update_email_template::UpdateEmailTemplateInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_email_template_input::ser_email_template_request_http_payload(& input.email_template_request)?);
