...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_segment_input::ser_write_segment_request_http_payload(& input.write_segment_request)?);
