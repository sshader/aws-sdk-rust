...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_campaign_input::ser_write_campaign_request_http_payload(& input.write_campaign_request)?);
