...
impl UpdateRumMetricDefinitionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_rum_metric_definition::UpdateRumMetricDefinitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_rum_metric_definition::UpdateRumMetricDefinitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_rum_metric_definition::UpdateRumMetricDefinitionOutput, crate::operation::update_rum_metric_definition::UpdateRumMetricDefinitionError, Self> {
