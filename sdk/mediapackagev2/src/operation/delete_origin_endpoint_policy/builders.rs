...
impl DeleteOriginEndpointPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_origin_endpoint_policy::DeleteOriginEndpointPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_origin_endpoint_policy::DeleteOriginEndpointPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_origin_endpoint_policy::DeleteOriginEndpointPolicyOutput, crate::operation::delete_origin_endpoint_policy::DeleteOriginEndpointPolicyError, Self> {
