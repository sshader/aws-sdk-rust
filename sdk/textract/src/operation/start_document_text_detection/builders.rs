...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::start_document_text_detection::StartDocumentTextDetectionOutput,
                    crate::operation::start_document_text_detection::StartDocumentTextDetectionError,
                > for StartDocumentTextDetectionFluentBuilder
            {
                fn send(
                    self,
...
impl StartDocumentTextDetectionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_document_text_detection::StartDocumentTextDetectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_document_text_detection::StartDocumentTextDetectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::start_document_text_detection::StartDocumentTextDetection::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::start_document_text_detection::StartDocumentTextDetection::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_document_text_detection::StartDocumentTextDetectionOutput, crate::operation::start_document_text_detection::StartDocumentTextDetectionError, Self> {
