...
impl GetLendingAnalysisFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_lending_analysis::GetLendingAnalysisOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_lending_analysis::GetLendingAnalysisError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_lending_analysis::GetLendingAnalysisOutput, crate::operation::get_lending_analysis::GetLendingAnalysisError, Self> {
