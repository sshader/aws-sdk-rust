...
impl  DeletePullRequestApprovalRuleOutput  {
    ...
    pub fn approval_rule_id(&self) -> & str {
        use std::ops::Deref; self.approval_rule_id.deref()
    }
}
...
impl DeletePullRequestApprovalRuleOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_pull_request_approval_rule::DeletePullRequestApprovalRuleOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::delete_pull_request_approval_rule::DeletePullRequestApprovalRuleOutput {
                approval_rule_id: self.approval_rule_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("approval_rule_id", "approval_rule_id was not specified but it is required when building DeletePullRequestApprovalRuleOutput")
                    )?
                ,
