...
impl UpdateApprovalRuleTemplateContentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_approval_rule_template_content::UpdateApprovalRuleTemplateContentInput, ::aws_smithy_types::error::operation::BuildError> {
