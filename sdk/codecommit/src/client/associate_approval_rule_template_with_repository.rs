...
impl super::Client {
    ...
    ///   - [`approval_rule_template_name(impl Into<String>)`](crate::operation::associate_approval_rule_template_with_repository::builders::AssociateApprovalRuleTemplateWithRepositoryFluentBuilder::approval_rule_template_name) / [`set_approval_rule_template_name(Option<String>)`](crate::operation::associate_approval_rule_template_with_repository::builders::AssociateApprovalRuleTemplateWithRepositoryFluentBuilder::set_approval_rule_template_name):<br>required: **true**<br><p>The name for the approval rule template. </p><br>
    ///   - [`repository_name(impl Into<String>)`](crate::operation::associate_approval_rule_template_with_repository::builders::AssociateApprovalRuleTemplateWithRepositoryFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::associate_approval_rule_template_with_repository::builders::AssociateApprovalRuleTemplateWithRepositoryFluentBuilder::set_repository_name):<br>required: **true**<br><p>The name of the repository that you want to associate with the template.</p><br>
