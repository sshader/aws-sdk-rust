...
pub fn ser_decision(
    ...
    if let Some(var_1) = &input.schedule_activity_task_decision_attributes {
        ...
        crate::protocol_serde::shape_schedule_activity_task_decision_attributes::ser_schedule_activity_task_decision_attributes(&mut object_2, var_1)?;
        object_2.finish();
    }
    if let Some(var_3) = &input.request_cancel_activity_task_decision_attributes {
        ...
        crate::protocol_serde::shape_request_cancel_activity_task_decision_attributes::ser_request_cancel_activity_task_decision_attributes(&mut object_4, var_3)?;
        object_4.finish();
    }
    if let Some(var_5) = &input.complete_workflow_execution_decision_attributes {
        ...
        crate::protocol_serde::shape_complete_workflow_execution_decision_attributes::ser_complete_workflow_execution_decision_attributes(&mut object_6, var_5)?;
        object_6.finish();
    }
    if let Some(var_7) = &input.fail_workflow_execution_decision_attributes {
        ...
        crate::protocol_serde::shape_fail_workflow_execution_decision_attributes::ser_fail_workflow_execution_decision_attributes(&mut object_8, var_7)?;
        object_8.finish();
    }
    if let Some(var_9) = &input.cancel_workflow_execution_decision_attributes {
        ...
        crate::protocol_serde::shape_cancel_workflow_execution_decision_attributes::ser_cancel_workflow_execution_decision_attributes(&mut object_10, var_9)?;
        object_10.finish();
    }
    ...
    if let Some(var_23) = &input.start_child_workflow_execution_decision_attributes {
        ...
        crate::protocol_serde::shape_start_child_workflow_execution_decision_attributes::ser_start_child_workflow_execution_decision_attributes(&mut object_24, var_23)?;
        object_24.finish();
    }
    if let Some(var_25) = &input.schedule_lambda_function_decision_attributes {
        ...
        crate::protocol_serde::shape_schedule_lambda_function_decision_attributes::ser_schedule_lambda_function_decision_attributes(&mut object_26, var_25)?;
        object_26.finish();
    }
    Ok(())
}
