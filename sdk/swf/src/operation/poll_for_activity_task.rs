...
impl PollForActivityTask {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::poll_for_activity_task::PollForActivityTaskOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::poll_for_activity_task::PollForActivityTaskError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::poll_for_activity_task::PollForActivityTaskError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::poll_for_activity_task::PollForActivityTaskOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PollForActivityTask {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PollForActivityTask");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PollForActivityTaskRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PollForActivityTaskResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PollForActivityTask")
                            .with_interceptor(PollForActivityTaskEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::poll_for_activity_task::PollForActivityTaskError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::poll_for_activity_task::PollForActivityTaskError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::poll_for_activity_task::PollForActivityTaskError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct PollForActivityTaskResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PollForActivityTaskResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_poll_for_activity_task::de_poll_for_activity_task_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PollForActivityTaskRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PollForActivityTaskRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::poll_for_activity_task::PollForActivityTaskInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::poll_for_activity_task::PollForActivityTaskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_poll_for_activity_task::ser_poll_for_activity_task_input(&input)?);
...
#[derive(Debug)]
            struct PollForActivityTaskEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PollForActivityTaskEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PollForActivityTaskEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PollForActivityTaskInput>()
                        .ok_or("failed to downcast to PollForActivityTaskInput")?;
...
pub enum PollForActivityTaskError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PollForActivityTaskError) for what information is available for the error.")]
...
impl PollForActivityTaskError {
    /// Creates the `PollForActivityTaskError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PollForActivityTaskError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PollForActivityTaskError {
...
impl ::aws_types::request_id::RequestId for crate::operation::poll_for_activity_task::PollForActivityTaskError {
