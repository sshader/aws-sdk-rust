...
impl RequestCancelWorkflowExecutionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionOutput, crate::operation::request_cancel_workflow_execution::RequestCancelWorkflowExecutionError, Self> {
