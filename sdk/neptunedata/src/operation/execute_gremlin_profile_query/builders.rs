...
impl ExecuteGremlinProfileQueryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::execute_gremlin_profile_query::ExecuteGremlinProfileQueryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::execute_gremlin_profile_query::ExecuteGremlinProfileQueryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::execute_gremlin_profile_query::ExecuteGremlinProfileQueryOutput, crate::operation::execute_gremlin_profile_query::ExecuteGremlinProfileQueryError, Self> {
