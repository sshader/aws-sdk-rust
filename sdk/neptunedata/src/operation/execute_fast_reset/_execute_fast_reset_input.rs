...
impl ExecuteFastResetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::execute_fast_reset::ExecuteFastResetInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::execute_fast_reset::ExecuteFastResetInput {
                action: self.action
                ,
                token: self.token
                ,
