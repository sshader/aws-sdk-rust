...
impl GetPropertygraphStatisticsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_propertygraph_statistics::GetPropertygraphStatisticsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_propertygraph_statistics::GetPropertygraphStatisticsOutput {
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building GetPropertygraphStatisticsOutput")
                    )?
                ,
