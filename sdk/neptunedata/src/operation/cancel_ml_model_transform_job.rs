...
/// Orchestration and serialization glue logic for `CancelMLModelTransformJob`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
#[doc(hidden)]
pub struct CancelMLModelTransformJob;
impl CancelMLModelTransformJob {
    #[doc(hidden)]
    pub fn new() -> Self {
        Self
    }
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::cancel_ml_model_transform_job::CancelMlModelTransformJobInput,
                    ) -> ::std::result::Result<crate::operation::cancel_ml_model_transform_job::CancelMlModelTransformJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_ml_model_transform_job::CancelMLModelTransformJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::cancel_ml_model_transform_job::CancelMLModelTransformJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::cancel_ml_model_transform_job::CancelMlModelTransformJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelMLModelTransformJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CancelMLModelTransformJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CancelMLModelTransformJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CancelMLModelTransformJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelMLModelTransformJob")
                            .with_interceptor(CancelMLModelTransformJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::cancel_ml_model_transform_job::CancelMLModelTransformJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::cancel_ml_model_transform_job::CancelMLModelTransformJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::cancel_ml_model_transform_job::CancelMLModelTransformJobError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct CancelMLModelTransformJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelMLModelTransformJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_cancel_ml_model_transform_job::de_cancel_ml_model_transform_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_cancel_ml_model_transform_job::de_cancel_ml_model_transform_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CancelMLModelTransformJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelMLModelTransformJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::cancel_ml_model_transform_job::CancelMlModelTransformJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::cancel_ml_model_transform_job::CancelMlModelTransformJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::cancel_ml_model_transform_job::CancelMlModelTransformJobInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct CancelMLModelTransformJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelMLModelTransformJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CancelMLModelTransformJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CancelMlModelTransformJobInput>()
                        .ok_or("failed to downcast to CancelMlModelTransformJobInput")?;
...
pub enum CancelMLModelTransformJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CancelMLModelTransformJobError) for what information is available for the error.")]
...
impl CancelMLModelTransformJobError {
    /// Creates the `CancelMLModelTransformJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelMLModelTransformJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CancelMLModelTransformJobError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `CancelMLModelTransformJobError::ClientTimeoutException`.
    pub fn is_client_timeout_exception(&self) -> bool {
        matches!(self, Self::ClientTimeoutException(_))
    }
    /// Returns `true` if the error kind is `CancelMLModelTransformJobError::ConstraintViolationException`.
    pub fn is_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::ConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `CancelMLModelTransformJobError::IllegalArgumentException`.
    pub fn is_illegal_argument_exception(&self) -> bool {
        matches!(self, Self::IllegalArgumentException(_))
    }
    /// Returns `true` if the error kind is `CancelMLModelTransformJobError::InvalidArgumentException`.
    pub fn is_invalid_argument_exception(&self) -> bool {
        matches!(self, Self::InvalidArgumentException(_))
    }
    /// Returns `true` if the error kind is `CancelMLModelTransformJobError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `CancelMLModelTransformJobError::MissingParameterException`.
    pub fn is_missing_parameter_exception(&self) -> bool {
        matches!(self, Self::MissingParameterException(_))
    }
    /// Returns `true` if the error kind is `CancelMLModelTransformJobError::MlResourceNotFoundException`.
    pub fn is_ml_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::MlResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CancelMLModelTransformJobError::PreconditionsFailedException`.
    pub fn is_preconditions_failed_exception(&self) -> bool {
        matches!(self, Self::PreconditionsFailedException(_))
    }
    /// Returns `true` if the error kind is `CancelMLModelTransformJobError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `CancelMLModelTransformJobError::UnsupportedOperationException`.
    pub fn is_unsupported_operation_exception(&self) -> bool {
        matches!(self, Self::UnsupportedOperationException(_))
    }
}
impl ::std::error::Error for CancelMLModelTransformJobError {
...
mod _cancel_ml_model_transform_job_output;
