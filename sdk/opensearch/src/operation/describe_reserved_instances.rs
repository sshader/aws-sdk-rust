...
fn uri_query(_input: &crate::operation::describe_reserved_instances::DescribeReservedInstancesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
