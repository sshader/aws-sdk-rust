    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeReservedInstanceOfferings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeReservedInstanceOfferings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeReservedInstanceOfferingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeReservedInstanceOfferingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeReservedInstanceOfferings")
                            .with_interceptor(DescribeReservedInstanceOfferingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DescribeReservedInstanceOfferingsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeReservedInstanceOfferingsResponseDeserializer {
...
#[derive(Debug)]
            struct DescribeReservedInstanceOfferingsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeReservedInstanceOfferingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2021-01-01/opensearch/reservedInstanceOfferings").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DescribeReservedInstanceOfferingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeReservedInstanceOfferingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeReservedInstanceOfferingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeReservedInstanceOfferingsInput>()
                        .ok_or("failed to downcast to DescribeReservedInstanceOfferingsInput")?;
...
pub enum DescribeReservedInstanceOfferingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeReservedInstanceOfferingsError) for what information is available for the error.")]
...
impl DescribeReservedInstanceOfferingsError {
    /// Creates the `DescribeReservedInstanceOfferingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeReservedInstanceOfferingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeReservedInstanceOfferingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsError {
