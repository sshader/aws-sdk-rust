...
impl RefreshTrustedAdvisorCheck {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RefreshTrustedAdvisorCheck {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RefreshTrustedAdvisorCheck");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RefreshTrustedAdvisorCheckRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RefreshTrustedAdvisorCheckResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RefreshTrustedAdvisorCheck")
                            .with_interceptor(RefreshTrustedAdvisorCheckEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct RefreshTrustedAdvisorCheckResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RefreshTrustedAdvisorCheckResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_refresh_trusted_advisor_check::de_refresh_trusted_advisor_check_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RefreshTrustedAdvisorCheckRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RefreshTrustedAdvisorCheckRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_refresh_trusted_advisor_check::ser_refresh_trusted_advisor_check_input(&input)?);
...
#[derive(Debug)]
            struct RefreshTrustedAdvisorCheckEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RefreshTrustedAdvisorCheckEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RefreshTrustedAdvisorCheckEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RefreshTrustedAdvisorCheckInput>()
                        .ok_or("failed to downcast to RefreshTrustedAdvisorCheckInput")?;
...
pub enum RefreshTrustedAdvisorCheckError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RefreshTrustedAdvisorCheckError) for what information is available for the error.")]
...
impl RefreshTrustedAdvisorCheckError {
    /// Creates the `RefreshTrustedAdvisorCheckError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RefreshTrustedAdvisorCheckError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RefreshTrustedAdvisorCheckError {
...
impl ::aws_types::request_id::RequestId for crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckError {
