...
impl DescribeReservedCacheNodesOfferings {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeReservedCacheNodesOfferings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeReservedCacheNodesOfferings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeReservedCacheNodesOfferingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeReservedCacheNodesOfferingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeReservedCacheNodesOfferings")
                            .with_interceptor(DescribeReservedCacheNodesOfferingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferingsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeReservedCacheNodesOfferingsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_describe_reserved_cache_nodes_offerings::de_describe_reserved_cache_nodes_offerings_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeReservedCacheNodesOfferingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_reserved_cache_nodes_offerings_input::ser_describe_reserved_cache_nodes_offerings_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeReservedCacheNodesOfferingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeReservedCacheNodesOfferingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeReservedCacheNodesOfferingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeReservedCacheNodesOfferingsInput>()
                        .ok_or("failed to downcast to DescribeReservedCacheNodesOfferingsInput")?;
...
pub enum DescribeReservedCacheNodesOfferingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeReservedCacheNodesOfferingsError) for what information is available for the error.")]
...
impl DescribeReservedCacheNodesOfferingsError {
    /// Creates the `DescribeReservedCacheNodesOfferingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeReservedCacheNodesOfferingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeReservedCacheNodesOfferingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferingsError {
