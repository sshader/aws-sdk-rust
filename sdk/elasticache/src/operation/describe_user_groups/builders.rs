...
impl DescribeUserGroupsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_user_groups::DescribeUserGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_user_groups::DescribeUserGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_user_groups::DescribeUserGroupsOutput, crate::operation::describe_user_groups::DescribeUserGroupsError, Self> {
