...
/// Orchestration and serialization glue logic for `TestMigration`.
...
impl TestMigration {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::test_migration::TestMigrationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::test_migration::TestMigrationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::test_migration::TestMigrationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::test_migration::TestMigrationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for TestMigration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("TestMigration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(TestMigrationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(TestMigrationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("TestMigration")
                            .with_interceptor(TestMigrationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::test_migration::TestMigrationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::test_migration::TestMigrationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::test_migration::TestMigrationError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct TestMigrationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TestMigrationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_test_migration::de_test_migration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_test_migration::de_test_migration_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct TestMigrationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TestMigrationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::test_migration::TestMigrationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::test_migration::TestMigrationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_test_migration_input::ser_test_migration_input_input_input(&input)?);
...
#[derive(Debug)]
            struct TestMigrationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TestMigrationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "TestMigrationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<TestMigrationInput>()
                        .ok_or("failed to downcast to TestMigrationInput")?;
...
/// Error type for the `TestMigrationError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum TestMigrationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-TestMigrationError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl TestMigrationError {
    /// Creates the `TestMigrationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `TestMigrationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `TestMigrationError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `TestMigrationError::InvalidReplicationGroupStateFault`.
    pub fn is_invalid_replication_group_state_fault(&self) -> bool {
        matches!(self, Self::InvalidReplicationGroupStateFault(_))
    }
    /// Returns `true` if the error kind is `TestMigrationError::ReplicationGroupAlreadyUnderMigrationFault`.
    ...
    /// Returns `true` if the error kind is `TestMigrationError::ReplicationGroupNotFoundFault`.
    pub fn is_replication_group_not_found_fault(&self) -> bool {
        matches!(self, Self::ReplicationGroupNotFoundFault(_))
    }
}
impl ::std::error::Error for TestMigrationError {
...
impl ::std::fmt::Display for TestMigrationError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for TestMigrationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for TestMigrationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for TestMigrationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::test_migration::TestMigrationError {
