...
impl super::Client {
    ...
    ///   - [`engine(impl Into<String>)`](crate::operation::describe_users::builders::DescribeUsersFluentBuilder::engine) / [`set_engine(Option<String>)`](crate::operation::describe_users::builders::DescribeUsersFluentBuilder::set_engine):<br>required: **false**<br><p>The Redis engine. </p><br>
    ///   - [`user_id(impl Into<String>)`](crate::operation::describe_users::builders::DescribeUsersFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::describe_users::builders::DescribeUsersFluentBuilder::set_user_id):<br>required: **false**<br><p>The ID of the user.</p><br>
    ///   - [`filters(Filter)`](crate::operation::describe_users::builders::DescribeUsersFluentBuilder::filters) / [`set_filters(Option<Vec::<Filter>>)`](crate::operation::describe_users::builders::DescribeUsersFluentBuilder::set_filters):<br>required: **false**<br><p>Filter to determine the list of User IDs to return.</p><br>
    ///   - [`max_records(i32)`](crate::operation::describe_users::builders::DescribeUsersFluentBuilder::max_records) / [`set_max_records(Option<i32>)`](crate::operation::describe_users::builders::DescribeUsersFluentBuilder::set_max_records):<br>required: **false**<br><p>The maximum number of records to include in the response. If more records exist than the specified MaxRecords value, a marker is included in the response so that the remaining results can be retrieved. </p><br>
