...
pub fn ser_byte_match_tuple(
    ...
    if let Some(var_1) = &input.field_to_match {
     ...
     {
        object.key("TargetString").string_unchecked(&::aws_smithy_types::base64::encode(&input.target_string));
    }
     {
...
pub(crate) fn de_byte_match_tuple<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ByteMatchTuple>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::byte_match_tuple_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
