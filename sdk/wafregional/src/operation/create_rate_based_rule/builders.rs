...
impl CreateRateBasedRuleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_rate_based_rule::CreateRateBasedRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_rate_based_rule::CreateRateBasedRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_rate_based_rule::CreateRateBasedRuleOutput, crate::operation::create_rate_based_rule::CreateRateBasedRuleError, Self> {
