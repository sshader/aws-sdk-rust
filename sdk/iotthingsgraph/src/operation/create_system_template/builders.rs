...
impl CreateSystemTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_system_template::CreateSystemTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_system_template::CreateSystemTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_system_template::CreateSystemTemplateOutput, crate::operation::create_system_template::CreateSystemTemplateError, Self> {
