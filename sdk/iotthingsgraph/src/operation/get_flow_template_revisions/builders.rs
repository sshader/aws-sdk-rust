...
impl GetFlowTemplateRevisionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_flow_template_revisions::GetFlowTemplateRevisionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_flow_template_revisions::GetFlowTemplateRevisionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_flow_template_revisions::GetFlowTemplateRevisionsOutput, crate::operation::get_flow_template_revisions::GetFlowTemplateRevisionsError, Self> {
