...
impl PutAutoTerminationPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_auto_termination_policy::PutAutoTerminationPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_auto_termination_policy::PutAutoTerminationPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_auto_termination_policy::PutAutoTerminationPolicyOutput, crate::operation::put_auto_termination_policy::PutAutoTerminationPolicyError, Self> {
