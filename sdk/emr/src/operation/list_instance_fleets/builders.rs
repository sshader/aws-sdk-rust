...
impl ListInstanceFleetsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_instance_fleets::ListInstanceFleetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_instance_fleets::ListInstanceFleetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_instance_fleets::ListInstanceFleetsOutput, crate::operation::list_instance_fleets::ListInstanceFleetsError, Self> {
