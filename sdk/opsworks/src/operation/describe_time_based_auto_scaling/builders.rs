...
impl DescribeTimeBasedAutoScalingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_time_based_auto_scaling::DescribeTimeBasedAutoScalingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_time_based_auto_scaling::DescribeTimeBasedAutoScalingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_time_based_auto_scaling::DescribeTimeBasedAutoScalingOutput, crate::operation::describe_time_based_auto_scaling::DescribeTimeBasedAutoScalingError, Self> {
