...
pub fn ser_resource_data_sync_s3_destination(
    ...
    if let Some(var_3) = &input.destination_data_sharing {
        ...
        crate::protocol_serde::shape_resource_data_sync_destination_data_sharing::ser_resource_data_sync_destination_data_sharing(&mut object_4, var_3)?;
        object_4.finish();
    }
    Ok(())
}
...
pub(crate) fn de_resource_data_sync_s3_destination<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ResourceDataSyncS3Destination>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::resource_data_sync_s3_destination_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
