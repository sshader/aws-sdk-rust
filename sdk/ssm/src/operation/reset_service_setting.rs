...
impl ResetServiceSetting {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::reset_service_setting::ResetServiceSettingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reset_service_setting::ResetServiceSettingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::reset_service_setting::ResetServiceSettingError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::reset_service_setting::ResetServiceSettingOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ResetServiceSetting {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ResetServiceSetting");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ResetServiceSettingRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ResetServiceSettingResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResetServiceSetting")
                            .with_interceptor(ResetServiceSettingEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::reset_service_setting::ResetServiceSettingError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::reset_service_setting::ResetServiceSettingError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::reset_service_setting::ResetServiceSettingError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct ResetServiceSettingResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ResetServiceSettingResponseDeserializer {
...
#[derive(Debug)]
            struct ResetServiceSettingRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ResetServiceSettingRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::reset_service_setting::ResetServiceSettingInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::reset_service_setting::ResetServiceSettingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_reset_service_setting::ser_reset_service_setting_input(&input)?);
...
#[derive(Debug)]
            struct ResetServiceSettingEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ResetServiceSettingEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ResetServiceSettingEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ResetServiceSettingInput>()
                        .ok_or("failed to downcast to ResetServiceSettingInput")?;
...
pub enum ResetServiceSettingError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ResetServiceSettingError) for what information is available for the error.")]
...
impl ResetServiceSettingError {
    /// Creates the `ResetServiceSettingError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ResetServiceSettingError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ResetServiceSettingError {
...
impl ::aws_types::request_id::RequestId for crate::operation::reset_service_setting::ResetServiceSettingError {
