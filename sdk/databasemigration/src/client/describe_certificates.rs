...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_certificates::builders::DescribeCertificatesFluentBuilder::filters) / [`set_filters(Option<Vec::<Filter>>)`](crate::operation::describe_certificates::builders::DescribeCertificatesFluentBuilder::set_filters):<br>required: **false**<br><p>Filters applied to the certificates described in the form of key-value pairs. Valid values are <code>certificate-arn</code> and <code>certificate-id</code>.</p><br>
    ///   - [`max_records(i32)`](crate::operation::describe_certificates::builders::DescribeCertificatesFluentBuilder::max_records) / [`set_max_records(Option<i32>)`](crate::operation::describe_certificates::builders::DescribeCertificatesFluentBuilder::set_max_records):<br>required: **false**<br><p> The maximum number of records to include in the response. If more records exist than the specified <code>MaxRecords</code> value, a pagination token called a marker is included in the response so that the remaining results can be retrieved. </p>  <p>Default: 10</p><br>
