...
pub fn ser_compute_config(
    ...
    if let Some(var_4) = &input.max_capacity_units {
        object.key("MaxCapacityUnits").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    if let Some(var_5) = &input.min_capacity_units {
        object.key("MinCapacityUnits").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
...
pub(crate) fn de_compute_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ComputeConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
