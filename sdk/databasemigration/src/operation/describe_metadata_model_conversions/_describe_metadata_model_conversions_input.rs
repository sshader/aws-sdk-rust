...
impl DescribeMetadataModelConversionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_metadata_model_conversions::DescribeMetadataModelConversionsInput, ::aws_smithy_types::error::operation::BuildError> {
