...
/// Orchestration and serialization glue logic for `DeleteMigrationProject`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
#[doc(hidden)]
pub struct DeleteMigrationProject;
impl DeleteMigrationProject {
    #[doc(hidden)]
    pub fn new() -> Self {
        Self
    }
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_migration_project::DeleteMigrationProjectOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_migration_project::DeleteMigrationProjectError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_migration_project::DeleteMigrationProjectError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_migration_project::DeleteMigrationProjectOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteMigrationProject {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteMigrationProject");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteMigrationProjectRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteMigrationProjectResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteMigrationProject")
                            .with_interceptor(DeleteMigrationProjectEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_migration_project::DeleteMigrationProjectError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_migration_project::DeleteMigrationProjectError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_migration_project::DeleteMigrationProjectError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DeleteMigrationProjectResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteMigrationProjectResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_migration_project::de_delete_migration_project_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_migration_project::de_delete_migration_project_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteMigrationProjectRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteMigrationProjectRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_migration_project::DeleteMigrationProjectInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_migration_project::DeleteMigrationProjectInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_migration_project::ser_delete_migration_project_input(&input)?);
...
#[derive(Debug)]
            struct DeleteMigrationProjectEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteMigrationProjectEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteMigrationProjectEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteMigrationProjectInput>()
                        .ok_or("failed to downcast to DeleteMigrationProjectInput")?;
...
/// Error type for the `DeleteMigrationProjectError` operation.
#[non_exhaustive]
...
pub enum DeleteMigrationProjectError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteMigrationProjectError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl DeleteMigrationProjectError {
    /// Creates the `DeleteMigrationProjectError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteMigrationProjectError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DeleteMigrationProjectError::ResourceNotFoundFault`.
    pub fn is_resource_not_found_fault(&self) -> bool {
        matches!(self, Self::ResourceNotFoundFault(_))
    }
}
impl ::std::error::Error for DeleteMigrationProjectError {
...
impl ::std::fmt::Display for DeleteMigrationProjectError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for DeleteMigrationProjectError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteMigrationProjectError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteMigrationProjectError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_migration_project::DeleteMigrationProjectError {
...
mod _delete_migration_project_output;
