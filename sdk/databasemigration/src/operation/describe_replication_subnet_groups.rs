...
impl DescribeReplicationSubnetGroups {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_replication_subnet_groups::DescribeReplicationSubnetGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_replication_subnet_groups::DescribeReplicationSubnetGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_replication_subnet_groups::DescribeReplicationSubnetGroupsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_replication_subnet_groups::DescribeReplicationSubnetGroupsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeReplicationSubnetGroups {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeReplicationSubnetGroups");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeReplicationSubnetGroupsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeReplicationSubnetGroupsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeReplicationSubnetGroups")
                            .with_interceptor(DescribeReplicationSubnetGroupsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_replication_subnet_groups::DescribeReplicationSubnetGroupsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_replication_subnet_groups::DescribeReplicationSubnetGroupsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_replication_subnet_groups::DescribeReplicationSubnetGroupsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DescribeReplicationSubnetGroupsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeReplicationSubnetGroupsResponseDeserializer {
...
#[derive(Debug)]
            struct DescribeReplicationSubnetGroupsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeReplicationSubnetGroupsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_replication_subnet_groups::DescribeReplicationSubnetGroupsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_replication_subnet_groups::DescribeReplicationSubnetGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_replication_subnet_groups::ser_describe_replication_subnet_groups_input(&input)?);
...
#[derive(Debug)]
            struct DescribeReplicationSubnetGroupsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeReplicationSubnetGroupsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeReplicationSubnetGroupsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeReplicationSubnetGroupsInput>()
                        .ok_or("failed to downcast to DescribeReplicationSubnetGroupsInput")?;
...
pub enum DescribeReplicationSubnetGroupsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeReplicationSubnetGroupsError) for what information is available for the error.")]
...
impl DescribeReplicationSubnetGroupsError {
    /// Creates the `DescribeReplicationSubnetGroupsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeReplicationSubnetGroupsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeReplicationSubnetGroupsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_replication_subnet_groups::DescribeReplicationSubnetGroupsError {
