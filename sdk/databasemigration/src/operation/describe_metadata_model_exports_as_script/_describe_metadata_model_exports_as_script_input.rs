...
impl DescribeMetadataModelExportsAsScriptInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_metadata_model_exports_as_script::DescribeMetadataModelExportsAsScriptInput, ::aws_smithy_types::error::operation::BuildError> {
