...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::detect_sentiment::DetectSentimentOutput,
                    crate::operation::detect_sentiment::DetectSentimentError,
                > for DetectSentimentFluentBuilder
            {
                fn send(
                    self,
...
impl DetectSentimentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::detect_sentiment::DetectSentimentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detect_sentiment::DetectSentimentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::detect_sentiment::DetectSentiment::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::detect_sentiment::DetectSentiment::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::detect_sentiment::DetectSentimentOutput, crate::operation::detect_sentiment::DetectSentimentError, Self> {
