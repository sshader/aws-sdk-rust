...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::start_topics_detection_job::StartTopicsDetectionJobOutput,
                    crate::operation::start_topics_detection_job::StartTopicsDetectionJobError,
                > for StartTopicsDetectionJobFluentBuilder
            {
                fn send(
                    self,
...
impl StartTopicsDetectionJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_topics_detection_job::StartTopicsDetectionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_topics_detection_job::StartTopicsDetectionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::start_topics_detection_job::StartTopicsDetectionJob::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::start_topics_detection_job::StartTopicsDetectionJob::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_topics_detection_job::StartTopicsDetectionJobOutput, crate::operation::start_topics_detection_job::StartTopicsDetectionJobError, Self> {
