...
impl BatchDetectDominantLanguage {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchDetectDominantLanguage {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchDetectDominantLanguage");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchDetectDominantLanguageRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchDetectDominantLanguageResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchDetectDominantLanguage")
                            .with_interceptor(BatchDetectDominantLanguageEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct BatchDetectDominantLanguageResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchDetectDominantLanguageResponseDeserializer {
...
#[derive(Debug)]
            struct BatchDetectDominantLanguageRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchDetectDominantLanguageRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_detect_dominant_language::ser_batch_detect_dominant_language_input(&input)?);
...
#[derive(Debug)]
            struct BatchDetectDominantLanguageEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchDetectDominantLanguageEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchDetectDominantLanguageEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchDetectDominantLanguageInput>()
                        .ok_or("failed to downcast to BatchDetectDominantLanguageInput")?;
...
pub enum BatchDetectDominantLanguageError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchDetectDominantLanguageError) for what information is available for the error.")]
...
impl BatchDetectDominantLanguageError {
    /// Creates the `BatchDetectDominantLanguageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchDetectDominantLanguageError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchDetectDominantLanguageError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageError {
