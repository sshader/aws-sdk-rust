...
impl DetectToxicContentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::detect_toxic_content::DetectToxicContentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detect_toxic_content::DetectToxicContentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::detect_toxic_content::DetectToxicContentOutput, crate::operation::detect_toxic_content::DetectToxicContentError, Self> {
