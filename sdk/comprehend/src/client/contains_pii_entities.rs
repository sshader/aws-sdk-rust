...
impl super::Client {
    ...
    ///   - [`text(impl Into<String>)`](crate::operation::contains_pii_entities::builders::ContainsPiiEntitiesFluentBuilder::text) / [`set_text(Option<String>)`](crate::operation::contains_pii_entities::builders::ContainsPiiEntitiesFluentBuilder::set_text):<br>required: **true**<br><p>A UTF-8 text string. The maximum string size is 100 KB.</p><br>
