    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDBInstancesOfferingError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDbInstancesOfferingOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PurchaseReservedDBInstancesOffering {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PurchaseReservedDBInstancesOffering");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PurchaseReservedDBInstancesOfferingRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PurchaseReservedDBInstancesOfferingResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PurchaseReservedDBInstancesOffering")
                            .with_interceptor(PurchaseReservedDBInstancesOfferingEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDBInstancesOfferingError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDBInstancesOfferingError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDBInstancesOfferingError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct PurchaseReservedDBInstancesOfferingResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PurchaseReservedDBInstancesOfferingResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_purchase_reserved_db_instances_offering::de_purchase_reserved_db_instances_offering_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PurchaseReservedDBInstancesOfferingRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PurchaseReservedDBInstancesOfferingRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDbInstancesOfferingInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDbInstancesOfferingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_purchase_reserved_db_instances_offering_input::ser_purchase_reserved_db_instances_offering_input_input_input(&input)?);
...
#[derive(Debug)]
            struct PurchaseReservedDBInstancesOfferingEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PurchaseReservedDBInstancesOfferingEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PurchaseReservedDBInstancesOfferingEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PurchaseReservedDbInstancesOfferingInput>()
                        .ok_or("failed to downcast to PurchaseReservedDbInstancesOfferingInput")?;
...
pub enum PurchaseReservedDBInstancesOfferingError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PurchaseReservedDBInstancesOfferingError) for what information is available for the error.")]
...
impl PurchaseReservedDBInstancesOfferingError {
    /// Creates the `PurchaseReservedDBInstancesOfferingError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PurchaseReservedDBInstancesOfferingError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ReservedDbInstanceAlreadyExistsFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::ReservedDbInstanceQuotaExceededFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PurchaseReservedDBInstancesOfferingError {
...
impl ::aws_types::request_id::RequestId for crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDBInstancesOfferingError {
