...
impl DescribeDBLogFilesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_db_log_files::DescribeDbLogFilesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_db_log_files::DescribeDBLogFilesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_db_log_files::DescribeDbLogFilesOutput, crate::operation::describe_db_log_files::DescribeDBLogFilesError, Self> {
