...
impl RestoreDbClusterFromS3InputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_db_cluster_from_s3::RestoreDbClusterFromS3Input, ::aws_smithy_types::error::operation::BuildError> {
