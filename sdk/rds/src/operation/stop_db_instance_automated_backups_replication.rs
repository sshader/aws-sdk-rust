    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_db_instance_automated_backups_replication::StopDBInstanceAutomatedBackupsReplicationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_db_instance_automated_backups_replication::StopDbInstanceAutomatedBackupsReplicationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopDBInstanceAutomatedBackupsReplication {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopDBInstanceAutomatedBackupsReplication");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopDBInstanceAutomatedBackupsReplicationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopDBInstanceAutomatedBackupsReplicationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopDBInstanceAutomatedBackupsReplication")
                            .with_interceptor(StopDBInstanceAutomatedBackupsReplicationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_db_instance_automated_backups_replication::StopDBInstanceAutomatedBackupsReplicationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_db_instance_automated_backups_replication::StopDBInstanceAutomatedBackupsReplicationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_db_instance_automated_backups_replication::StopDBInstanceAutomatedBackupsReplicationError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct StopDBInstanceAutomatedBackupsReplicationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopDBInstanceAutomatedBackupsReplicationResponseDeserializer {
...
#[derive(Debug)]
            struct StopDBInstanceAutomatedBackupsReplicationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopDBInstanceAutomatedBackupsReplicationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_db_instance_automated_backups_replication::StopDbInstanceAutomatedBackupsReplicationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_db_instance_automated_backups_replication::StopDbInstanceAutomatedBackupsReplicationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_db_instance_automated_backups_replication_input::ser_stop_db_instance_automated_backups_replication_input_input_input(&input)?);
...
#[derive(Debug)]
            struct StopDBInstanceAutomatedBackupsReplicationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopDBInstanceAutomatedBackupsReplicationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopDBInstanceAutomatedBackupsReplicationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopDbInstanceAutomatedBackupsReplicationInput>()
                        .ok_or("failed to downcast to StopDbInstanceAutomatedBackupsReplicationInput")?;
...
pub enum StopDBInstanceAutomatedBackupsReplicationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopDBInstanceAutomatedBackupsReplicationError) for what information is available for the error.")]
...
impl StopDBInstanceAutomatedBackupsReplicationError {
    /// Creates the `StopDBInstanceAutomatedBackupsReplicationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopDBInstanceAutomatedBackupsReplicationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopDBInstanceAutomatedBackupsReplicationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_db_instance_automated_backups_replication::StopDBInstanceAutomatedBackupsReplicationError {
