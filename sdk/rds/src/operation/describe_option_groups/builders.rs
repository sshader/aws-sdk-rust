...
impl DescribeOptionGroupsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_option_groups::DescribeOptionGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_option_groups::DescribeOptionGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_option_groups::DescribeOptionGroupsOutput, crate::operation::describe_option_groups::DescribeOptionGroupsError, Self> {
