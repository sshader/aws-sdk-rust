...
impl ListPackageVersionAssetsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_package_version_assets::ListPackageVersionAssetsInput, ::aws_smithy_types::error::operation::BuildError> {
