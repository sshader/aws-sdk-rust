...
pub(crate) fn de_list_of_video_description<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::VideoDescription>>, ::aws_smithy_json::deserialize::error::DeserializeError>
