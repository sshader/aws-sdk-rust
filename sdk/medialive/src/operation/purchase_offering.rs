    ...
    pub(crate) async fn orchestrate(
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                ...
                                let input: &mut crate::operation::purchase_offering::PurchaseOfferingInput = input.downcast_mut().expect("correct type");
...
#[derive(Debug)]
    ...
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("offering_id", "cannot be empty or unset"))?;
    ...
    if offering_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("offering_id", "cannot be empty or unset"))
                }
