...
impl UpdateSiteAddressFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_site_address::UpdateSiteAddressOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_site_address::UpdateSiteAddressError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_site_address::UpdateSiteAddressOutput, crate::operation::update_site_address::UpdateSiteAddressError, Self> {
