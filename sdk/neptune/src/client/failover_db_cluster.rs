...
impl super::Client {
    ...
    ///   - [`db_cluster(Option<DbCluster>)`](crate::operation::failover_db_cluster::FailoverDbClusterOutput::db_cluster): <p>Contains the details of an Amazon Neptune DB cluster.</p>  <p>This data type is used as a response element in the <code>DescribeDBClusters</code>.</p>
