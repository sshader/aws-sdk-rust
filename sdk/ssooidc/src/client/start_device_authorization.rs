...
impl super::Client {
    ...
    ///   - [`start_url(impl Into<String>)`](crate::operation::start_device_authorization::builders::StartDeviceAuthorizationFluentBuilder::start_url) / [`set_start_url(Option<String>)`](crate::operation::start_device_authorization::builders::StartDeviceAuthorizationFluentBuilder::set_start_url):<br>required: **true**<br><p>The URL for the AWS access portal. For more information, see <a href="https://docs.aws.amazon.com/singlesignon/latest/userguide/using-the-portal.html">Using the AWS access portal</a> in the <i>IAM Identity Center User Guide</i>.</p><br>
