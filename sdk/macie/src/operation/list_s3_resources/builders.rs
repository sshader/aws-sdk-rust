...
impl ListS3ResourcesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_s3_resources::ListS3ResourcesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_s3_resources::ListS3ResourcesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_s3_resources::ListS3ResourcesOutput, crate::operation::list_s3_resources::ListS3ResourcesError, Self> {
