        ...
        ::std::result::Result::Ok(
            crate::types::S3ResourceClassificationUpdate {
                bucket_name: self.bucket_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("bucket_name", "bucket_name was not specified but it is required when building S3ResourceClassificationUpdate")
                    )?
                ,
                prefix: self.prefix
                ,
