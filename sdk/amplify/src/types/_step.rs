...
impl  Step  {
    ...
    pub fn step_name(&self) -> & str {
        use std::ops::Deref; self.step_name.deref()
    }
    /// <p> The start date and time of the execution step. </p>
        ...
        ::std::result::Result::Ok(
            crate::types::Step {
                step_name: self.step_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("step_name", "step_name was not specified but it is required when building Step")
                    )?
                ,
                start_time: self.start_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("start_time", "start_time was not specified but it is required when building Step")
                    )?
                ,
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building Step")
                    )?
                ,
                end_time: self.end_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("end_time", "end_time was not specified but it is required when building Step")
                    )?
                ,
