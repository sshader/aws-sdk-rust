    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDataCatalogEncryptionSettings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDataCatalogEncryptionSettings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDataCatalogEncryptionSettingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDataCatalogEncryptionSettingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDataCatalogEncryptionSettings")
                            .with_interceptor(GetDataCatalogEncryptionSettingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettingsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetDataCatalogEncryptionSettingsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDataCatalogEncryptionSettingsResponseDeserializer {
...
#[derive(Debug)]
            struct GetDataCatalogEncryptionSettingsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDataCatalogEncryptionSettingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_data_catalog_encryption_settings::ser_get_data_catalog_encryption_settings_input(&input)?);
...
#[derive(Debug)]
            struct GetDataCatalogEncryptionSettingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDataCatalogEncryptionSettingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDataCatalogEncryptionSettingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDataCatalogEncryptionSettingsInput>()
                        .ok_or("failed to downcast to GetDataCatalogEncryptionSettingsInput")?;
...
pub enum GetDataCatalogEncryptionSettingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDataCatalogEncryptionSettingsError) for what information is available for the error.")]
...
impl GetDataCatalogEncryptionSettingsError {
    /// Creates the `GetDataCatalogEncryptionSettingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDataCatalogEncryptionSettingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDataCatalogEncryptionSettingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettingsError {
