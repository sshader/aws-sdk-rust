...
impl GetColumnStatisticsForPartition {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetColumnStatisticsForPartition {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetColumnStatisticsForPartition");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetColumnStatisticsForPartitionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetColumnStatisticsForPartitionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetColumnStatisticsForPartition")
                            .with_interceptor(GetColumnStatisticsForPartitionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetColumnStatisticsForPartitionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetColumnStatisticsForPartitionResponseDeserializer {
...
#[derive(Debug)]
            struct GetColumnStatisticsForPartitionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetColumnStatisticsForPartitionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_column_statistics_for_partition::ser_get_column_statistics_for_partition_input(&input)?);
...
#[derive(Debug)]
            struct GetColumnStatisticsForPartitionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetColumnStatisticsForPartitionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetColumnStatisticsForPartitionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetColumnStatisticsForPartitionInput>()
                        .ok_or("failed to downcast to GetColumnStatisticsForPartitionInput")?;
...
pub enum GetColumnStatisticsForPartitionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetColumnStatisticsForPartitionError) for what information is available for the error.")]
...
impl GetColumnStatisticsForPartitionError {
    /// Creates the `GetColumnStatisticsForPartitionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetColumnStatisticsForPartitionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetColumnStatisticsForPartitionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionError {
