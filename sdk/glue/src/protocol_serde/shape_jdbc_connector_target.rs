...
pub fn ser_jdbc_connector_target(
     ...
     {
        object.key("ConnectionTable").string(input.connection_table.as_str());
    }
     {
...
pub(crate) fn de_jdbc_connector_target<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::JdbcConnectorTarget>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::jdbc_connector_target_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
