        ...
        ::std::result::Result::Ok(
            crate::types::CreateXmlClassifierRequest {
                classification: self.classification
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("classification", "classification was not specified but it is required when building CreateXmlClassifierRequest")
                    )?
                ,
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building CreateXmlClassifierRequest")
                    )?
                ,
