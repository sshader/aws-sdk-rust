...
impl CreateScalingPlanFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_scaling_plan::CreateScalingPlanOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_scaling_plan::CreateScalingPlanError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_scaling_plan::CreateScalingPlanOutput, crate::operation::create_scaling_plan::CreateScalingPlanError, Self> {
