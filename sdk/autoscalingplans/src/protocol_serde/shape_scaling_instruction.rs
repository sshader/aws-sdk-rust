...
pub fn ser_scaling_instruction(
     ...
     {
        object.key("MinCapacity").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((input.min_capacity).into()));
    }
     {
    ...
    if let Some(var_8) = &input.scheduled_action_buffer_time {
        object.key("ScheduledActionBufferTime").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_8).into()));
    }
    ...
    if let Some(var_10) = &input.predictive_scaling_max_capacity_buffer {
        object.key("PredictiveScalingMaxCapacityBuffer").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
...
pub(crate) fn de_scaling_instruction<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ScalingInstruction>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::scaling_instruction_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
