...
impl super::Client {
    ...
    ///   - [`analysis_id(impl Into<String>)`](crate::operation::describe_detector_model_analysis::builders::DescribeDetectorModelAnalysisFluentBuilder::analysis_id) / [`set_analysis_id(Option<String>)`](crate::operation::describe_detector_model_analysis::builders::DescribeDetectorModelAnalysisFluentBuilder::set_analysis_id):<br>required: **true**<br><p>The ID of the analysis result that you want to retrieve.</p><br>
