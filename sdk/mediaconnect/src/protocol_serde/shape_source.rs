...
pub(crate) fn de_source<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::Source>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "mediaStreamSourceConfigurations" => {
                                builder = builder.set_media_stream_source_configurations(
                                    crate::protocol_serde::shape_list_of_media_stream_source_configuration::de_list_of_media_stream_source_configuration(tokens)?
                                );
                            }
                            "name" => {
            ...
            Ok(Some(crate::serde_util::source_correct_errors(builder).build()))
        }
        _ => {
