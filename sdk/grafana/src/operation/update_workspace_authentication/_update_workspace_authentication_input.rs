...
impl UpdateWorkspaceAuthenticationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_workspace_authentication::UpdateWorkspaceAuthenticationInput, ::aws_smithy_types::error::operation::BuildError> {
