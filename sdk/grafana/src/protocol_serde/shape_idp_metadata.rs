...
pub fn ser_idp_metadata(object_2: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::IdpMetadata) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
