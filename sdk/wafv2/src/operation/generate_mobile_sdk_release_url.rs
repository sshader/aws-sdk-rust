...
impl GenerateMobileSdkReleaseUrl {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateMobileSdkReleaseUrl {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GenerateMobileSdkReleaseUrl");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GenerateMobileSdkReleaseUrlRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GenerateMobileSdkReleaseUrlResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GenerateMobileSdkReleaseUrl")
                            .with_interceptor(GenerateMobileSdkReleaseUrlEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GenerateMobileSdkReleaseUrlResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateMobileSdkReleaseUrlResponseDeserializer {
...
#[derive(Debug)]
            struct GenerateMobileSdkReleaseUrlRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateMobileSdkReleaseUrlRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_generate_mobile_sdk_release_url::ser_generate_mobile_sdk_release_url_input(&input)?);
...
#[derive(Debug)]
            struct GenerateMobileSdkReleaseUrlEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GenerateMobileSdkReleaseUrlEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GenerateMobileSdkReleaseUrlEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GenerateMobileSdkReleaseUrlInput>()
                        .ok_or("failed to downcast to GenerateMobileSdkReleaseUrlInput")?;
...
pub enum GenerateMobileSdkReleaseUrlError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GenerateMobileSdkReleaseUrlError) for what information is available for the error.")]
...
impl GenerateMobileSdkReleaseUrlError {
    /// Creates the `GenerateMobileSdkReleaseUrlError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GenerateMobileSdkReleaseUrlError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GenerateMobileSdkReleaseUrlError {
...
impl ::aws_types::request_id::RequestId for crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlError {
