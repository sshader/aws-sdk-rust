...
pub(crate) fn de_regex_match_statement<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RegexMatchStatement>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::regex_match_statement_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
