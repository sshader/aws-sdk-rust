...
impl ExecuteProvisionedProductPlan {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                ...
                                let input: &mut crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExecuteProvisionedProductPlan {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ExecuteProvisionedProductPlan");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ExecuteProvisionedProductPlanRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ExecuteProvisionedProductPlanResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExecuteProvisionedProductPlan")
                            .with_interceptor(ExecuteProvisionedProductPlanEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_execute_provisioned_product_plan::de_execute_provisioned_product_plan_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExecuteProvisionedProductPlanRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_execute_provisioned_product_plan::ser_execute_provisioned_product_plan_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ExecuteProvisionedProductPlanEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ExecuteProvisionedProductPlanInput>()
                        .ok_or("failed to downcast to ExecuteProvisionedProductPlanInput")?;
...
pub enum ExecuteProvisionedProductPlanError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ExecuteProvisionedProductPlanError) for what information is available for the error.")]
...
impl ExecuteProvisionedProductPlanError {
    /// Creates the `ExecuteProvisionedProductPlanError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ExecuteProvisionedProductPlanError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ExecuteProvisionedProductPlanError {
...
impl ::aws_types::request_id::RequestId for crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanError {
