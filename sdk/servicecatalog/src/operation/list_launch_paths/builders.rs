...
impl ListLaunchPathsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_launch_paths::ListLaunchPathsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_launch_paths::ListLaunchPathsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_launch_paths::ListLaunchPathsOutput, crate::operation::list_launch_paths::ListLaunchPathsError, Self> {
