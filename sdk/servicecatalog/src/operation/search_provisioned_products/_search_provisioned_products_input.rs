...
impl SearchProvisionedProductsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::search_provisioned_products::SearchProvisionedProductsInput, ::aws_smithy_types::error::operation::BuildError> {
