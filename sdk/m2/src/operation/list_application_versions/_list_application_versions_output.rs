...
impl  ListApplicationVersionsOutput  {
    ...
    pub fn application_versions(&self) -> & [crate::types::ApplicationVersionSummary] {
        use std::ops::Deref; self.application_versions.deref()
    }
    /// <p>If there are more items to return, this contains a token that is passed to a subsequent call to this operation to retrieve the next set of items.</p>
...
impl ListApplicationVersionsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_application_versions::ListApplicationVersionsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_application_versions::ListApplicationVersionsOutput {
                application_versions: self.application_versions
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("application_versions", "application_versions was not specified but it is required when building ListApplicationVersionsOutput")
                    )?
                ,
