...
impl GetDataSetDetailsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_data_set_details::GetDataSetDetailsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_data_set_details::GetDataSetDetailsOutput {
                data_set_name: self.data_set_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("data_set_name", "data_set_name was not specified but it is required when building GetDataSetDetailsOutput")
                    )?
                ,
