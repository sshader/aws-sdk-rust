        ...
        ::std::result::Result::Ok(
            crate::types::TagCollection {
                app_boundary_key: self.app_boundary_key
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("app_boundary_key", "app_boundary_key was not specified but it is required when building TagCollection")
                    )?
                ,
                tag_values: self.tag_values
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("tag_values", "tag_values was not specified but it is required when building TagCollection")
                    )?
                ,
            }
        )
