...
impl super::Client {
    ...
    ///   - [`mean_time_to_recover_in_milliseconds(i64)`](crate::operation::describe_account_overview::DescribeAccountOverviewOutput::mean_time_to_recover_in_milliseconds): <p> The Mean Time to Recover (MTTR) for all closed insights that were created during the time range passed in. </p>
