    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatusError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatusOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeAccountAssignmentCreationStatus {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeAccountAssignmentCreationStatus");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeAccountAssignmentCreationStatusRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeAccountAssignmentCreationStatusResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeAccountAssignmentCreationStatus")
                            .with_interceptor(DescribeAccountAssignmentCreationStatusEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatusError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatusError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatusError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DescribeAccountAssignmentCreationStatusResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeAccountAssignmentCreationStatusResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_describe_account_assignment_creation_status::de_describe_account_assignment_creation_status_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeAccountAssignmentCreationStatusRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeAccountAssignmentCreationStatusRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatusInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_account_assignment_creation_status::ser_describe_account_assignment_creation_status_input(&input)?);
...
#[derive(Debug)]
            struct DescribeAccountAssignmentCreationStatusEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeAccountAssignmentCreationStatusEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeAccountAssignmentCreationStatusEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeAccountAssignmentCreationStatusInput>()
                        .ok_or("failed to downcast to DescribeAccountAssignmentCreationStatusInput")?;
...
pub enum DescribeAccountAssignmentCreationStatusError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeAccountAssignmentCreationStatusError) for what information is available for the error.")]
...
impl DescribeAccountAssignmentCreationStatusError {
    /// Creates the `DescribeAccountAssignmentCreationStatusError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeAccountAssignmentCreationStatusError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeAccountAssignmentCreationStatusError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatusError {
