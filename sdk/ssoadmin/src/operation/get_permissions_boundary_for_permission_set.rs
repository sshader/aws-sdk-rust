...
impl GetPermissionsBoundaryForPermissionSet {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetPermissionsBoundaryForPermissionSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetPermissionsBoundaryForPermissionSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetPermissionsBoundaryForPermissionSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetPermissionsBoundaryForPermissionSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetPermissionsBoundaryForPermissionSet")
                            .with_interceptor(GetPermissionsBoundaryForPermissionSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSetError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetPermissionsBoundaryForPermissionSetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetPermissionsBoundaryForPermissionSetResponseDeserializer {
...
#[derive(Debug)]
            struct GetPermissionsBoundaryForPermissionSetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPermissionsBoundaryForPermissionSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_permissions_boundary_for_permission_set::ser_get_permissions_boundary_for_permission_set_input(&input)?);
...
#[derive(Debug)]
            struct GetPermissionsBoundaryForPermissionSetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetPermissionsBoundaryForPermissionSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetPermissionsBoundaryForPermissionSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetPermissionsBoundaryForPermissionSetInput>()
                        .ok_or("failed to downcast to GetPermissionsBoundaryForPermissionSetInput")?;
...
pub enum GetPermissionsBoundaryForPermissionSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetPermissionsBoundaryForPermissionSetError) for what information is available for the error.")]
...
impl GetPermissionsBoundaryForPermissionSetError {
    /// Creates the `GetPermissionsBoundaryForPermissionSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetPermissionsBoundaryForPermissionSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetPermissionsBoundaryForPermissionSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSetError {
