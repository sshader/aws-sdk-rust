...
impl ListAccountAssignmentDeletionStatus {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAccountAssignmentDeletionStatus {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAccountAssignmentDeletionStatus");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAccountAssignmentDeletionStatusRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAccountAssignmentDeletionStatusResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAccountAssignmentDeletionStatus")
                            .with_interceptor(ListAccountAssignmentDeletionStatusEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct ListAccountAssignmentDeletionStatusResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAccountAssignmentDeletionStatusResponseDeserializer {
...
#[derive(Debug)]
            struct ListAccountAssignmentDeletionStatusRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAccountAssignmentDeletionStatusRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_account_assignment_deletion_status::ser_list_account_assignment_deletion_status_input(&input)?);
...
#[derive(Debug)]
            struct ListAccountAssignmentDeletionStatusEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAccountAssignmentDeletionStatusEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAccountAssignmentDeletionStatusEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAccountAssignmentDeletionStatusInput>()
                        .ok_or("failed to downcast to ListAccountAssignmentDeletionStatusInput")?;
...
pub enum ListAccountAssignmentDeletionStatusError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAccountAssignmentDeletionStatusError) for what information is available for the error.")]
...
impl ListAccountAssignmentDeletionStatusError {
    /// Creates the `ListAccountAssignmentDeletionStatusError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAccountAssignmentDeletionStatusError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAccountAssignmentDeletionStatusError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusError {
