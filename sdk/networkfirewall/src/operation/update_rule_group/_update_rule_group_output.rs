...
impl UpdateRuleGroupOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_rule_group::UpdateRuleGroupOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::update_rule_group::UpdateRuleGroupOutput {
                update_token: self.update_token
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("update_token", "update_token was not specified but it is required when building UpdateRuleGroupOutput")
                    )?
                ,
