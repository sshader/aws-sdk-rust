...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_tls_inspection_configuration::DeleteTlsInspectionConfigurationOutput,
                    crate::operation::delete_tls_inspection_configuration::DeleteTLSInspectionConfigurationError,
                > for DeleteTLSInspectionConfigurationFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteTLSInspectionConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_tls_inspection_configuration::DeleteTlsInspectionConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_tls_inspection_configuration::DeleteTLSInspectionConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_tls_inspection_configuration::DeleteTLSInspectionConfiguration::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_tls_inspection_configuration::DeleteTLSInspectionConfiguration::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_tls_inspection_configuration::DeleteTlsInspectionConfigurationOutput, crate::operation::delete_tls_inspection_configuration::DeleteTLSInspectionConfigurationError, Self> {
