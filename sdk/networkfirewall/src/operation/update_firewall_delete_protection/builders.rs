...
impl UpdateFirewallDeleteProtectionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_firewall_delete_protection::UpdateFirewallDeleteProtectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_firewall_delete_protection::UpdateFirewallDeleteProtectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_firewall_delete_protection::UpdateFirewallDeleteProtectionOutput, crate::operation::update_firewall_delete_protection::UpdateFirewallDeleteProtectionError, Self> {
