...
impl UpdateFirewallPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_firewall_policy::UpdateFirewallPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_firewall_policy::UpdateFirewallPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_firewall_policy::UpdateFirewallPolicyOutput, crate::operation::update_firewall_policy::UpdateFirewallPolicyError, Self> {
