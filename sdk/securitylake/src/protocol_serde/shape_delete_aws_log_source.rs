...
pub fn de_delete_aws_log_source_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_aws_log_source::DeleteAwsLogSourceOutput, crate::operation::delete_aws_log_source::DeleteAwsLogSourceError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_aws_log_source_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_aws_log_source::DeleteAwsLogSourceOutput, crate::operation::delete_aws_log_source::DeleteAwsLogSourceError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_delete_aws_log_source_input(input: &crate::operation::delete_aws_log_source::DeleteAwsLogSourceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_delete_aws_log_source_input::ser_delete_aws_log_source_input_input(&mut object, input)?;
    object.finish();
