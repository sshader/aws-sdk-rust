...
impl GetSavingsPlansPurchaseRecommendationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_savings_plans_purchase_recommendation::GetSavingsPlansPurchaseRecommendationInput, ::aws_smithy_types::error::operation::BuildError> {
