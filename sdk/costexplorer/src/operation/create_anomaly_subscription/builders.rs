...
impl CreateAnomalySubscriptionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_anomaly_subscription::CreateAnomalySubscriptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_anomaly_subscription::CreateAnomalySubscriptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_anomaly_subscription::CreateAnomalySubscriptionOutput, crate::operation::create_anomaly_subscription::CreateAnomalySubscriptionError, Self> {
