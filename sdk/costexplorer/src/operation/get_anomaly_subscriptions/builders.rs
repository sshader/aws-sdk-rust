...
impl GetAnomalySubscriptionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_anomaly_subscriptions::GetAnomalySubscriptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_anomaly_subscriptions::GetAnomalySubscriptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_anomaly_subscriptions::GetAnomalySubscriptionsOutput, crate::operation::get_anomaly_subscriptions::GetAnomalySubscriptionsError, Self> {
