...
impl UpdateUserError {
    ...
    /// Returns `true` if the error kind is `UpdateUserError::DirectoryServiceAuthenticationFailedException`.
    ...
    /// Returns `true` if the error kind is `UpdateUserError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateUserError::EntityStateException`.
    pub fn is_entity_state_exception(&self) -> bool {
        matches!(self, Self::EntityStateException(_))
    }
    /// Returns `true` if the error kind is `UpdateUserError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `UpdateUserError::OrganizationNotFoundException`.
    pub fn is_organization_not_found_exception(&self) -> bool {
        matches!(self, Self::OrganizationNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateUserError::OrganizationStateException`.
    pub fn is_organization_state_exception(&self) -> bool {
        matches!(self, Self::OrganizationStateException(_))
    }
    /// Returns `true` if the error kind is `UpdateUserError::UnsupportedOperationException`.
