...
impl super::Client {
    ...
    ///   - [`dashboard_name(impl Into<String>)`](crate::operation::get_dashboard::builders::GetDashboardFluentBuilder::dashboard_name) / [`set_dashboard_name(Option<String>)`](crate::operation::get_dashboard::builders::GetDashboardFluentBuilder::set_dashboard_name):<br>required: **true**<br><p>The name of the dashboard to be described.</p><br>
