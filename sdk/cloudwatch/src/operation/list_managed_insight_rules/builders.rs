...
impl ListManagedInsightRulesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_managed_insight_rules::ListManagedInsightRulesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_managed_insight_rules::ListManagedInsightRulesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_managed_insight_rules::ListManagedInsightRulesOutput, crate::operation::list_managed_insight_rules::ListManagedInsightRulesError, Self> {
