...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_anomaly_detector_input::ser_delete_anomaly_detector_input_input_input(&input)?);
