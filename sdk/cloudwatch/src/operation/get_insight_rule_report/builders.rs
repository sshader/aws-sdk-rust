...
impl GetInsightRuleReportFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_insight_rule_report::GetInsightRuleReportOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_insight_rule_report::GetInsightRuleReportError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_insight_rule_report::GetInsightRuleReportOutput, crate::operation::get_insight_rule_report::GetInsightRuleReportError, Self> {
