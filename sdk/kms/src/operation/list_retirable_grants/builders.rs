...
impl ListRetirableGrantsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_retirable_grants::ListRetirableGrantsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_retirable_grants::ListRetirableGrantsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_retirable_grants::ListRetirableGrantsOutput, crate::operation::list_retirable_grants::ListRetirableGrantsError, Self> {
