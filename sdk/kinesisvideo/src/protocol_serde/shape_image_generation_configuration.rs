...
pub(crate) fn de_image_generation_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ImageGenerationConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::image_generation_configuration_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
...
pub fn ser_image_generation_configuration(
    ...
    if let Some(var_1) = &input.destination_config {
     ...
     {
        object.key("SamplingInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((input.sampling_interval).into()));
    }
     {
    ...
    if let Some(var_7) = &input.width_pixels {
        object.key("WidthPixels").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    if let Some(var_8) = &input.height_pixels {
        object.key("HeightPixels").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_8).into()));
    }
    Ok(())
}
