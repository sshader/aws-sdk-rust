...
fn uri_query(_input: &crate::operation::describe_entity::DescribeEntityInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let inner_2 = inner_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("entity_id", "cannot be empty or unset"))?;
    if inner_2.is_empty() {
...
impl DescribeEntityError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ResourceNotSupportedException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
