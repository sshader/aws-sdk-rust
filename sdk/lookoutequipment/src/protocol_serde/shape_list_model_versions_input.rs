...
pub fn ser_list_model_versions_input_input(
    ...
    if let Some(var_6) = &input.created_at_end_time {
        object.key("CreatedAtEndTime").date_time(var_6, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_7) = &input.created_at_start_time {
        object.key("CreatedAtStartTime").date_time(var_7, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_8) = &input.max_model_version {
        object.key("MaxModelVersion").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_8).into()));
    }
    if let Some(var_9) = &input.min_model_version {
        object.key("MinModelVersion").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_9).into()));
    }
    Ok(())
}
