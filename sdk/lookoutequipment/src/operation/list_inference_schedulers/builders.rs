...
impl ListInferenceSchedulersFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_inference_schedulers::ListInferenceSchedulersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_inference_schedulers::ListInferenceSchedulersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_inference_schedulers::ListInferenceSchedulersOutput, crate::operation::list_inference_schedulers::ListInferenceSchedulersError, Self> {
