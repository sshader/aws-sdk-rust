...
impl DeleteInferenceSchedulerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_inference_scheduler::DeleteInferenceSchedulerInput, ::aws_smithy_types::error::operation::BuildError> {
