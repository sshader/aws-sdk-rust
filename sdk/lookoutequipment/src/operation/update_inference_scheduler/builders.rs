...
impl UpdateInferenceSchedulerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_inference_scheduler::UpdateInferenceSchedulerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_inference_scheduler::UpdateInferenceSchedulerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_inference_scheduler::UpdateInferenceSchedulerOutput, crate::operation::update_inference_scheduler::UpdateInferenceSchedulerError, Self> {
