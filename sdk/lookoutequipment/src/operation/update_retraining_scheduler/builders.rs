...
impl UpdateRetrainingSchedulerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_retraining_scheduler::UpdateRetrainingSchedulerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_retraining_scheduler::UpdateRetrainingSchedulerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_retraining_scheduler::UpdateRetrainingSchedulerOutput, crate::operation::update_retraining_scheduler::UpdateRetrainingSchedulerError, Self> {
