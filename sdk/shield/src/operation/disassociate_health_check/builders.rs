...
impl DisassociateHealthCheckFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::disassociate_health_check::DisassociateHealthCheckOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_health_check::DisassociateHealthCheckError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::disassociate_health_check::DisassociateHealthCheckOutput, crate::operation::disassociate_health_check::DisassociateHealthCheckError, Self> {
