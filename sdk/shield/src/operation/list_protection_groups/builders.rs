...
impl ListProtectionGroupsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_protection_groups::ListProtectionGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_protection_groups::ListProtectionGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_protection_groups::ListProtectionGroupsOutput, crate::operation::list_protection_groups::ListProtectionGroupsError, Self> {
