    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetailsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetailsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateProactiveEngagementDetails {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateProactiveEngagementDetails");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateProactiveEngagementDetailsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateProactiveEngagementDetailsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateProactiveEngagementDetails")
                            .with_interceptor(AssociateProactiveEngagementDetailsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetailsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetailsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetailsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct AssociateProactiveEngagementDetailsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateProactiveEngagementDetailsResponseDeserializer {
...
#[derive(Debug)]
            struct AssociateProactiveEngagementDetailsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateProactiveEngagementDetailsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetailsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetailsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_proactive_engagement_details::ser_associate_proactive_engagement_details_input(&input)?);
...
#[derive(Debug)]
            struct AssociateProactiveEngagementDetailsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateProactiveEngagementDetailsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateProactiveEngagementDetailsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateProactiveEngagementDetailsInput>()
                        .ok_or("failed to downcast to AssociateProactiveEngagementDetailsInput")?;
...
pub enum AssociateProactiveEngagementDetailsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateProactiveEngagementDetailsError) for what information is available for the error.")]
...
impl AssociateProactiveEngagementDetailsError {
    /// Creates the `AssociateProactiveEngagementDetailsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateProactiveEngagementDetailsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateProactiveEngagementDetailsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetailsError {
