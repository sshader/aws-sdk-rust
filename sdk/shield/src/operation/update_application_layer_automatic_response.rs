    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_application_layer_automatic_response::UpdateApplicationLayerAutomaticResponseError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_application_layer_automatic_response::UpdateApplicationLayerAutomaticResponseOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateApplicationLayerAutomaticResponse {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateApplicationLayerAutomaticResponse");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateApplicationLayerAutomaticResponseRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateApplicationLayerAutomaticResponseResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateApplicationLayerAutomaticResponse")
                            .with_interceptor(UpdateApplicationLayerAutomaticResponseEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_application_layer_automatic_response::UpdateApplicationLayerAutomaticResponseError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_application_layer_automatic_response::UpdateApplicationLayerAutomaticResponseError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_application_layer_automatic_response::UpdateApplicationLayerAutomaticResponseError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct UpdateApplicationLayerAutomaticResponseResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateApplicationLayerAutomaticResponseResponseDeserializer {
...
#[derive(Debug)]
            struct UpdateApplicationLayerAutomaticResponseRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateApplicationLayerAutomaticResponseRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_application_layer_automatic_response::UpdateApplicationLayerAutomaticResponseInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_application_layer_automatic_response::UpdateApplicationLayerAutomaticResponseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_application_layer_automatic_response::ser_update_application_layer_automatic_response_input(&input)?);
...
#[derive(Debug)]
            struct UpdateApplicationLayerAutomaticResponseEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateApplicationLayerAutomaticResponseEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateApplicationLayerAutomaticResponseEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateApplicationLayerAutomaticResponseInput>()
                        .ok_or("failed to downcast to UpdateApplicationLayerAutomaticResponseInput")?;
...
pub enum UpdateApplicationLayerAutomaticResponseError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateApplicationLayerAutomaticResponseError) for what information is available for the error.")]
...
impl UpdateApplicationLayerAutomaticResponseError {
    /// Creates the `UpdateApplicationLayerAutomaticResponseError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateApplicationLayerAutomaticResponseError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateApplicationLayerAutomaticResponseError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_application_layer_automatic_response::UpdateApplicationLayerAutomaticResponseError {
