...
impl DescribeAttackStatisticsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_attack_statistics::DescribeAttackStatisticsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_attack_statistics::DescribeAttackStatisticsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_attack_statistics::DescribeAttackStatisticsOutput, crate::operation::describe_attack_statistics::DescribeAttackStatisticsError, Self> {
