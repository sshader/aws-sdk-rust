...
impl AssociateConfigurationItemsToApplication {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateConfigurationItemsToApplication {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateConfigurationItemsToApplication");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateConfigurationItemsToApplicationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateConfigurationItemsToApplicationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateConfigurationItemsToApplication")
                            .with_interceptor(AssociateConfigurationItemsToApplicationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct AssociateConfigurationItemsToApplicationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateConfigurationItemsToApplicationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_associate_configuration_items_to_application::de_associate_configuration_items_to_application_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AssociateConfigurationItemsToApplicationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateConfigurationItemsToApplicationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_configuration_items_to_application::ser_associate_configuration_items_to_application_input(&input)?);
...
#[derive(Debug)]
            struct AssociateConfigurationItemsToApplicationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateConfigurationItemsToApplicationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateConfigurationItemsToApplicationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateConfigurationItemsToApplicationInput>()
                        .ok_or("failed to downcast to AssociateConfigurationItemsToApplicationInput")?;
...
pub enum AssociateConfigurationItemsToApplicationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateConfigurationItemsToApplicationError) for what information is available for the error.")]
...
impl AssociateConfigurationItemsToApplicationError {
    /// Creates the `AssociateConfigurationItemsToApplicationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateConfigurationItemsToApplicationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateConfigurationItemsToApplicationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_configuration_items_to_application::AssociateConfigurationItemsToApplicationError {
