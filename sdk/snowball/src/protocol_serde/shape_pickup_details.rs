...
pub fn ser_pickup_details(
    ...
    if let Some(var_5) = &input.identification_expiration_date {
        object.key("IdentificationExpirationDate").date_time(var_5, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
...
pub(crate) fn de_pickup_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PickupDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    ...
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "IdentificationExpirationDate" => {
                                builder = builder.set_identification_expiration_date(
