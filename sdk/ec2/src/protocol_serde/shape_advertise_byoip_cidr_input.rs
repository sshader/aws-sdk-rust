...
pub fn ser_advertise_byoip_cidr_input_input_input(input: &crate::operation::advertise_byoip_cidr::AdvertiseByoipCidrInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
