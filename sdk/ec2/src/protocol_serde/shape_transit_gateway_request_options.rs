...
#[allow(unused_mut)]
pub fn ser_transit_gateway_request_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::TransitGatewayRequestOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
