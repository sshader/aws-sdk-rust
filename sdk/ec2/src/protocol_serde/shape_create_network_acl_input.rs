...
pub fn ser_create_network_acl_input_input_input(input: &crate::operation::create_network_acl::CreateNetworkAclInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
