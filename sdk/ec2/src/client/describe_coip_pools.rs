...
impl super::Client {
    ...
    ///   - [`pool_ids(impl Into<String>)`](crate::operation::describe_coip_pools::builders::DescribeCoipPoolsFluentBuilder::pool_ids) / [`set_pool_ids(Option<Vec::<String>>)`](crate::operation::describe_coip_pools::builders::DescribeCoipPoolsFluentBuilder::set_pool_ids):<br>required: **false**<br><p>The IDs of the address pools.</p><br>
    ///   - [`filters(Filter)`](crate::operation::describe_coip_pools::builders::DescribeCoipPoolsFluentBuilder::filters) / [`set_filters(Option<Vec::<Filter>>)`](crate::operation::describe_coip_pools::builders::DescribeCoipPoolsFluentBuilder::set_filters):<br>required: **false**<br><p>One or more filters.</p>  <ul>   <li> <p> <code>coip-pool.local-gateway-route-table-id</code> - The ID of the local gateway route table.</p> </li>   <li> <p> <code>coip-pool.pool-id</code> - The ID of the address pool.</p> </li>  </ul><br>
    ///   - [`max_results(i32)`](crate::operation::describe_coip_pools::builders::DescribeCoipPoolsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_coip_pools::builders::DescribeCoipPoolsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return with a single call. To retrieve the remaining results, make another call with the returned <code>nextToken</code> value.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_coip_pools::builders::DescribeCoipPoolsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_coip_pools::builders::DescribeCoipPoolsFluentBuilder::set_next_token):<br>required: **false**<br><p>The token for the next page of results.</p><br>
