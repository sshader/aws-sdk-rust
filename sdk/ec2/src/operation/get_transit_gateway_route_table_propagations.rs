...
impl GetTransitGatewayRouteTablePropagations {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTransitGatewayRouteTablePropagations {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetTransitGatewayRouteTablePropagations");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetTransitGatewayRouteTablePropagationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetTransitGatewayRouteTablePropagationsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetTransitGatewayRouteTablePropagations")
                            .with_interceptor(GetTransitGatewayRouteTablePropagationsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetTransitGatewayRouteTablePropagationsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetTransitGatewayRouteTablePropagationsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_transit_gateway_route_table_propagations::de_get_transit_gateway_route_table_propagations_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetTransitGatewayRouteTablePropagationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetTransitGatewayRouteTablePropagationsEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetTransitGatewayRouteTablePropagationsInput>()
                        .ok_or("failed to downcast to GetTransitGatewayRouteTablePropagationsInput")?;
...
pub enum GetTransitGatewayRouteTablePropagationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetTransitGatewayRouteTablePropagationsError) for what information is available for the error.")]
...
impl GetTransitGatewayRouteTablePropagationsError {
    /// Creates the `GetTransitGatewayRouteTablePropagationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetTransitGatewayRouteTablePropagationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetTransitGatewayRouteTablePropagationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsError {
