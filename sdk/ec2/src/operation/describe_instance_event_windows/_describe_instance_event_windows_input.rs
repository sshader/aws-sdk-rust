...
impl DescribeInstanceEventWindowsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsInput, ::aws_smithy_types::error::operation::BuildError> {
