...
impl ModifyNetworkInterfaceAttributeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_network_interface_attribute::ModifyNetworkInterfaceAttributeInput, ::aws_smithy_types::error::operation::BuildError> {
