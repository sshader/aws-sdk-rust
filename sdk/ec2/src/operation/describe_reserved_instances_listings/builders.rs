...
impl DescribeReservedInstancesListingsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_reserved_instances_listings::DescribeReservedInstancesListingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_reserved_instances_listings::DescribeReservedInstancesListingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_reserved_instances_listings::DescribeReservedInstancesListingsOutput, crate::operation::describe_reserved_instances_listings::DescribeReservedInstancesListingsError, Self> {
