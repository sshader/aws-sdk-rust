...
impl CreateSubnetCidrReservationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationOutput, crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationError, Self> {
