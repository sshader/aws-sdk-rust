    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::attach_verified_access_trust_provider::AttachVerifiedAccessTrustProviderError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::attach_verified_access_trust_provider::AttachVerifiedAccessTrustProviderOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                ...
                                let input: &mut crate::operation::attach_verified_access_trust_provider::AttachVerifiedAccessTrustProviderInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AttachVerifiedAccessTrustProvider {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AttachVerifiedAccessTrustProvider");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AttachVerifiedAccessTrustProviderRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AttachVerifiedAccessTrustProviderResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AttachVerifiedAccessTrustProvider")
                            .with_interceptor(AttachVerifiedAccessTrustProviderEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::attach_verified_access_trust_provider::AttachVerifiedAccessTrustProviderError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::attach_verified_access_trust_provider::AttachVerifiedAccessTrustProviderError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::attach_verified_access_trust_provider::AttachVerifiedAccessTrustProviderError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct AttachVerifiedAccessTrustProviderRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AttachVerifiedAccessTrustProviderRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::attach_verified_access_trust_provider::AttachVerifiedAccessTrustProviderInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::attach_verified_access_trust_provider::AttachVerifiedAccessTrustProviderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_attach_verified_access_trust_provider_input::ser_attach_verified_access_trust_provider_input_input_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AttachVerifiedAccessTrustProviderEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AttachVerifiedAccessTrustProviderInput>()
                        .ok_or("failed to downcast to AttachVerifiedAccessTrustProviderInput")?;
...
pub enum AttachVerifiedAccessTrustProviderError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AttachVerifiedAccessTrustProviderError) for what information is available for the error.")]
...
impl AttachVerifiedAccessTrustProviderError {
    /// Creates the `AttachVerifiedAccessTrustProviderError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AttachVerifiedAccessTrustProviderError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AttachVerifiedAccessTrustProviderError {
...
impl ::aws_types::request_id::RequestId for crate::operation::attach_verified_access_trust_provider::AttachVerifiedAccessTrustProviderError {
