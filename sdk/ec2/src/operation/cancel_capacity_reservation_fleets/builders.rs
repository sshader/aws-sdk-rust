...
impl CancelCapacityReservationFleetsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleetsOutput, crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleetsError, Self> {
