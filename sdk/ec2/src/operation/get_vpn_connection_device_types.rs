...
impl GetVpnConnectionDeviceTypes {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_vpn_connection_device_types::GetVpnConnectionDeviceTypesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_vpn_connection_device_types::GetVpnConnectionDeviceTypesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_vpn_connection_device_types::GetVpnConnectionDeviceTypesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_vpn_connection_device_types::GetVpnConnectionDeviceTypesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetVpnConnectionDeviceTypes {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetVpnConnectionDeviceTypes");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetVpnConnectionDeviceTypesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetVpnConnectionDeviceTypesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetVpnConnectionDeviceTypes")
                            .with_interceptor(GetVpnConnectionDeviceTypesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_vpn_connection_device_types::GetVpnConnectionDeviceTypesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_vpn_connection_device_types::GetVpnConnectionDeviceTypesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_vpn_connection_device_types::GetVpnConnectionDeviceTypesError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetVpnConnectionDeviceTypesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetVpnConnectionDeviceTypesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_vpn_connection_device_types::de_get_vpn_connection_device_types_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetVpnConnectionDeviceTypesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetVpnConnectionDeviceTypesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_vpn_connection_device_types::GetVpnConnectionDeviceTypesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_vpn_connection_device_types::GetVpnConnectionDeviceTypesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_vpn_connection_device_types_input::ser_get_vpn_connection_device_types_input_input_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetVpnConnectionDeviceTypesEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetVpnConnectionDeviceTypesInput>()
                        .ok_or("failed to downcast to GetVpnConnectionDeviceTypesInput")?;
...
pub enum GetVpnConnectionDeviceTypesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetVpnConnectionDeviceTypesError) for what information is available for the error.")]
...
impl GetVpnConnectionDeviceTypesError {
    /// Creates the `GetVpnConnectionDeviceTypesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetVpnConnectionDeviceTypesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetVpnConnectionDeviceTypesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_vpn_connection_device_types::GetVpnConnectionDeviceTypesError {
