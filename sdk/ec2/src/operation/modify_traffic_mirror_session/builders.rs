...
impl ModifyTrafficMirrorSessionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_traffic_mirror_session::ModifyTrafficMirrorSessionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_traffic_mirror_session::ModifyTrafficMirrorSessionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_traffic_mirror_session::ModifyTrafficMirrorSessionOutput, crate::operation::modify_traffic_mirror_session::ModifyTrafficMirrorSessionError, Self> {
