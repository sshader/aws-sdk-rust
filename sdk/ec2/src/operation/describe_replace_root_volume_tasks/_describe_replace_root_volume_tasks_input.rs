...
impl DescribeReplaceRootVolumeTasksInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_replace_root_volume_tasks::DescribeReplaceRootVolumeTasksInput, ::aws_smithy_types::error::operation::BuildError> {
