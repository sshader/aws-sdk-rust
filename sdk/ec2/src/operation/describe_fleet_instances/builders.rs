...
impl DescribeFleetInstancesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_fleet_instances::DescribeFleetInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_fleet_instances::DescribeFleetInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_fleet_instances::DescribeFleetInstancesOutput, crate::operation::describe_fleet_instances::DescribeFleetInstancesError, Self> {
