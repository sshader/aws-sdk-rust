...
impl CreateIpamScopeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_ipam_scope::CreateIpamScopeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_ipam_scope::CreateIpamScopeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_ipam_scope::CreateIpamScopeOutput, crate::operation::create_ipam_scope::CreateIpamScopeError, Self> {
