...
impl ReplaceTransitGatewayRoute {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReplaceTransitGatewayRoute {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ReplaceTransitGatewayRoute");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ReplaceTransitGatewayRouteRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ReplaceTransitGatewayRouteResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReplaceTransitGatewayRoute")
                            .with_interceptor(ReplaceTransitGatewayRouteEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_replace_transit_gateway_route::de_replace_transit_gateway_route_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReplaceTransitGatewayRouteRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_replace_transit_gateway_route_input::ser_replace_transit_gateway_route_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ReplaceTransitGatewayRouteEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ReplaceTransitGatewayRouteEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ReplaceTransitGatewayRouteEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ReplaceTransitGatewayRouteInput>()
                        .ok_or("failed to downcast to ReplaceTransitGatewayRouteInput")?;
...
pub enum ReplaceTransitGatewayRouteError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ReplaceTransitGatewayRouteError) for what information is available for the error.")]
...
impl ReplaceTransitGatewayRouteError {
    /// Creates the `ReplaceTransitGatewayRouteError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ReplaceTransitGatewayRouteError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ReplaceTransitGatewayRouteError {
...
impl ::aws_types::request_id::RequestId for crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteError {
