    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_transit_gateway_route_table::DisassociateTransitGatewayRouteTableError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_transit_gateway_route_table::DisassociateTransitGatewayRouteTableOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateTransitGatewayRouteTable {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateTransitGatewayRouteTable");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateTransitGatewayRouteTableRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateTransitGatewayRouteTableResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateTransitGatewayRouteTable")
                            .with_interceptor(DisassociateTransitGatewayRouteTableEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_transit_gateway_route_table::DisassociateTransitGatewayRouteTableError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_transit_gateway_route_table::DisassociateTransitGatewayRouteTableError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_transit_gateway_route_table::DisassociateTransitGatewayRouteTableError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DisassociateTransitGatewayRouteTableResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateTransitGatewayRouteTableResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_disassociate_transit_gateway_route_table::de_disassociate_transit_gateway_route_table_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateTransitGatewayRouteTableRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_transit_gateway_route_table::DisassociateTransitGatewayRouteTableInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_transit_gateway_route_table::DisassociateTransitGatewayRouteTableInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateTransitGatewayRouteTableEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateTransitGatewayRouteTableInput>()
                        .ok_or("failed to downcast to DisassociateTransitGatewayRouteTableInput")?;
...
pub enum DisassociateTransitGatewayRouteTableError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateTransitGatewayRouteTableError) for what information is available for the error.")]
...
impl DisassociateTransitGatewayRouteTableError {
    /// Creates the `DisassociateTransitGatewayRouteTableError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateTransitGatewayRouteTableError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateTransitGatewayRouteTableError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_transit_gateway_route_table::DisassociateTransitGatewayRouteTableError {
