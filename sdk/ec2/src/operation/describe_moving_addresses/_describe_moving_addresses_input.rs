...
impl DescribeMovingAddressesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_moving_addresses::DescribeMovingAddressesInput, ::aws_smithy_types::error::operation::BuildError> {
