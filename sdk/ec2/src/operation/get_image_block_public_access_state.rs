...
impl GetImageBlockPublicAccessState {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_image_block_public_access_state::GetImageBlockPublicAccessStateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_image_block_public_access_state::GetImageBlockPublicAccessStateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_image_block_public_access_state::GetImageBlockPublicAccessStateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_image_block_public_access_state::GetImageBlockPublicAccessStateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetImageBlockPublicAccessState {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetImageBlockPublicAccessState");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetImageBlockPublicAccessStateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetImageBlockPublicAccessStateResponseDeserializer));
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetImageBlockPublicAccessState")
                            ...
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_image_block_public_access_state::GetImageBlockPublicAccessStateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_image_block_public_access_state::GetImageBlockPublicAccessStateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_image_block_public_access_state::GetImageBlockPublicAccessStateError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_image_block_public_access_state::de_get_image_block_public_access_state_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_image_block_public_access_state::de_get_image_block_public_access_state_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetImageBlockPublicAccessStateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_image_block_public_access_state::GetImageBlockPublicAccessStateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_image_block_public_access_state::GetImageBlockPublicAccessStateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_image_block_public_access_state_input::ser_get_image_block_public_access_state_input_input_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetImageBlockPublicAccessStateEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetImageBlockPublicAccessStateInput>()
                        .ok_or("failed to downcast to GetImageBlockPublicAccessStateInput")?;
...
/// Error type for the `GetImageBlockPublicAccessStateError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetImageBlockPublicAccessStateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetImageBlockPublicAccessStateError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetImageBlockPublicAccessStateError {
    /// Creates the `GetImageBlockPublicAccessStateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetImageBlockPublicAccessStateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for GetImageBlockPublicAccessStateError {
...
impl ::std::fmt::Display for GetImageBlockPublicAccessStateError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetImageBlockPublicAccessStateError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetImageBlockPublicAccessStateError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetImageBlockPublicAccessStateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_image_block_public_access_state::GetImageBlockPublicAccessStateError {
...
mod _get_image_block_public_access_state_output;
