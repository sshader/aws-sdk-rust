...
impl DescribeInstanceCreditSpecifications {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_instance_credit_specifications::DescribeInstanceCreditSpecificationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_instance_credit_specifications::DescribeInstanceCreditSpecificationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_instance_credit_specifications::DescribeInstanceCreditSpecificationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_instance_credit_specifications::DescribeInstanceCreditSpecificationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeInstanceCreditSpecifications {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeInstanceCreditSpecifications");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeInstanceCreditSpecificationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeInstanceCreditSpecificationsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeInstanceCreditSpecifications")
                            .with_interceptor(DescribeInstanceCreditSpecificationsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_instance_credit_specifications::DescribeInstanceCreditSpecificationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_instance_credit_specifications::DescribeInstanceCreditSpecificationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_instance_credit_specifications::DescribeInstanceCreditSpecificationsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DescribeInstanceCreditSpecificationsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeInstanceCreditSpecificationsResponseDeserializer {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeInstanceCreditSpecificationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_instance_credit_specifications::DescribeInstanceCreditSpecificationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_instance_credit_specifications::DescribeInstanceCreditSpecificationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_instance_credit_specifications_input::ser_describe_instance_credit_specifications_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeInstanceCreditSpecificationsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeInstanceCreditSpecificationsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeInstanceCreditSpecificationsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeInstanceCreditSpecificationsInput>()
                        .ok_or("failed to downcast to DescribeInstanceCreditSpecificationsInput")?;
...
pub enum DescribeInstanceCreditSpecificationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeInstanceCreditSpecificationsError) for what information is available for the error.")]
...
impl DescribeInstanceCreditSpecificationsError {
    /// Creates the `DescribeInstanceCreditSpecificationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeInstanceCreditSpecificationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeInstanceCreditSpecificationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_instance_credit_specifications::DescribeInstanceCreditSpecificationsError {
