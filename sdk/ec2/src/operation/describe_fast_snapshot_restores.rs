...
impl DescribeFastSnapshotRestores {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_fast_snapshot_restores::DescribeFastSnapshotRestoresOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_fast_snapshot_restores::DescribeFastSnapshotRestoresError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_fast_snapshot_restores::DescribeFastSnapshotRestoresError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_fast_snapshot_restores::DescribeFastSnapshotRestoresOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeFastSnapshotRestores {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeFastSnapshotRestores");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeFastSnapshotRestoresRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeFastSnapshotRestoresResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeFastSnapshotRestores")
                            .with_interceptor(DescribeFastSnapshotRestoresEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_fast_snapshot_restores::DescribeFastSnapshotRestoresError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_fast_snapshot_restores::DescribeFastSnapshotRestoresError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_fast_snapshot_restores::DescribeFastSnapshotRestoresError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DescribeFastSnapshotRestoresResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeFastSnapshotRestoresResponseDeserializer {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeFastSnapshotRestoresRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_fast_snapshot_restores::DescribeFastSnapshotRestoresInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_fast_snapshot_restores::DescribeFastSnapshotRestoresInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_fast_snapshot_restores_input::ser_describe_fast_snapshot_restores_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeFastSnapshotRestoresEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeFastSnapshotRestoresEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeFastSnapshotRestoresEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeFastSnapshotRestoresInput>()
                        .ok_or("failed to downcast to DescribeFastSnapshotRestoresInput")?;
...
pub enum DescribeFastSnapshotRestoresError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeFastSnapshotRestoresError) for what information is available for the error.")]
...
impl DescribeFastSnapshotRestoresError {
    /// Creates the `DescribeFastSnapshotRestoresError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeFastSnapshotRestoresError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeFastSnapshotRestoresError {
