...
impl DisableImageBlockPublicAccessFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::disable_image_block_public_access::DisableImageBlockPublicAccessOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_image_block_public_access::DisableImageBlockPublicAccessError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::disable_image_block_public_access::DisableImageBlockPublicAccessOutput, crate::operation::disable_image_block_public_access::DisableImageBlockPublicAccessError, Self> {
