...
impl GetFlowLogsIntegrationTemplate {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetFlowLogsIntegrationTemplate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetFlowLogsIntegrationTemplate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetFlowLogsIntegrationTemplateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetFlowLogsIntegrationTemplateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetFlowLogsIntegrationTemplate")
                            .with_interceptor(GetFlowLogsIntegrationTemplateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetFlowLogsIntegrationTemplateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetFlowLogsIntegrationTemplateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_flow_logs_integration_template_input::ser_get_flow_logs_integration_template_input_input_input(&input)?);
...
#[derive(Debug)]
            struct GetFlowLogsIntegrationTemplateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetFlowLogsIntegrationTemplateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetFlowLogsIntegrationTemplateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetFlowLogsIntegrationTemplateInput>()
                        .ok_or("failed to downcast to GetFlowLogsIntegrationTemplateInput")?;
...
pub enum GetFlowLogsIntegrationTemplateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetFlowLogsIntegrationTemplateError) for what information is available for the error.")]
...
impl GetFlowLogsIntegrationTemplateError {
    /// Creates the `GetFlowLogsIntegrationTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetFlowLogsIntegrationTemplateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetFlowLogsIntegrationTemplateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateError {
