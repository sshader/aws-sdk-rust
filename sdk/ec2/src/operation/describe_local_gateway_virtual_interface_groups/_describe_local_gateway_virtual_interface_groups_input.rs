...
impl DescribeLocalGatewayVirtualInterfaceGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_local_gateway_virtual_interface_groups::DescribeLocalGatewayVirtualInterfaceGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
