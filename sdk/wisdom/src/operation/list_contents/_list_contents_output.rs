...
impl ListContentsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_contents::ListContentsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_contents::ListContentsOutput {
                content_summaries: self.content_summaries
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("content_summaries", "content_summaries was not specified but it is required when building ListContentsOutput")
                    )?
                ,
