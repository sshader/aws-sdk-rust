...
impl  AccessPointAlreadyExists  {
    ...
    pub fn access_point_id(&self) -> & str {
        use std::ops::Deref; self.access_point_id.deref()
    }
}
impl AccessPointAlreadyExists {
        ...
        ::std::result::Result::Ok(
            crate::types::error::AccessPointAlreadyExists {
                error_code: self.error_code
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("error_code", "error_code was not specified but it is required when building AccessPointAlreadyExists")
                    )?
                ,
                ...
                access_point_id: self.access_point_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("access_point_id", "access_point_id was not specified but it is required when building AccessPointAlreadyExists")
                    )?
                ,
