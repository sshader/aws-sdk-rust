...
impl PutLifecycleConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_lifecycle_configuration::PutLifecycleConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_lifecycle_configuration::PutLifecycleConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_lifecycle_configuration::PutLifecycleConfigurationOutput, crate::operation::put_lifecycle_configuration::PutLifecycleConfigurationError, Self> {
