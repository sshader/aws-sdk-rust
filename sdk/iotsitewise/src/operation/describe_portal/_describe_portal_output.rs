...
impl  DescribePortalOutput  {
    ...
    pub fn portal_name(&self) -> & str {
        use std::ops::Deref; self.portal_name.deref()
    }
    /// <p>The portal's description.</p>
    ...
    pub fn portal_client_id(&self) -> & str {
        use std::ops::Deref; self.portal_client_id.deref()
    }
    /// <p>The URL for the IoT SiteWise Monitor portal. You can use this URL to access portals that use IAM Identity Center for authentication. For portals that use IAM for authentication, you must use the IoT SiteWise console to get a URL that you can use to access the portal.</p>
    ...
    pub fn portal_contact_email(&self) -> & str {
        use std::ops::Deref; self.portal_contact_email.deref()
    }
    /// <p>The current status of the portal, which contains a state and any error message.</p>
...
impl DescribePortalOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_portal::DescribePortalOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::describe_portal::DescribePortalOutput {
                portal_id: self.portal_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("portal_id", "portal_id was not specified but it is required when building DescribePortalOutput")
                    )?
                ,
                portal_arn: self.portal_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("portal_arn", "portal_arn was not specified but it is required when building DescribePortalOutput")
                    )?
                ,
                portal_name: self.portal_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("portal_name", "portal_name was not specified but it is required when building DescribePortalOutput")
                    )?
                ,
                ...
                portal_client_id: self.portal_client_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("portal_client_id", "portal_client_id was not specified but it is required when building DescribePortalOutput")
                    )?
                ,
                portal_start_url: self.portal_start_url
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("portal_start_url", "portal_start_url was not specified but it is required when building DescribePortalOutput")
                    )?
                ,
                portal_contact_email: self.portal_contact_email
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("portal_contact_email", "portal_contact_email was not specified but it is required when building DescribePortalOutput")
                    )?
                ,
                ...
                portal_creation_date: self.portal_creation_date
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("portal_creation_date", "portal_creation_date was not specified but it is required when building DescribePortalOutput")
                    )?
                ,
                portal_last_update_date: self.portal_last_update_date
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("portal_last_update_date", "portal_last_update_date was not specified but it is required when building DescribePortalOutput")
                    )?
                ,
