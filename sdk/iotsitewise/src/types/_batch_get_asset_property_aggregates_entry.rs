...
impl  BatchGetAssetPropertyAggregatesEntry  {
    ...
    pub fn aggregate_types(&self) -> & [crate::types::AggregateType] {
        use std::ops::Deref; self.aggregate_types.deref()
    }
    /// <p>The time interval over which to aggregate data.</p>
    pub fn resolution(&self) -> & str {
        use std::ops::Deref; self.resolution.deref()
    }
    /// <p>The exclusive start of the range from which to query historical data, expressed in seconds in Unix epoch time.</p>
...
impl BatchGetAssetPropertyAggregatesEntryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::BatchGetAssetPropertyAggregatesEntry, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::BatchGetAssetPropertyAggregatesEntry {
                entry_id: self.entry_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("entry_id", "entry_id was not specified but it is required when building BatchGetAssetPropertyAggregatesEntry")
                    )?
                ,
                ...
                aggregate_types: self.aggregate_types
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("aggregate_types", "aggregate_types was not specified but it is required when building BatchGetAssetPropertyAggregatesEntry")
                    )?
                ,
                resolution: self.resolution
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("resolution", "resolution was not specified but it is required when building BatchGetAssetPropertyAggregatesEntry")
                    )?
                ,
                start_date: self.start_date
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("start_date", "start_date was not specified but it is required when building BatchGetAssetPropertyAggregatesEntry")
                    )?
                ,
                end_date: self.end_date
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("end_date", "end_date was not specified but it is required when building BatchGetAssetPropertyAggregatesEntry")
                    )?
                ,
