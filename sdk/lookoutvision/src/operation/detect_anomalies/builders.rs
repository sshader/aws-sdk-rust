...
impl DetectAnomaliesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::detect_anomalies::DetectAnomaliesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detect_anomalies::DetectAnomaliesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::detect_anomalies::DetectAnomaliesOutput, crate::operation::detect_anomalies::DetectAnomaliesError, Self> {
