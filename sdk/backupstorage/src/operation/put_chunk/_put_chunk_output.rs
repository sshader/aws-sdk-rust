...
impl  PutChunkOutput  {
    ...
    pub fn chunk_checksum(&self) -> & str {
        use std::ops::Deref; self.chunk_checksum.deref()
    }
    /// Checksum algorithm
        ...
        ::std::result::Result::Ok(
            crate::operation::put_chunk::PutChunkOutput {
                chunk_checksum: self.chunk_checksum
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("chunk_checksum", "chunk_checksum was not specified but it is required when building PutChunkOutput")
                    )?
                ,
                chunk_checksum_algorithm: self.chunk_checksum_algorithm
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("chunk_checksum_algorithm", "chunk_checksum_algorithm was not specified but it is required when building PutChunkOutput")
                    )?
                ,
