...
impl  ListObjectsOutput  {
    ...
    pub fn object_list(&self) -> & [crate::types::BackupObject] {
        use std::ops::Deref; self.object_list.deref()
    }
    /// Pagination token
        ...
        ::std::result::Result::Ok(
            crate::operation::list_objects::ListObjectsOutput {
                object_list: self.object_list
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("object_list", "object_list was not specified but it is required when building ListObjectsOutput")
                    )?
                ,
