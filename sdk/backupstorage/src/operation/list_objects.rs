...
fn uri_query(_input: &crate::operation::list_objects::ListObjectsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_6) = &_input.created_before {
         {
            query.push_kv("created-before", &::aws_smithy_http::query::fmt_timestamp(inner_6, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
    if let ::std::option::Option::Some(inner_7) = &_input.created_after {
         {
            query.push_kv("created-after", &::aws_smithy_http::query::fmt_timestamp(inner_7, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
    ::std::result::Result::Ok(())
}
