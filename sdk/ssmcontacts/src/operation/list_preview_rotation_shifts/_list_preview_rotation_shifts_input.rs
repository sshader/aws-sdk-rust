...
impl ListPreviewRotationShiftsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_preview_rotation_shifts::ListPreviewRotationShiftsInput, ::aws_smithy_types::error::operation::BuildError> {
