...
impl CreateApplicationInstanceOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_application_instance::CreateApplicationInstanceOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_application_instance::CreateApplicationInstanceOutput {
                application_instance_id: self.application_instance_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("application_instance_id", "application_instance_id was not specified but it is required when building CreateApplicationInstanceOutput")
                    )?
                ,
