...
pub(crate) fn de_end_session_result<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::EndSessionResult>, ::aws_smithy_json::deserialize::error::DeserializeError>
