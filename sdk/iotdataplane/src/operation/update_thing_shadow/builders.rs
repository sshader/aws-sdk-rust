...
impl UpdateThingShadowFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_thing_shadow::UpdateThingShadowOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_thing_shadow::UpdateThingShadowError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_thing_shadow::UpdateThingShadowOutput, crate::operation::update_thing_shadow::UpdateThingShadowError, Self> {
