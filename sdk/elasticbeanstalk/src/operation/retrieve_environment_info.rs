...
impl RetrieveEnvironmentInfo {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RetrieveEnvironmentInfo {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RetrieveEnvironmentInfo");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RetrieveEnvironmentInfoRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RetrieveEnvironmentInfoResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RetrieveEnvironmentInfo")
                            .with_interceptor(RetrieveEnvironmentInfoEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RetrieveEnvironmentInfoResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_retrieve_environment_info::de_retrieve_environment_info_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RetrieveEnvironmentInfoRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_retrieve_environment_info_input::ser_retrieve_environment_info_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RetrieveEnvironmentInfoEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RetrieveEnvironmentInfoEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RetrieveEnvironmentInfoEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RetrieveEnvironmentInfoInput>()
                        .ok_or("failed to downcast to RetrieveEnvironmentInfoInput")?;
...
pub enum RetrieveEnvironmentInfoError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RetrieveEnvironmentInfoError) for what information is available for the error.")]
...
impl RetrieveEnvironmentInfoError {
    /// Creates the `RetrieveEnvironmentInfoError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RetrieveEnvironmentInfoError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RetrieveEnvironmentInfoError {
...
impl ::aws_types::request_id::RequestId for crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoError {
