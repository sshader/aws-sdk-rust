...
impl RequestEnvironmentInfoFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::request_environment_info::RequestEnvironmentInfoOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::request_environment_info::RequestEnvironmentInfoError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::request_environment_info::RequestEnvironmentInfoOutput, crate::operation::request_environment_info::RequestEnvironmentInfoError, Self> {
