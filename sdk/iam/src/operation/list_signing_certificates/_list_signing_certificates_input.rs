...
impl ListSigningCertificatesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_signing_certificates::ListSigningCertificatesInput, ::aws_smithy_types::error::operation::BuildError> {
