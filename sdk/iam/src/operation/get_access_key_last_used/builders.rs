...
impl GetAccessKeyLastUsedFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_access_key_last_used::GetAccessKeyLastUsedOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_access_key_last_used::GetAccessKeyLastUsedError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_access_key_last_used::GetAccessKeyLastUsedOutput, crate::operation::get_access_key_last_used::GetAccessKeyLastUsedError, Self> {
