...
impl UpdateAccessKeyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_access_key::UpdateAccessKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_access_key::UpdateAccessKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_access_key::UpdateAccessKeyOutput, crate::operation::update_access_key::UpdateAccessKeyError, Self> {
