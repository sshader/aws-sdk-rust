...
impl DeleteAccessKeyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_access_key::DeleteAccessKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_access_key::DeleteAccessKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_access_key::DeleteAccessKeyOutput, crate::operation::delete_access_key::DeleteAccessKeyError, Self> {
