...
impl SetSecurityTokenServicePreferencesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::set_security_token_service_preferences::SetSecurityTokenServicePreferencesInput, ::aws_smithy_types::error::operation::BuildError> {
