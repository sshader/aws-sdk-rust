...
impl ListServerCertificateTagsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_server_certificate_tags::ListServerCertificateTagsInput, ::aws_smithy_types::error::operation::BuildError> {
