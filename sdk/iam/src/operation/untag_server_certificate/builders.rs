...
impl UntagServerCertificateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::untag_server_certificate::UntagServerCertificateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::untag_server_certificate::UntagServerCertificateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::untag_server_certificate::UntagServerCertificateOutput, crate::operation::untag_server_certificate::UntagServerCertificateError, Self> {
