...
impl ListInstanceProfilesForRoleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleInput, ::aws_smithy_types::error::operation::BuildError> {
