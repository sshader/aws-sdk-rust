...
impl ListSAMLProvidersFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_saml_providers::ListSamlProvidersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_saml_providers::ListSAMLProvidersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_saml_providers::ListSamlProvidersOutput, crate::operation::list_saml_providers::ListSAMLProvidersError, Self> {
