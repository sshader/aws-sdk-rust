...
pub(crate) fn de_ca_certificate_description<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CaCertificateDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    ...
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "autoRegistrationStatus" => {
                                builder = builder.set_auto_registration_status(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
