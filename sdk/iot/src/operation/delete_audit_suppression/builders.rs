...
impl DeleteAuditSuppressionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_audit_suppression::DeleteAuditSuppressionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_audit_suppression::DeleteAuditSuppressionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_audit_suppression::DeleteAuditSuppressionOutput, crate::operation::delete_audit_suppression::DeleteAuditSuppressionError, Self> {
