...
impl AssociateTargetsWithJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_targets_with_job::AssociateTargetsWithJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_targets_with_job::AssociateTargetsWithJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_targets_with_job::AssociateTargetsWithJobOutput, crate::operation::associate_targets_with_job::AssociateTargetsWithJobError, Self> {
