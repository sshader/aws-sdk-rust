...
impl AddThingToBillingGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::add_thing_to_billing_group::AddThingToBillingGroupInput, ::aws_smithy_types::error::operation::BuildError> {
