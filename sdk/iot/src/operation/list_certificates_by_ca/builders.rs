...
impl ListCertificatesByCAFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_certificates_by_ca::ListCertificatesByCaOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_certificates_by_ca::ListCertificatesByCAError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_certificates_by_ca::ListCertificatesByCaOutput, crate::operation::list_certificates_by_ca::ListCertificatesByCAError, Self> {
