...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileOutput,
                    crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileError,
                > for ListTargetsForSecurityProfileFluentBuilder
            {
                fn send(
                    self,
...
impl ListTargetsForSecurityProfileFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfile::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileOutput, crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_targets_for_security_profile::paginator::ListTargetsForSecurityProfilePaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
