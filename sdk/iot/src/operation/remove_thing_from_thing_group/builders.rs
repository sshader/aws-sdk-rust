...
impl RemoveThingFromThingGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupOutput, crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupError, Self> {
