...
impl UpdateDynamicThingGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_dynamic_thing_group::UpdateDynamicThingGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_dynamic_thing_group::UpdateDynamicThingGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_dynamic_thing_group::UpdateDynamicThingGroupOutput, crate::operation::update_dynamic_thing_group::UpdateDynamicThingGroupError, Self> {
