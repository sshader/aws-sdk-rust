...
impl  AuditSuppression  {
    ...
    pub fn check_name(&self) -> & str {
        use std::ops::Deref; self.check_name.deref()
    }
    /// <p>Information that identifies the noncompliant resource.</p>
        ...
        ::std::result::Result::Ok(
            crate::types::AuditSuppression {
                check_name: self.check_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("check_name", "check_name was not specified but it is required when building AuditSuppression")
                    )?
                ,
