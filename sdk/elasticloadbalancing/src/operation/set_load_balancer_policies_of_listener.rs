...
impl SetLoadBalancerPoliciesOfListener {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetLoadBalancerPoliciesOfListener {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetLoadBalancerPoliciesOfListener");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetLoadBalancerPoliciesOfListenerRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetLoadBalancerPoliciesOfListenerResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetLoadBalancerPoliciesOfListener")
                            .with_interceptor(SetLoadBalancerPoliciesOfListenerEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetLoadBalancerPoliciesOfListenerResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_set_load_balancer_policies_of_listener::de_set_load_balancer_policies_of_listener_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetLoadBalancerPoliciesOfListenerRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_load_balancer_policies_of_listener_input::ser_set_load_balancer_policies_of_listener_input_input_input(&input)?);
...
#[derive(Debug)]
            struct SetLoadBalancerPoliciesOfListenerEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetLoadBalancerPoliciesOfListenerEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetLoadBalancerPoliciesOfListenerEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetLoadBalancerPoliciesOfListenerInput>()
                        .ok_or("failed to downcast to SetLoadBalancerPoliciesOfListenerInput")?;
...
pub enum SetLoadBalancerPoliciesOfListenerError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetLoadBalancerPoliciesOfListenerError) for what information is available for the error.")]
...
impl SetLoadBalancerPoliciesOfListenerError {
    /// Creates the `SetLoadBalancerPoliciesOfListenerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetLoadBalancerPoliciesOfListenerError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetLoadBalancerPoliciesOfListenerError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerError {
