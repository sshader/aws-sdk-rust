...
impl DeleteAutomaticTapeCreationPolicy {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteAutomaticTapeCreationPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteAutomaticTapeCreationPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteAutomaticTapeCreationPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteAutomaticTapeCreationPolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteAutomaticTapeCreationPolicy")
                            .with_interceptor(DeleteAutomaticTapeCreationPolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DeleteAutomaticTapeCreationPolicyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteAutomaticTapeCreationPolicyResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteAutomaticTapeCreationPolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAutomaticTapeCreationPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_automatic_tape_creation_policy::ser_delete_automatic_tape_creation_policy_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteAutomaticTapeCreationPolicyEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteAutomaticTapeCreationPolicyInput>()
                        .ok_or("failed to downcast to DeleteAutomaticTapeCreationPolicyInput")?;
...
pub enum DeleteAutomaticTapeCreationPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteAutomaticTapeCreationPolicyError) for what information is available for the error.")]
...
impl DeleteAutomaticTapeCreationPolicyError {
    /// Creates the `DeleteAutomaticTapeCreationPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteAutomaticTapeCreationPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteAutomaticTapeCreationPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyError {
