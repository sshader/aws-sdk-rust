...
impl SetLocalConsolePassword {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::set_local_console_password::SetLocalConsolePasswordOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_local_console_password::SetLocalConsolePasswordError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_local_console_password::SetLocalConsolePasswordError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_local_console_password::SetLocalConsolePasswordOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetLocalConsolePassword {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetLocalConsolePassword");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetLocalConsolePasswordRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetLocalConsolePasswordResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetLocalConsolePassword")
                            .with_interceptor(SetLocalConsolePasswordEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_local_console_password::SetLocalConsolePasswordError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_local_console_password::SetLocalConsolePasswordError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_local_console_password::SetLocalConsolePasswordError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct SetLocalConsolePasswordResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetLocalConsolePasswordResponseDeserializer {
...
#[derive(Debug)]
            struct SetLocalConsolePasswordRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetLocalConsolePasswordRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_local_console_password::SetLocalConsolePasswordInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_local_console_password::SetLocalConsolePasswordInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_local_console_password::ser_set_local_console_password_input(&input)?);
...
#[derive(Debug)]
            struct SetLocalConsolePasswordEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetLocalConsolePasswordEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetLocalConsolePasswordEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetLocalConsolePasswordInput>()
                        .ok_or("failed to downcast to SetLocalConsolePasswordInput")?;
...
pub enum SetLocalConsolePasswordError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetLocalConsolePasswordError) for what information is available for the error.")]
...
impl SetLocalConsolePasswordError {
    /// Creates the `SetLocalConsolePasswordError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetLocalConsolePasswordError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetLocalConsolePasswordError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_local_console_password::SetLocalConsolePasswordError {
