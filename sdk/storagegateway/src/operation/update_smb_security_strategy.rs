...
impl UpdateSMBSecurityStrategy {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_smb_security_strategy::UpdateSmbSecurityStrategyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_smb_security_strategy::UpdateSMBSecurityStrategyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_smb_security_strategy::UpdateSMBSecurityStrategyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_smb_security_strategy::UpdateSmbSecurityStrategyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateSMBSecurityStrategy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateSMBSecurityStrategy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateSMBSecurityStrategyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateSMBSecurityStrategyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateSMBSecurityStrategy")
                            .with_interceptor(UpdateSMBSecurityStrategyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_smb_security_strategy::UpdateSMBSecurityStrategyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_smb_security_strategy::UpdateSMBSecurityStrategyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_smb_security_strategy::UpdateSMBSecurityStrategyError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct UpdateSMBSecurityStrategyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateSMBSecurityStrategyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_update_smb_security_strategy::de_update_smb_security_strategy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateSMBSecurityStrategyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateSMBSecurityStrategyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_smb_security_strategy::UpdateSmbSecurityStrategyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_smb_security_strategy::UpdateSmbSecurityStrategyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_smb_security_strategy::ser_update_smb_security_strategy_input(&input)?);
...
#[derive(Debug)]
            struct UpdateSMBSecurityStrategyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateSMBSecurityStrategyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateSMBSecurityStrategyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateSmbSecurityStrategyInput>()
                        .ok_or("failed to downcast to UpdateSmbSecurityStrategyInput")?;
...
pub enum UpdateSMBSecurityStrategyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateSMBSecurityStrategyError) for what information is available for the error.")]
...
impl UpdateSMBSecurityStrategyError {
    /// Creates the `UpdateSMBSecurityStrategyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateSMBSecurityStrategyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateSMBSecurityStrategyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_smb_security_strategy::UpdateSMBSecurityStrategyError {
