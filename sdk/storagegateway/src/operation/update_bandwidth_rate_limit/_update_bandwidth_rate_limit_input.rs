...
impl UpdateBandwidthRateLimitInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_bandwidth_rate_limit::UpdateBandwidthRateLimitInput, ::aws_smithy_types::error::operation::BuildError> {
