...
impl UpdateChapCredentialsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_chap_credentials::UpdateChapCredentialsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_chap_credentials::UpdateChapCredentialsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_chap_credentials::UpdateChapCredentialsOutput, crate::operation::update_chap_credentials::UpdateChapCredentialsError, Self> {
