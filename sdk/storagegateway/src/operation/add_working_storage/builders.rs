...
impl AddWorkingStorageFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::add_working_storage::AddWorkingStorageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_working_storage::AddWorkingStorageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::add_working_storage::AddWorkingStorageOutput, crate::operation::add_working_storage::AddWorkingStorageError, Self> {
