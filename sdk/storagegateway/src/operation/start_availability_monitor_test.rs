...
impl StartAvailabilityMonitorTest {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartAvailabilityMonitorTest {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartAvailabilityMonitorTest");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartAvailabilityMonitorTestRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartAvailabilityMonitorTestResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartAvailabilityMonitorTest")
                            .with_interceptor(StartAvailabilityMonitorTestEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct StartAvailabilityMonitorTestResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartAvailabilityMonitorTestResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_start_availability_monitor_test::de_start_availability_monitor_test_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartAvailabilityMonitorTestRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartAvailabilityMonitorTestRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_availability_monitor_test::ser_start_availability_monitor_test_input(&input)?);
...
#[derive(Debug)]
            struct StartAvailabilityMonitorTestEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartAvailabilityMonitorTestEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartAvailabilityMonitorTestEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartAvailabilityMonitorTestInput>()
                        .ok_or("failed to downcast to StartAvailabilityMonitorTestInput")?;
...
pub enum StartAvailabilityMonitorTestError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartAvailabilityMonitorTestError) for what information is available for the error.")]
...
impl StartAvailabilityMonitorTestError {
    /// Creates the `StartAvailabilityMonitorTestError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartAvailabilityMonitorTestError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartAvailabilityMonitorTestError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestError {
