...
impl NotifyWhenUploaded {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::notify_when_uploaded::NotifyWhenUploadedOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::notify_when_uploaded::NotifyWhenUploadedError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::notify_when_uploaded::NotifyWhenUploadedError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::notify_when_uploaded::NotifyWhenUploadedOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for NotifyWhenUploaded {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("NotifyWhenUploaded");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(NotifyWhenUploadedRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(NotifyWhenUploadedResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("NotifyWhenUploaded")
                            .with_interceptor(NotifyWhenUploadedEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::notify_when_uploaded::NotifyWhenUploadedError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::notify_when_uploaded::NotifyWhenUploadedError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::notify_when_uploaded::NotifyWhenUploadedError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct NotifyWhenUploadedResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for NotifyWhenUploadedResponseDeserializer {
...
#[derive(Debug)]
            struct NotifyWhenUploadedRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for NotifyWhenUploadedRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::notify_when_uploaded::NotifyWhenUploadedInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::notify_when_uploaded::NotifyWhenUploadedInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_notify_when_uploaded::ser_notify_when_uploaded_input(&input)?);
...
#[derive(Debug)]
            struct NotifyWhenUploadedEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for NotifyWhenUploadedEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "NotifyWhenUploadedEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<NotifyWhenUploadedInput>()
                        .ok_or("failed to downcast to NotifyWhenUploadedInput")?;
...
pub enum NotifyWhenUploadedError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-NotifyWhenUploadedError) for what information is available for the error.")]
...
impl NotifyWhenUploadedError {
    /// Creates the `NotifyWhenUploadedError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `NotifyWhenUploadedError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for NotifyWhenUploadedError {
...
impl ::aws_types::request_id::RequestId for crate::operation::notify_when_uploaded::NotifyWhenUploadedError {
