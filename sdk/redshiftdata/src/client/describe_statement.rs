...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::describe_statement::builders::DescribeStatementFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::describe_statement::builders::DescribeStatementFluentBuilder::set_id):<br>required: **true**<br><p>The identifier of the SQL statement to describe. This value is a universally unique identifier (UUID) generated by Amazon Redshift Data API. A suffix indicates the number of the SQL statement. For example, <code>d9b6c0c9-0747-4bf4-b142-e8883122f766:2</code> has a suffix of <code>:2</code> that indicates the second SQL statement of a batch query. This identifier is returned by <code>BatchExecuteStatment</code>, <code>ExecuteStatement</code>, and <code>ListStatements</code>. </p><br>
                            /// - On success, responds with [`DescribeStatementOutput`](crate::operation::describe_statement::DescribeStatementOutput) with field(s):
    ///   - [`id(String)`](crate::operation::describe_statement::DescribeStatementOutput::id): <p>The identifier of the SQL statement described. This value is a universally unique identifier (UUID) generated by Amazon Redshift Data API. </p>
