...
impl StartBgpFailoverTestFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_bgp_failover_test::StartBgpFailoverTestOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_bgp_failover_test::StartBgpFailoverTestError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_bgp_failover_test::StartBgpFailoverTestOutput, crate::operation::start_bgp_failover_test::StartBgpFailoverTestError, Self> {
