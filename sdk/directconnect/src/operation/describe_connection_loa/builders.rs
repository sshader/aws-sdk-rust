...
impl DescribeConnectionLoaFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_connection_loa::DescribeConnectionLoaOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_connection_loa::DescribeConnectionLoaError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_connection_loa::DescribeConnectionLoaOutput, crate::operation::describe_connection_loa::DescribeConnectionLoaError, Self> {
