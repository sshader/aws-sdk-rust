...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_virtual_interface_test_history::ListVirtualInterfaceTestHistoryOutput,
                    crate::operation::list_virtual_interface_test_history::ListVirtualInterfaceTestHistoryError,
                > for ListVirtualInterfaceTestHistoryFluentBuilder
            {
                fn send(
                    self,
...
impl ListVirtualInterfaceTestHistoryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_virtual_interface_test_history::ListVirtualInterfaceTestHistoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_virtual_interface_test_history::ListVirtualInterfaceTestHistoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_virtual_interface_test_history::ListVirtualInterfaceTestHistory::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_virtual_interface_test_history::ListVirtualInterfaceTestHistory::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_virtual_interface_test_history::ListVirtualInterfaceTestHistoryOutput, crate::operation::list_virtual_interface_test_history::ListVirtualInterfaceTestHistoryError, Self> {
