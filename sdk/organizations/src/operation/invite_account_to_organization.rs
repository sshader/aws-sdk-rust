...
impl InviteAccountToOrganization {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::invite_account_to_organization::InviteAccountToOrganizationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::invite_account_to_organization::InviteAccountToOrganizationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::invite_account_to_organization::InviteAccountToOrganizationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::invite_account_to_organization::InviteAccountToOrganizationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for InviteAccountToOrganization {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("InviteAccountToOrganization");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(InviteAccountToOrganizationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(InviteAccountToOrganizationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("InviteAccountToOrganization")
                            .with_interceptor(InviteAccountToOrganizationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::invite_account_to_organization::InviteAccountToOrganizationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::invite_account_to_organization::InviteAccountToOrganizationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::invite_account_to_organization::InviteAccountToOrganizationError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct InviteAccountToOrganizationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for InviteAccountToOrganizationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_invite_account_to_organization::de_invite_account_to_organization_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct InviteAccountToOrganizationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for InviteAccountToOrganizationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::invite_account_to_organization::InviteAccountToOrganizationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::invite_account_to_organization::InviteAccountToOrganizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_invite_account_to_organization::ser_invite_account_to_organization_input(&input)?);
...
#[derive(Debug)]
            struct InviteAccountToOrganizationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for InviteAccountToOrganizationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "InviteAccountToOrganizationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<InviteAccountToOrganizationInput>()
                        .ok_or("failed to downcast to InviteAccountToOrganizationInput")?;
...
pub enum InviteAccountToOrganizationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-InviteAccountToOrganizationError) for what information is available for the error.")]
...
impl InviteAccountToOrganizationError {
    /// Creates the `InviteAccountToOrganizationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `InviteAccountToOrganizationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::AccountOwnerNotVerifiedException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for InviteAccountToOrganizationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::invite_account_to_organization::InviteAccountToOrganizationError {
