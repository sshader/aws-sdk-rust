...
impl GetBotsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_bots::GetBotsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_bots::GetBotsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
