...
pub fn ser_checkpoint_configuration(
    ...
    if let Some(var_2) = &input.checkpoint_interval {
        object.key("CheckpointInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
    if let Some(var_3) = &input.min_pause_between_checkpoints {
        object.key("MinPauseBetweenCheckpoints").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
    Ok(())
}
