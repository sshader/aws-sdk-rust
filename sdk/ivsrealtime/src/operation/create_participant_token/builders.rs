...
impl CreateParticipantTokenFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_participant_token::CreateParticipantTokenOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_participant_token::CreateParticipantTokenError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_participant_token::CreateParticipantTokenOutput, crate::operation::create_participant_token::CreateParticipantTokenError, Self> {
