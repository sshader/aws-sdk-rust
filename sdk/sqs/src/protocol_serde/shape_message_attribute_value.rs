...
pub(crate) fn de_message_attribute_value<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MessageAttributeValue>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "BinaryListValues" => {
                                builder = builder.set_binary_list_values(
                                    crate::protocol_serde::shape_binary_list::de_binary_list(tokens)?
                                );
                            }
                            "DataType" => {
            ...
            Ok(Some(crate::serde_util::message_attribute_value_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
