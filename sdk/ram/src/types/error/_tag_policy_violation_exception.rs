        ...
        ::std::result::Result::Ok(
            crate::types::error::TagPolicyViolationException {
                message: self.message
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("message", "message was not specified but it is required when building TagPolicyViolationException")
                    )?
                ,
