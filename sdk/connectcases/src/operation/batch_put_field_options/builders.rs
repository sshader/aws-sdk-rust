...
impl BatchPutFieldOptionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_put_field_options::BatchPutFieldOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_put_field_options::BatchPutFieldOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_put_field_options::BatchPutFieldOptionsOutput, crate::operation::batch_put_field_options::BatchPutFieldOptionsError, Self> {
