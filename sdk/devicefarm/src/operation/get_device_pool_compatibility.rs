...
impl GetDevicePoolCompatibility {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_device_pool_compatibility::GetDevicePoolCompatibilityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_device_pool_compatibility::GetDevicePoolCompatibilityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_device_pool_compatibility::GetDevicePoolCompatibilityError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_device_pool_compatibility::GetDevicePoolCompatibilityOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDevicePoolCompatibility {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDevicePoolCompatibility");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDevicePoolCompatibilityRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDevicePoolCompatibilityResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDevicePoolCompatibility")
                            .with_interceptor(GetDevicePoolCompatibilityEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_device_pool_compatibility::GetDevicePoolCompatibilityError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_device_pool_compatibility::GetDevicePoolCompatibilityError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_device_pool_compatibility::GetDevicePoolCompatibilityError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetDevicePoolCompatibilityResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDevicePoolCompatibilityResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_device_pool_compatibility::de_get_device_pool_compatibility_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetDevicePoolCompatibilityRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDevicePoolCompatibilityRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_device_pool_compatibility::GetDevicePoolCompatibilityInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_device_pool_compatibility::GetDevicePoolCompatibilityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_device_pool_compatibility::ser_get_device_pool_compatibility_input(&input)?);
...
#[derive(Debug)]
            struct GetDevicePoolCompatibilityEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDevicePoolCompatibilityEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDevicePoolCompatibilityEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDevicePoolCompatibilityInput>()
                        .ok_or("failed to downcast to GetDevicePoolCompatibilityInput")?;
...
pub enum GetDevicePoolCompatibilityError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDevicePoolCompatibilityError) for what information is available for the error.")]
...
impl GetDevicePoolCompatibilityError {
    /// Creates the `GetDevicePoolCompatibilityError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDevicePoolCompatibilityError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDevicePoolCompatibilityError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_device_pool_compatibility::GetDevicePoolCompatibilityError {
