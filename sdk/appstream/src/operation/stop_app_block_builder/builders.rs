...
impl StopAppBlockBuilderFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_app_block_builder::StopAppBlockBuilderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_app_block_builder::StopAppBlockBuilderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_app_block_builder::StopAppBlockBuilderOutput, crate::operation::stop_app_block_builder::StopAppBlockBuilderError, Self> {
