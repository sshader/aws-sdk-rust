...
impl ListStreamingSessionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_streaming_sessions::ListStreamingSessionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_streaming_sessions::ListStreamingSessionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_streaming_sessions::ListStreamingSessionsOutput, crate::operation::list_streaming_sessions::ListStreamingSessionsError, Self> {
