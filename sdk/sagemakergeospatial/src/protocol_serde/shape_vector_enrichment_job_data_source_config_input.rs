...
pub fn ser_vector_enrichment_job_data_source_config_input(object_2: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::VectorEnrichmentJobDataSourceConfigInput) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::VectorEnrichmentJobDataSourceConfigInput::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("VectorEnrichmentJobDataSourceConfigInput"))
    }
    Ok(())
}
