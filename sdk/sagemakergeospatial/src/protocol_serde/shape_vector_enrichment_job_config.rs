...
pub fn ser_vector_enrichment_job_config(object_6: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::VectorEnrichmentJobConfig) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::VectorEnrichmentJobConfig::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("VectorEnrichmentJobConfig"))
    }
    Ok(())
}
