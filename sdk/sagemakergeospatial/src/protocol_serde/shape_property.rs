...
pub fn ser_property(object_2: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::Property) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
