...
impl AssociateTrackerConsumerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_tracker_consumer::AssociateTrackerConsumerInput, ::aws_smithy_types::error::operation::BuildError> {
