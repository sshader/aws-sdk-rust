...
impl GetDevicePositionHistoryOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_device_position_history::GetDevicePositionHistoryOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_device_position_history::GetDevicePositionHistoryOutput {
                device_positions: self.device_positions
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("device_positions", "device_positions was not specified but it is required when building GetDevicePositionHistoryOutput")
                    )?
                ,
