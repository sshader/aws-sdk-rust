    ...
    pub fn build(self) -> ::std::result::Result<crate::types::AccessPoint, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::AccessPoint {
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building AccessPoint")
                    )?
                ,
                network_origin: self.network_origin
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("network_origin", "network_origin was not specified but it is required when building AccessPoint")
                    )?
                ,
                ...
                bucket: self.bucket
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("bucket", "bucket was not specified but it is required when building AccessPoint")
                    )?
                ,
