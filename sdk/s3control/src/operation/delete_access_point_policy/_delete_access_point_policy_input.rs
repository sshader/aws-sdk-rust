...
impl DeleteAccessPointPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_access_point_policy::DeleteAccessPointPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
