...
impl DeleteJobTaggingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_job_tagging::DeleteJobTaggingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_job_tagging::DeleteJobTaggingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_job_tagging::DeleteJobTaggingOutput, crate::operation::delete_job_tagging::DeleteJobTaggingError, Self> {
