...
impl DetectEntitiesV2OutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::detect_entities_v2::DetectEntitiesV2Output, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::detect_entities_v2::DetectEntitiesV2Output {
                entities: self.entities
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("entities", "entities was not specified but it is required when building DetectEntitiesV2Output")
                    )?
                ,
                ...
                model_version: self.model_version
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("model_version", "model_version was not specified but it is required when building DetectEntitiesV2Output")
                    )?
                ,
