...
impl DescribeDashboardDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_dashboard_definition::DescribeDashboardDefinitionInput, ::aws_smithy_types::error::operation::BuildError> {
