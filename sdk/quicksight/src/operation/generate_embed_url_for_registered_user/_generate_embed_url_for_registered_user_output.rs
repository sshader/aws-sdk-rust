...
impl GenerateEmbedUrlForRegisteredUserOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserOutput {
                embed_url: self.embed_url
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("embed_url", "embed_url was not specified but it is required when building GenerateEmbedUrlForRegisteredUserOutput")
                    )?
                ,
                status: self.status
                    .unwrap_or_default()
                ...
                request_id: self.request_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("request_id", "request_id was not specified but it is required when building GenerateEmbedUrlForRegisteredUserOutput")
                    )?
                ,
