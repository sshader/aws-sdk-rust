...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::update_folder_permissions::UpdateFolderPermissionsOutput,
                    crate::operation::update_folder_permissions::UpdateFolderPermissionsError,
                > for UpdateFolderPermissionsFluentBuilder
            {
                fn send(
                    self,
...
impl UpdateFolderPermissionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_folder_permissions::UpdateFolderPermissionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_folder_permissions::UpdateFolderPermissionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::update_folder_permissions::UpdateFolderPermissions::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::update_folder_permissions::UpdateFolderPermissions::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_folder_permissions::UpdateFolderPermissionsOutput, crate::operation::update_folder_permissions::UpdateFolderPermissionsError, Self> {
