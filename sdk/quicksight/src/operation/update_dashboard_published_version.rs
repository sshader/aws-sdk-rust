...
impl UpdateDashboardPublishedVersion {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_dashboard_published_version::UpdateDashboardPublishedVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_dashboard_published_version::UpdateDashboardPublishedVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_dashboard_published_version::UpdateDashboardPublishedVersionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_dashboard_published_version::UpdateDashboardPublishedVersionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateDashboardPublishedVersion {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateDashboardPublishedVersion");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateDashboardPublishedVersionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateDashboardPublishedVersionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateDashboardPublishedVersion")
                            .with_interceptor(UpdateDashboardPublishedVersionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_dashboard_published_version::UpdateDashboardPublishedVersionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_dashboard_published_version::UpdateDashboardPublishedVersionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_dashboard_published_version::UpdateDashboardPublishedVersionError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct UpdateDashboardPublishedVersionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateDashboardPublishedVersionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_update_dashboard_published_version::de_update_dashboard_published_version_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateDashboardPublishedVersionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateDashboardPublishedVersionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_dashboard_published_version::UpdateDashboardPublishedVersionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_dashboard_published_version::UpdateDashboardPublishedVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct UpdateDashboardPublishedVersionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateDashboardPublishedVersionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateDashboardPublishedVersionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateDashboardPublishedVersionInput>()
                        .ok_or("failed to downcast to UpdateDashboardPublishedVersionInput")?;
...
pub enum UpdateDashboardPublishedVersionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateDashboardPublishedVersionError) for what information is available for the error.")]
...
impl UpdateDashboardPublishedVersionError {
    /// Creates the `UpdateDashboardPublishedVersionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateDashboardPublishedVersionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateDashboardPublishedVersionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_dashboard_published_version::UpdateDashboardPublishedVersionError {
