...
impl DeleteIamPolicyAssignmentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_iam_policy_assignment::DeleteIamPolicyAssignmentInput, ::aws_smithy_types::error::operation::BuildError> {
