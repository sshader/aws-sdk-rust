...
pub fn ser_gauge_chart_visual(
    ...
    if let Some(var_5) = &input.chart_configuration {
        ...
        crate::protocol_serde::shape_gauge_chart_configuration::ser_gauge_chart_configuration(&mut object_6, var_5)?;
        object_6.finish();
    }
    if let Some(var_7) = &input.conditional_formatting {
        #[allow(unused_mut)]
        let mut object_8 = object.key("ConditionalFormatting").start_object();
        crate::protocol_serde::shape_gauge_chart_conditional_formatting::ser_gauge_chart_conditional_formatting(&mut object_8, var_7)?;
        object_8.finish();
    }
...
pub(crate) fn de_gauge_chart_visual<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::GaugeChartVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::gauge_chart_visual_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
