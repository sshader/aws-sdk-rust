...
pub fn ser_sankey_diagram_visual(
    ...
    if let Some(var_5) = &input.chart_configuration {
        ...
        crate::protocol_serde::shape_sankey_diagram_chart_configuration::ser_sankey_diagram_chart_configuration(&mut object_6, var_5)?;
        object_6.finish();
    }
...
pub(crate) fn de_sankey_diagram_visual<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SankeyDiagramVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::sankey_diagram_visual_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
