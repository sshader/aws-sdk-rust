...
pub fn ser_kpi_visual(
    ...
    if let Some(var_5) = &input.chart_configuration {
        ...
        crate::protocol_serde::shape_kpi_configuration::ser_kpi_configuration(&mut object_6, var_5)?;
        object_6.finish();
    }
    if let Some(var_7) = &input.conditional_formatting {
        #[allow(unused_mut)]
        let mut object_8 = object.key("ConditionalFormatting").start_object();
        crate::protocol_serde::shape_kpi_conditional_formatting::ser_kpi_conditional_formatting(&mut object_8, var_7)?;
        object_8.finish();
    }
    ...
    if let Some(var_13) = &input.column_hierarchies {
        let mut array_14 = object.key("ColumnHierarchies").start_array();
        for item_15 in var_13 {
             {
                #[allow(unused_mut)]
                let mut object_16 = array_14.value().start_object();
                crate::protocol_serde::shape_column_hierarchy::ser_column_hierarchy(&mut object_16, item_15)?;
                object_16.finish();
            }
        }
        array_14.finish();
...
pub(crate) fn de_kpi_visual<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::KpiVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::kpi_visual_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
