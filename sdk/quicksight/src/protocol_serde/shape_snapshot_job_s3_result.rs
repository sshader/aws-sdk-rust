...
pub(crate) fn de_snapshot_job_s3_result<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SnapshotJobS3Result>, ::aws_smithy_json::deserialize::error::DeserializeError>
