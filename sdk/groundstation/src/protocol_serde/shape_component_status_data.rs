...
pub fn ser_component_status_data(
    ...
    if let Some(var_1) = &input.bytes_sent {
        object.key("bytesSent").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
    if let Some(var_2) = &input.bytes_received {
        object.key("bytesReceived").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
    if let Some(var_3) = &input.packets_dropped {
        object.key("packetsDropped").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
     {
