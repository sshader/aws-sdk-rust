...
impl InvokeScreenAutomationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::invoke_screen_automation::InvokeScreenAutomationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::invoke_screen_automation::InvokeScreenAutomationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::invoke_screen_automation::InvokeScreenAutomationOutput, crate::operation::invoke_screen_automation::InvokeScreenAutomationError, Self> {
