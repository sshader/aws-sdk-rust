...
/// Configuration for a aws_sdk_honeycode service client.
/// 
/// 
...
impl Builder {
    ...
    /// Sets the endpoint resolver to use when making requests.
                            ...
                            /// ```no_run
                            /// use aws_sdk_honeycode::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
                            /// #[derive(Debug)]
                            ...
                            /// let config = aws_sdk_honeycode::Config::builder().endpoint_resolver(resolver).build();
    ...
    /// Set the identity cache for auth.
                        ...
                        /// ```no_run
                        /// use aws_sdk_honeycode::config::IdentityCache;
                        ///
    ...
    /// Sets the [`behavior major version`](crate::config::BehaviorVersion).
                ...
                /// ```no_run
                /// use aws_sdk_honeycode::config::BehaviorVersion;
                ///
                /// let config = aws_sdk_honeycode::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("honeycode"));
                                layer.load::<::aws_types::region::Region>().cloned().map(|r| layer.store_put(::aws_types::region::SigningRegion::from(r)));
        Config {
            config: crate::config::Layer::from(layer.clone()).with_name("aws_sdk_honeycode::config::Config").freeze(),
                                    cloneable: layer,
                ...
                pub(crate) fn new(
                    ...
                    Self {
                        config: ::aws_smithy_types::config_bag::Layer::from(layer)
                            .with_name("aws_sdk_honeycode::config::ConfigOverrideRuntimePlugin").freeze(),
                        components,
                    }
                }
            }
                ...
                let mut plugins = ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins::new()
                    ...
                    .with_client_plugins(::aws_smithy_runtime::client::defaults::default_plugins(
                        ::aws_smithy_runtime::client::defaults::DefaultPluginParams::new()
                            .with_retry_partition_name("honeycode")
