...
impl StopStreamEncryptionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_stream_encryption::StopStreamEncryptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_stream_encryption::StopStreamEncryptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_stream_encryption::StopStreamEncryptionOutput, crate::operation::stop_stream_encryption::StopStreamEncryptionError, Self> {
