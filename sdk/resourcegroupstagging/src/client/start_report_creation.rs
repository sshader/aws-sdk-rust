...
impl super::Client {
    ...
    ///   - [`s3_bucket(impl Into<String>)`](crate::operation::start_report_creation::builders::StartReportCreationFluentBuilder::s3_bucket) / [`set_s3_bucket(Option<String>)`](crate::operation::start_report_creation::builders::StartReportCreationFluentBuilder::set_s3_bucket):<br>required: **true**<br><p>The name of the Amazon S3 bucket where the report will be stored; for example:</p>  <p> <code>awsexamplebucket</code> </p>  <p>For more information on S3 bucket requirements, including an example bucket policy, see the example S3 bucket policy on this page.</p><br>
