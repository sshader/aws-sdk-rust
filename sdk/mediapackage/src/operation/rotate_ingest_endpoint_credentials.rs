...
impl RotateIngestEndpointCredentials {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RotateIngestEndpointCredentials {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RotateIngestEndpointCredentials");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RotateIngestEndpointCredentialsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RotateIngestEndpointCredentialsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RotateIngestEndpointCredentials")
                            .with_interceptor(RotateIngestEndpointCredentialsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct RotateIngestEndpointCredentialsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RotateIngestEndpointCredentialsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_rotate_ingest_endpoint_credentials::de_rotate_ingest_endpoint_credentials_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RotateIngestEndpointCredentialsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RotateIngestEndpointCredentialsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("ingest_endpoint_id", "cannot be empty or unset"))?;
    ...
    if ingest_endpoint_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("ingest_endpoint_id", "cannot be empty or unset"))
                }
...
#[derive(Debug)]
            struct RotateIngestEndpointCredentialsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RotateIngestEndpointCredentialsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RotateIngestEndpointCredentialsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RotateIngestEndpointCredentialsInput>()
                        .ok_or("failed to downcast to RotateIngestEndpointCredentialsInput")?;
...
pub enum RotateIngestEndpointCredentialsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RotateIngestEndpointCredentialsError) for what information is available for the error.")]
...
impl RotateIngestEndpointCredentialsError {
    /// Creates the `RotateIngestEndpointCredentialsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RotateIngestEndpointCredentialsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RotateIngestEndpointCredentialsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsError {
