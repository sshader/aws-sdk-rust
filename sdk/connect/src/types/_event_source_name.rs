...
impl EventSourceName {
    ...
    EventSourceName::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["OnContactEvaluationSubmit", "OnMetricDataUpdate", "OnPostCallAnalysisAvailable", "OnPostChatAnalysisAvailable", "OnRealTimeCallAnalysisAvailable", "OnSalesforceCaseCreate", "OnZendeskTicketCreate", "OnZendeskTicketStatusUpdate"]
                }
            }
