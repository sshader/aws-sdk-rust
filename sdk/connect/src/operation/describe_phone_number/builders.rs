...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_phone_number::DescribePhoneNumberOutput,
                    crate::operation::describe_phone_number::DescribePhoneNumberError,
                > for DescribePhoneNumberFluentBuilder
            {
                fn send(
                    self,
...
impl DescribePhoneNumberFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_phone_number::DescribePhoneNumberOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_phone_number::DescribePhoneNumberError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_phone_number::DescribePhoneNumberOutput, crate::operation::describe_phone_number::DescribePhoneNumberError, Self> {
