...
impl ListDefaultVocabulariesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_default_vocabularies::ListDefaultVocabulariesInput, ::aws_smithy_types::error::operation::BuildError> {
