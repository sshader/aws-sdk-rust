...
impl UpdateContactFlowModuleContentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_contact_flow_module_content::UpdateContactFlowModuleContentInput, ::aws_smithy_types::error::operation::BuildError> {
