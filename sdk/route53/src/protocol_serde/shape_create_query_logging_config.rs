...
pub fn de_create_query_logging_config_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_query_logging_config::CreateQueryLoggingConfigOutput, crate::operation::create_query_logging_config::CreateQueryLoggingConfigError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_query_logging_config_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_query_logging_config::CreateQueryLoggingConfigOutput, crate::operation::create_query_logging_config::CreateQueryLoggingConfigError> {
    Ok({
        #[allow(unused_mut)]
        ...
        crate::serde_util::create_query_logging_config_output_output_correct_errors(output).build().map_err(crate::operation::create_query_logging_config::CreateQueryLoggingConfigError::unhandled)?
    })
}

pub fn ser_create_query_logging_config_op_input(input: &crate::operation::create_query_logging_config::CreateQueryLoggingConfigInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
     {
        ...
        crate::protocol_serde::shape_create_query_logging_config_input::ser_create_query_logging_config_input_input_input(input, root)?
    }
