...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_cidr_collections::builders::ListCidrCollectionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_cidr_collections::builders::ListCidrCollectionsFluentBuilder::set_next_token):<br>required: **false**<br><p>An opaque pagination token to indicate where the service is to begin enumerating results.</p>  <p>If no value is provided, the listing of results starts from the beginning.</p><br>
