...
impl super::Client {
    ...
    ///   - [`vpc(Vpc)`](crate::operation::disassociate_vpc_from_hosted_zone::builders::DisassociateVPCFromHostedZoneFluentBuilder::vpc) / [`set_vpc(Option<Vpc>)`](crate::operation::disassociate_vpc_from_hosted_zone::builders::DisassociateVPCFromHostedZoneFluentBuilder::set_vpc):<br>required: **true**<br><p>A complex type that contains information about the VPC that you're disassociating from the specified hosted zone.</p><br>
