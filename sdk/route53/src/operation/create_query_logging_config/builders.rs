...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::create_query_logging_config::CreateQueryLoggingConfigOutput,
                    crate::operation::create_query_logging_config::CreateQueryLoggingConfigError,
                > for CreateQueryLoggingConfigFluentBuilder
            {
                fn send(
                    self,
...
impl CreateQueryLoggingConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_query_logging_config::CreateQueryLoggingConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_query_logging_config::CreateQueryLoggingConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::create_query_logging_config::CreateQueryLoggingConfig::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::create_query_logging_config::CreateQueryLoggingConfig::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_query_logging_config::CreateQueryLoggingConfigOutput, crate::operation::create_query_logging_config::CreateQueryLoggingConfigError, Self> {
