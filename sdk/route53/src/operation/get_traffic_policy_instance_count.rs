...
impl GetTrafficPolicyInstanceCount {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_traffic_policy_instance_count::GetTrafficPolicyInstanceCountOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_traffic_policy_instance_count::GetTrafficPolicyInstanceCountError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_traffic_policy_instance_count::GetTrafficPolicyInstanceCountError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_traffic_policy_instance_count::GetTrafficPolicyInstanceCountOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTrafficPolicyInstanceCount {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetTrafficPolicyInstanceCount");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetTrafficPolicyInstanceCountRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetTrafficPolicyInstanceCountResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetTrafficPolicyInstanceCount")
                            .with_interceptor(GetTrafficPolicyInstanceCountEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_traffic_policy_instance_count::GetTrafficPolicyInstanceCountError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_traffic_policy_instance_count::GetTrafficPolicyInstanceCountError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_traffic_policy_instance_count::GetTrafficPolicyInstanceCountError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_traffic_policy_instance_count::de_get_traffic_policy_instance_count_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetTrafficPolicyInstanceCountRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetTrafficPolicyInstanceCountRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_traffic_policy_instance_count::GetTrafficPolicyInstanceCountInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_traffic_policy_instance_count::GetTrafficPolicyInstanceCountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetTrafficPolicyInstanceCountEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetTrafficPolicyInstanceCountEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetTrafficPolicyInstanceCountInput>()
                        .ok_or("failed to downcast to GetTrafficPolicyInstanceCountInput")?;
...
pub enum GetTrafficPolicyInstanceCountError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetTrafficPolicyInstanceCountError) for what information is available for the error.")]
...
impl GetTrafficPolicyInstanceCountError {
    /// Creates the `GetTrafficPolicyInstanceCountError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetTrafficPolicyInstanceCountError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetTrafficPolicyInstanceCountError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_traffic_policy_instance_count::GetTrafficPolicyInstanceCountError {
