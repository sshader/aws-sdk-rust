...
impl  ListResourceRecordSetsOutput  {
    ...
    pub fn resource_record_sets(&self) -> & [crate::types::ResourceRecordSet] {
        use std::ops::Deref; self.resource_record_sets.deref()
    }
    /// <p>A flag that indicates whether more resource record sets remain to be listed. If your results were truncated, you can make a follow-up pagination request by using the <code>NextRecordName</code> element.</p>
...
impl ListResourceRecordSetsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_resource_record_sets::ListResourceRecordSetsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_resource_record_sets::ListResourceRecordSetsOutput {
                resource_record_sets: self.resource_record_sets
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("resource_record_sets", "resource_record_sets was not specified but it is required when building ListResourceRecordSetsOutput")
                    )?
                ,
                ...
                max_items: self.max_items
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("max_items", "max_items was not specified but it is required when building ListResourceRecordSetsOutput")
                    )?
                ,
