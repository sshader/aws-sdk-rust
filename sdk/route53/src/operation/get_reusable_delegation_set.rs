...
impl GetReusableDelegationSet {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetReusableDelegationSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetReusableDelegationSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetReusableDelegationSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetReusableDelegationSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetReusableDelegationSet")
                            .with_interceptor(GetReusableDelegationSetEndpointParamsInterceptor)
.with_interceptor(crate::route53_resource_id_preprocessor::Route53ResourceIdInterceptor::new(|input: &mut crate::operation::get_reusable_delegation_set::GetReusableDelegationSetInput| {
                            &mut input.id
                        }))
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct GetReusableDelegationSetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetReusableDelegationSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_reusable_delegation_set::GetReusableDelegationSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetReusableDelegationSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetReusableDelegationSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetReusableDelegationSetInput>()
                        .ok_or("failed to downcast to GetReusableDelegationSetInput")?;
...
pub enum GetReusableDelegationSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetReusableDelegationSetError) for what information is available for the error.")]
...
impl GetReusableDelegationSetError {
    /// Creates the `GetReusableDelegationSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetReusableDelegationSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetReusableDelegationSetError {
