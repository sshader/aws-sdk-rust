...
impl ListVPCAssociationAuthorizations {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_vpc_association_authorizations::ListVpcAssociationAuthorizationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_vpc_association_authorizations::ListVPCAssociationAuthorizationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_vpc_association_authorizations::ListVPCAssociationAuthorizationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_vpc_association_authorizations::ListVpcAssociationAuthorizationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListVPCAssociationAuthorizations {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListVPCAssociationAuthorizations");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListVPCAssociationAuthorizationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListVPCAssociationAuthorizationsResponseDeserializer));
...
.with_interceptor(crate::route53_resource_id_preprocessor::Route53ResourceIdInterceptor::new(|input: &mut crate::operation::list_vpc_association_authorizations::ListVpcAssociationAuthorizationsInput| {
                            &mut input.hosted_zone_id
                        }))
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_vpc_association_authorizations::ListVPCAssociationAuthorizationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_vpc_association_authorizations::ListVPCAssociationAuthorizationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_vpc_association_authorizations::ListVPCAssociationAuthorizationsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListVPCAssociationAuthorizationsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_list_vpc_association_authorizations::de_list_vpc_association_authorizations_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListVPCAssociationAuthorizationsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListVPCAssociationAuthorizationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_vpc_association_authorizations::ListVpcAssociationAuthorizationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_vpc_association_authorizations::ListVpcAssociationAuthorizationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::list_vpc_association_authorizations::ListVpcAssociationAuthorizationsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListVPCAssociationAuthorizationsEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListVpcAssociationAuthorizationsInput>()
                        .ok_or("failed to downcast to ListVpcAssociationAuthorizationsInput")?;
...
pub enum ListVPCAssociationAuthorizationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListVPCAssociationAuthorizationsError) for what information is available for the error.")]
...
impl ListVPCAssociationAuthorizationsError {
    /// Creates the `ListVPCAssociationAuthorizationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListVPCAssociationAuthorizationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListVPCAssociationAuthorizationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_vpc_association_authorizations::ListVPCAssociationAuthorizationsError {
