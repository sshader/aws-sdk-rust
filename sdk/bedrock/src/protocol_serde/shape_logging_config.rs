                    ...
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "textDataDeliveryEnabled" => {
                                builder = builder.set_text_data_delivery_enabled(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "imageDataDeliveryEnabled" => {
                                builder = builder.set_image_data_delivery_enabled(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "embeddingDataDeliveryEnabled" => {
                                builder = builder.set_embedding_data_delivery_enabled(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
...
pub fn ser_logging_config(
    ...
    if let Some(var_1) = &input.cloud_watch_config {
        ...
        crate::protocol_serde::shape_cloud_watch_config::ser_cloud_watch_config(&mut object_2, var_1)?;
        object_2.finish();
    }
    ...
    if let Some(var_5) = &input.text_data_delivery_enabled {
        object.key("textDataDeliveryEnabled").boolean(*var_5);
    }
    if let Some(var_6) = &input.image_data_delivery_enabled {
        object.key("imageDataDeliveryEnabled").boolean(*var_6);
    }
