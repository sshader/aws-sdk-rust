        ...
        ::std::result::Result::Ok(
            crate::types::FoundationModelSummary {
                model_arn: self.model_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("model_arn", "model_arn was not specified but it is required when building FoundationModelSummary")
                    )?
                ,
                model_id: self.model_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("model_id", "model_id was not specified but it is required when building FoundationModelSummary")
                    )?
                ,
