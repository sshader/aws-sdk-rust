...
impl ExtendTransactionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::extend_transaction::ExtendTransactionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::extend_transaction::ExtendTransactionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::extend_transaction::ExtendTransactionOutput, crate::operation::extend_transaction::ExtendTransactionError, Self> {
