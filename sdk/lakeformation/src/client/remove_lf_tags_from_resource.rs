...
impl super::Client {
    ...
    ///   - [`catalog_id(impl Into<String>)`](crate::operation::remove_lf_tags_from_resource::builders::RemoveLFTagsFromResourceFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::remove_lf_tags_from_resource::builders::RemoveLFTagsFromResourceFluentBuilder::set_catalog_id):<br>required: **false**<br><p>The identifier for the Data Catalog. By default, the account ID. The Data Catalog is the persistent metadata store. It contains database definitions, table definitions, and other control information to manage your Lake Formation environment. </p><br>
    ///   - [`resource(Resource)`](crate::operation::remove_lf_tags_from_resource::builders::RemoveLFTagsFromResourceFluentBuilder::resource) / [`set_resource(Option<Resource>)`](crate::operation::remove_lf_tags_from_resource::builders::RemoveLFTagsFromResourceFluentBuilder::set_resource):<br>required: **true**<br><p>The database, table, or column resource where you want to remove an LF-tag.</p><br>
    ///   - [`lf_tags(LfTagPair)`](crate::operation::remove_lf_tags_from_resource::builders::RemoveLFTagsFromResourceFluentBuilder::lf_tags) / [`set_lf_tags(Option<Vec::<LfTagPair>>)`](crate::operation::remove_lf_tags_from_resource::builders::RemoveLFTagsFromResourceFluentBuilder::set_lf_tags):<br>required: **true**<br><p>The LF-tags to be removed from the resource.</p><br>
