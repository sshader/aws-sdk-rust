...
impl GetNetworkResourcesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_network_resources::GetNetworkResourcesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_network_resources::GetNetworkResourcesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_network_resources::GetNetworkResourcesOutput, crate::operation::get_network_resources::GetNetworkResourcesError, Self> {
