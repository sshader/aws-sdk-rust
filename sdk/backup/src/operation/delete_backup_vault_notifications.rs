...
impl DeleteBackupVaultNotifications {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_backup_vault_notifications::DeleteBackupVaultNotificationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_backup_vault_notifications::DeleteBackupVaultNotificationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_backup_vault_notifications::DeleteBackupVaultNotificationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_backup_vault_notifications::DeleteBackupVaultNotificationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteBackupVaultNotifications {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteBackupVaultNotifications");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteBackupVaultNotificationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteBackupVaultNotificationsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteBackupVaultNotifications")
                            .with_interceptor(DeleteBackupVaultNotificationsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_backup_vault_notifications::DeleteBackupVaultNotificationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_backup_vault_notifications::DeleteBackupVaultNotificationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_backup_vault_notifications::DeleteBackupVaultNotificationsError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DeleteBackupVaultNotificationsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteBackupVaultNotificationsResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteBackupVaultNotificationsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteBackupVaultNotificationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_backup_vault_notifications::DeleteBackupVaultNotificationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_backup_vault_notifications::DeleteBackupVaultNotificationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DeleteBackupVaultNotificationsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteBackupVaultNotificationsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteBackupVaultNotificationsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteBackupVaultNotificationsInput>()
                        .ok_or("failed to downcast to DeleteBackupVaultNotificationsInput")?;
...
pub enum DeleteBackupVaultNotificationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteBackupVaultNotificationsError) for what information is available for the error.")]
...
impl DeleteBackupVaultNotificationsError {
    /// Creates the `DeleteBackupVaultNotificationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteBackupVaultNotificationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteBackupVaultNotificationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_backup_vault_notifications::DeleteBackupVaultNotificationsError {
