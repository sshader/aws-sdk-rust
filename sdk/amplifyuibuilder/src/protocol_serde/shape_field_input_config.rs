...
pub fn ser_field_input_config(
    ...
    if let Some(var_11) = &input.min_value {
        object.key("minValue").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_11).into()));
    }
    if let Some(var_12) = &input.max_value {
        object.key("maxValue").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_12).into()));
    }
    if let Some(var_13) = &input.step {
        object.key("step").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_13).into()));
    }
...
pub(crate) fn de_field_input_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::FieldInputConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::field_input_config_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
