...
other => MediaInsightsPipelineConfigurationElementType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
                    }
                }
            }
...
impl MediaInsightsPipelineConfigurationElementType {
    ...
    MediaInsightsPipelineConfigurationElementType::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["AmazonTranscribeCallAnalyticsProcessor", "AmazonTranscribeProcessor", "KinesisDataStreamSink", "LambdaFunctionSink", "S3RecordingSink", "SnsTopicSink", "SqsQueueSink", "VoiceAnalyticsProcessor", "VoiceEnhancementSink"]
                }
            }
