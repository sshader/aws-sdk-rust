...
pub(crate) fn de_media_insights_pipeline_configuration_element<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MediaInsightsPipelineConfigurationElement>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::media_insights_pipeline_configuration_element_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
