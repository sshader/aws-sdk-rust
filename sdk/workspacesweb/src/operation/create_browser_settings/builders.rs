...
impl CreateBrowserSettingsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_browser_settings::CreateBrowserSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_browser_settings::CreateBrowserSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_browser_settings::CreateBrowserSettingsOutput, crate::operation::create_browser_settings::CreateBrowserSettingsError, Self> {
