...
impl ListShareInvitationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_share_invitations::ListShareInvitationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_share_invitations::ListShareInvitationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_share_invitations::ListShareInvitationsOutput, crate::operation::list_share_invitations::ListShareInvitationsError, Self> {
