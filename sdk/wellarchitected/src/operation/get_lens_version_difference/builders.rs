...
impl GetLensVersionDifferenceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_lens_version_difference::GetLensVersionDifferenceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_lens_version_difference::GetLensVersionDifferenceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_lens_version_difference::GetLensVersionDifferenceOutput, crate::operation::get_lens_version_difference::GetLensVersionDifferenceError, Self> {
