...
impl GetLensVersionDifferenceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_lens_version_difference::GetLensVersionDifferenceInput, ::aws_smithy_types::error::operation::BuildError> {
