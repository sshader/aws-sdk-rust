...
impl DeleteReviewTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_review_template::DeleteReviewTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_review_template::DeleteReviewTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_review_template::DeleteReviewTemplateOutput, crate::operation::delete_review_template::DeleteReviewTemplateError, Self> {
