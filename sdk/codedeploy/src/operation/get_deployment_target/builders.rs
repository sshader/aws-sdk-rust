...
impl GetDeploymentTargetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_deployment_target::GetDeploymentTargetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_deployment_target::GetDeploymentTargetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_deployment_target::GetDeploymentTargetOutput, crate::operation::get_deployment_target::GetDeploymentTargetError, Self> {
