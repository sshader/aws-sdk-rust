...
impl DeleteCustomRoutingAccelerator {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_custom_routing_accelerator::DeleteCustomRoutingAcceleratorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_custom_routing_accelerator::DeleteCustomRoutingAcceleratorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_custom_routing_accelerator::DeleteCustomRoutingAcceleratorError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_custom_routing_accelerator::DeleteCustomRoutingAcceleratorOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteCustomRoutingAccelerator {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteCustomRoutingAccelerator");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteCustomRoutingAcceleratorRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteCustomRoutingAcceleratorResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteCustomRoutingAccelerator")
                            .with_interceptor(DeleteCustomRoutingAcceleratorEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_custom_routing_accelerator::DeleteCustomRoutingAcceleratorError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_custom_routing_accelerator::DeleteCustomRoutingAcceleratorError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_custom_routing_accelerator::DeleteCustomRoutingAcceleratorError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DeleteCustomRoutingAcceleratorResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteCustomRoutingAcceleratorResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteCustomRoutingAcceleratorRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteCustomRoutingAcceleratorRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_custom_routing_accelerator::DeleteCustomRoutingAcceleratorInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_custom_routing_accelerator::DeleteCustomRoutingAcceleratorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_custom_routing_accelerator::ser_delete_custom_routing_accelerator_input(&input)?);
...
#[derive(Debug)]
            struct DeleteCustomRoutingAcceleratorEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteCustomRoutingAcceleratorEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteCustomRoutingAcceleratorEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteCustomRoutingAcceleratorInput>()
                        .ok_or("failed to downcast to DeleteCustomRoutingAcceleratorInput")?;
...
pub enum DeleteCustomRoutingAcceleratorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteCustomRoutingAcceleratorError) for what information is available for the error.")]
...
impl DeleteCustomRoutingAcceleratorError {
    /// Creates the `DeleteCustomRoutingAcceleratorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteCustomRoutingAcceleratorError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteCustomRoutingAcceleratorError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_custom_routing_accelerator::DeleteCustomRoutingAcceleratorError {
