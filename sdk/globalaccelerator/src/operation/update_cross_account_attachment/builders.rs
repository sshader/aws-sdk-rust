...
impl UpdateCrossAccountAttachmentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_cross_account_attachment::UpdateCrossAccountAttachmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_cross_account_attachment::UpdateCrossAccountAttachmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_cross_account_attachment::UpdateCrossAccountAttachmentOutput, crate::operation::update_cross_account_attachment::UpdateCrossAccountAttachmentError, Self> {
