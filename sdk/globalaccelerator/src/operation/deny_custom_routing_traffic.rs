...
impl DenyCustomRoutingTraffic {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTrafficOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTrafficError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTrafficError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTrafficOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DenyCustomRoutingTraffic {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DenyCustomRoutingTraffic");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DenyCustomRoutingTrafficRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DenyCustomRoutingTrafficResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DenyCustomRoutingTraffic")
                            .with_interceptor(DenyCustomRoutingTrafficEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTrafficError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTrafficError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTrafficError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct DenyCustomRoutingTrafficResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DenyCustomRoutingTrafficResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_deny_custom_routing_traffic::de_deny_custom_routing_traffic_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DenyCustomRoutingTrafficRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DenyCustomRoutingTrafficRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTrafficInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTrafficInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_deny_custom_routing_traffic::ser_deny_custom_routing_traffic_input(&input)?);
...
#[derive(Debug)]
            struct DenyCustomRoutingTrafficEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DenyCustomRoutingTrafficEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DenyCustomRoutingTrafficEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DenyCustomRoutingTrafficInput>()
                        .ok_or("failed to downcast to DenyCustomRoutingTrafficInput")?;
...
pub enum DenyCustomRoutingTrafficError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DenyCustomRoutingTrafficError) for what information is available for the error.")]
...
impl DenyCustomRoutingTrafficError {
    /// Creates the `DenyCustomRoutingTrafficError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DenyCustomRoutingTrafficError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DenyCustomRoutingTrafficError {
...
impl ::aws_types::request_id::RequestId for crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTrafficError {
