...
impl CreateAppVersionAppComponentOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_app_version_app_component::CreateAppVersionAppComponentOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_app_version_app_component::CreateAppVersionAppComponentOutput {
                app_arn: self.app_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("app_arn", "app_arn was not specified but it is required when building CreateAppVersionAppComponentOutput")
                    )?
                ,
                app_version: self.app_version
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("app_version", "app_version was not specified but it is required when building CreateAppVersionAppComponentOutput")
                    )?
                ,
