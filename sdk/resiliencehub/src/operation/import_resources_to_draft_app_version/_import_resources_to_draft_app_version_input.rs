...
impl ImportResourcesToDraftAppVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::import_resources_to_draft_app_version::ImportResourcesToDraftAppVersionInput, ::aws_smithy_types::error::operation::BuildError> {
