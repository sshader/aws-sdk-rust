...
impl DeleteOptedOutNumberFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_opted_out_number::DeleteOptedOutNumberOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_opted_out_number::DeleteOptedOutNumberError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_opted_out_number::DeleteOptedOutNumberOutput, crate::operation::delete_opted_out_number::DeleteOptedOutNumberError, Self> {
