...
impl AssociateOriginationIdentityFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_origination_identity::AssociateOriginationIdentityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_origination_identity::AssociateOriginationIdentityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_origination_identity::AssociateOriginationIdentityOutput, crate::operation::associate_origination_identity::AssociateOriginationIdentityError, Self> {
