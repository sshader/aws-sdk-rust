...
impl SendTextMessageFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::send_text_message::SendTextMessageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::send_text_message::SendTextMessageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::send_text_message::SendTextMessageOutput, crate::operation::send_text_message::SendTextMessageError, Self> {
