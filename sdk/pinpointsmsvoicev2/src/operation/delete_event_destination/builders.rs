...
impl DeleteEventDestinationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_event_destination::DeleteEventDestinationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_event_destination::DeleteEventDestinationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_event_destination::DeleteEventDestinationOutput, crate::operation::delete_event_destination::DeleteEventDestinationError, Self> {
