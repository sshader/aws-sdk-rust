...
impl UpgradePublishedSchema {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::upgrade_published_schema::UpgradePublishedSchemaOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::upgrade_published_schema::UpgradePublishedSchemaError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::upgrade_published_schema::UpgradePublishedSchemaError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::upgrade_published_schema::UpgradePublishedSchemaOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpgradePublishedSchema {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpgradePublishedSchema");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpgradePublishedSchemaRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpgradePublishedSchemaResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpgradePublishedSchema")
                            .with_interceptor(UpgradePublishedSchemaEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::upgrade_published_schema::UpgradePublishedSchemaError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::upgrade_published_schema::UpgradePublishedSchemaError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::upgrade_published_schema::UpgradePublishedSchemaError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct UpgradePublishedSchemaResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpgradePublishedSchemaResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_upgrade_published_schema::de_upgrade_published_schema_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpgradePublishedSchemaRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpgradePublishedSchemaRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::upgrade_published_schema::UpgradePublishedSchemaInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::upgrade_published_schema::UpgradePublishedSchemaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_upgrade_published_schema::ser_upgrade_published_schema_input(&input)?);
...
#[derive(Debug)]
            struct UpgradePublishedSchemaEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpgradePublishedSchemaEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpgradePublishedSchemaEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpgradePublishedSchemaInput>()
                        .ok_or("failed to downcast to UpgradePublishedSchemaInput")?;
...
pub enum UpgradePublishedSchemaError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpgradePublishedSchemaError) for what information is available for the error.")]
...
impl UpgradePublishedSchemaError {
    /// Creates the `UpgradePublishedSchemaError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpgradePublishedSchemaError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpgradePublishedSchemaError {
...
impl ::aws_types::request_id::RequestId for crate::operation::upgrade_published_schema::UpgradePublishedSchemaError {
