...
impl ListObjectAttributesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_object_attributes::ListObjectAttributesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_object_attributes::ListObjectAttributesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_object_attributes::ListObjectAttributesOutput, crate::operation::list_object_attributes::ListObjectAttributesError, Self> {
