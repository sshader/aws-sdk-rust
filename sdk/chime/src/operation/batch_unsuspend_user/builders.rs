...
impl BatchUnsuspendUserFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_unsuspend_user::BatchUnsuspendUserOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_unsuspend_user::BatchUnsuspendUserError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_unsuspend_user::BatchUnsuspendUserOutput, crate::operation::batch_unsuspend_user::BatchUnsuspendUserError, Self> {
