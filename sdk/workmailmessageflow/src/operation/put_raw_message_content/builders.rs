...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::put_raw_message_content::PutRawMessageContentOutput,
                    crate::operation::put_raw_message_content::PutRawMessageContentError,
                > for PutRawMessageContentFluentBuilder
            {
                fn send(
                    self,
...
impl PutRawMessageContentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_raw_message_content::PutRawMessageContentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_raw_message_content::PutRawMessageContentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::put_raw_message_content::PutRawMessageContent::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::put_raw_message_content::PutRawMessageContent::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_raw_message_content::PutRawMessageContentOutput, crate::operation::put_raw_message_content::PutRawMessageContentError, Self> {
