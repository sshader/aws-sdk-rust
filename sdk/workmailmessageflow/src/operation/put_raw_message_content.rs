...
impl PutRawMessageContent {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_raw_message_content::PutRawMessageContentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_raw_message_content::PutRawMessageContentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_raw_message_content::PutRawMessageContentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_raw_message_content::PutRawMessageContentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutRawMessageContent {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutRawMessageContent");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutRawMessageContentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutRawMessageContentResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutRawMessageContent")
                            .with_interceptor(PutRawMessageContentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_raw_message_content::PutRawMessageContentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_raw_message_content::PutRawMessageContentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_raw_message_content::PutRawMessageContentError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct PutRawMessageContentResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutRawMessageContentResponseDeserializer {
...
#[derive(Debug)]
            struct PutRawMessageContentRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutRawMessageContentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_raw_message_content::PutRawMessageContentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_raw_message_content::PutRawMessageContentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_raw_message_content::ser_put_raw_message_content_input(&input)?);
...
#[derive(Debug)]
            struct PutRawMessageContentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutRawMessageContentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutRawMessageContentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutRawMessageContentInput>()
                        .ok_or("failed to downcast to PutRawMessageContentInput")?;
...
pub enum PutRawMessageContentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutRawMessageContentError) for what information is available for the error.")]
...
impl PutRawMessageContentError {
    /// Creates the `PutRawMessageContentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutRawMessageContentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InvalidContentLocation(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::MessageFrozen(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutRawMessageContentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_raw_message_content::PutRawMessageContentError {
