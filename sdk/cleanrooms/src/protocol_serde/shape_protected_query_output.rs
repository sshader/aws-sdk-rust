                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        variant = match key.as_ref() {
                            ...
                            "memberList" => {
                                Some(crate::types::ProtectedQueryOutput::MemberList(
                                    crate::protocol_serde::shape_protected_query_member_output_list::de_protected_query_member_output_list(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'memberList' cannot be null"))?
                                ))
                            }
                            _ => {
                                                                      ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
