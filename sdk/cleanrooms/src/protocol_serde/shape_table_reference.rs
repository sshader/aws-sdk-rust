...
pub fn ser_table_reference(object_8: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::TableReference) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::TableReference::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("TableReference"))
    }
    Ok(())
}
