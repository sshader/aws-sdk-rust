...
impl GetPriceListFileUrlFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_price_list_file_url::GetPriceListFileUrlOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_price_list_file_url::GetPriceListFileUrlError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_price_list_file_url::GetPriceListFileUrlOutput, crate::operation::get_price_list_file_url::GetPriceListFileUrlError, Self> {
