...
pub(crate) fn de_cloud_watch_logging_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CloudWatchLoggingConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "logTypes" => {
                                builder = builder.set_log_types(
                                    crate::protocol_serde::shape_log_type_map::de_log_type_map(tokens)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::cloud_watch_logging_configuration_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
