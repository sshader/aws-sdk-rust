...
impl CreateHostedConfigurationVersion {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateHostedConfigurationVersion {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateHostedConfigurationVersion");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateHostedConfigurationVersionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateHostedConfigurationVersionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    ::std::borrow::Cow::Owned(
                        ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateHostedConfigurationVersion")
                            .with_interceptor(CreateHostedConfigurationVersionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionError>::new())
                    )
                }
            }
...
#[derive(Debug)]
            struct CreateHostedConfigurationVersionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateHostedConfigurationVersionResponseDeserializer {
...
#[derive(Debug)]
            struct CreateHostedConfigurationVersionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateHostedConfigurationVersionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_hosted_configuration_version_input::ser_content_http_payload( input.content)?);
...
#[derive(Debug)]
            struct CreateHostedConfigurationVersionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateHostedConfigurationVersionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateHostedConfigurationVersionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateHostedConfigurationVersionInput>()
                        .ok_or("failed to downcast to CreateHostedConfigurationVersionInput")?;
...
pub enum CreateHostedConfigurationVersionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateHostedConfigurationVersionError) for what information is available for the error.")]
...
impl CreateHostedConfigurationVersionError {
    /// Creates the `CreateHostedConfigurationVersionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateHostedConfigurationVersionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateHostedConfigurationVersionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionError {
