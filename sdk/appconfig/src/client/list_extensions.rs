...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_extensions::builders::ListExtensionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_extensions::builders::ListExtensionsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of items to return for this call. The call also returns a token that you can specify in a subsequent call to get the next set of results.</p><br>
